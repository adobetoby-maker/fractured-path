...
**Current state: Updated through Book 2 (Iron Circuit) final review pass; Book 7 (Void Roads) close appended 2026-09-04 from DRAFTED prose (Books 3–6 sections are owed by their own teams — the Book 7 tables below carry the B3–B6 fragment facts as Book 7's architecture inherited them)**
...
# BOOK 7 — VOID ROADS — STATE AT CLOSE (drafted prose, 24 chapters, 2026-09-04)
