...

{
  ...
  "pov": {
    ...
    "knowledge_boundary": [
      "Cael does not know what the unnamed capability that surfaces in the third exchange is, and neither does the reader; he cannot summon it, cannot reproduce it on request, and cannot explain what happened even to himself",
      "Cael does not yet know whether the capability will ever recur — its first echo (Ch19) has not happened yet from his perspective",
      "Cael has not yet acquired the Iron-adjacent fragment; that comes later, from sustained close sparring with Brom (Ch13), and must not be anticipated or referenced as already available in this scene",
      "Cael does not know Brom's family background, the Velmere estate, or why Brom left home; that is revealed the following day (Ch12) and must not be foreshadowed with specifics here",
      "Cael does not know about the Compact's Suppression-Advisory Watch / Level 4 flag on his file, or about the Architect's will; these are SECRET-tier and unknown to every character at this point in the story",
      "Cael does not know Warden Coss's exact rank or clearance level",
      "Cael has not yet met Reydan and knows nothing about a Compression-adjacent fragment; that arc is Ch18-24"
    ]
  },
  "purpose": "Force Cael through a fight he cannot win on strategy alone, so a wholly unplanned, fragment-independent capability appears on the page for the first time -- deliberately under-explained -- while the loss itself opens the friendship between Cael and Brom.",
  "scene_shape": {
    "opening_state": "Cael enters the fight off two weeks of observation and a written fragment-discipline plan: Wind-adjacent rationed to read-fed bursts only, never reactive; Pressure-adjacent locked away entirely against Brom's hardened surface. The bout is on the Ironyard's main floor before the largest crowd Cael has fought in front of, with Vell keeping the ledger personally.",
    "pov_goal": "Find and exploit a transition window in Brom's Iron Skin pressure-read between its defensive and offensive activation, without breaking his own fragment-discipline rules, in order to close the scoreline against a fighter with a hard rating advantage.",
    "opposition": "Brom's Iron Skin hardens specific contact points at the instant of impact and redirects incoming force back through the contact point at an angle the opponent's body has not braced for; the give-to-hardening transition at contact is effectively instantaneous, leaving no exploitable window there. His pressure-read also has a faster response speed against fast approaches than two weeks of observation indicated -- a modification aimed at countering exactly the kind of speed-based attack Cael tries in the second exchange. The read tracks active resistance, not simple presence.",
    "turn": "In the third exchange, Cael abandons the plan to break the read head-on and instead does something spontaneous and outside his named toolkit -- not a fragment deployment, no reserve spent, no account drawn, no warning before it happens. For under a full second, Brom's pressure-read does not register him at all: not blocked, not evaded, simply absent from anything the read is built to categorize.",
    "choice": "There is no deliberate choice on Cael's part to make here -- that is the point of the beat. The event is not summoned, not authorized, not something he decides to do; it happens the way the Wind-adjacent step first arrived over a year earlier, present without having been asked for, and it cannot be repeated or explained afterward, including to Cael himself.",
    "outcome": "Brom wins the third exchange anyway, adapting on raw instinct rather than the read, but visibly takes longer to do so than either of the first two exchanges. In the fourth exchange he targets Cael's already-compromised legs (damaged in the second exchange) with a clean, deliberate force-redirect and ends the bout. Cael loses all four exchanges; the bout goes to Brom.",
    "closing_state": "Cael is down, both legs spent twice over (damage plus the bursts drawn against them), breath ragged but reorganizing, and the Pressure-adjacent reserve entirely unspent for the first time since he acquired it. Brom crosses the floor without hurry and sits down beside Cael rather than standing over him, and asks directly what happened in the third exchange. Neither of them can answer it. This exchange is what starts their friendship."
  },
  "obligations": {
    "must_include": [
      "Four exchanges total; Brom wins every exchange, with the fourth being the deliberate, fight-ending blow against Cael's already-compromised legs",
      "Iron Skin hardens at the point and instant of contact and redirects the opponent's own incoming force back at an unanticipated angle, rather than simply blocking or absorbing passively",
      "The give-to-hardening transition happens essentially instantaneously once real contact replaces training-post contact; there is no usable transition window at the point of impact, which corrects Cael's pre-fight hypothesis",
      "Brom's pressure-read has a faster response speed against fast approaches than two weeks of alcove observation suggested -- a modification Cael concludes is aimed specifically at countering speed-based attacks",
      "Cael entered the bout with a written fragment-discipline rule: Wind-adjacent rationed to read-fed bursts only, never reactive; Pressure-adjacent locked away entirely against a hardened surface",
      "In the first exchange, Cael is tempted at least twice to break Pressure-adjacent discipline and declines each time; each refusal has a cost that Brom's redirects punish",
      "Cael is forced to spend one reactive Wind-adjacent burst in the first exchange, against his own discipline plan, to recover his footing",
      "In the second exchange Cael takes a real, weight-bearing hit that compromises both legs (not broken, but unstable) -- not the glancing redirected contact of exchange one",
      "After the leg damage, Wind-adjacent becomes unusable in its intended form -- it still fires and still spends its full cost but delivers a fraction of its distance with no precision -- and Cael deliberately shuts it down rather than keep drawing on it",
      "From partway through the second exchange onward, Cael fights the remainder of the bout with neither fragment available to him",
      "In the third exchange, Cael produces a capability that is explicitly not a fragment deployment: no reserve is spent, no named account is drawn against, there is no anticipatory warning the way the Wind-adjacent step sometimes gives",
      "The effect of that capability: for under one full second, Brom's pressure-read fails to register Cael at all -- not blocked, not evaded, simply absent from what the read can categorize",
      "Cael cannot explain what he did, in the moment or afterward, including directly to Brom in the post-bout conversation",
      "Brom notices the read-gap is real; it costs him visibly more time to close than either of the first two exchanges, though it does not cost him the exchange itself since he adapts on instinct rather than the read",
      "Something in Brom's manner changes after the third exchange -- sharper attention, genuine interest -- and this must be shown through behavior (sitting beside Cael instead of standing over him after the win, asking directly what happened) rather than stated as an internal fact only Cael could know",
      "At the bout's end: legs compromised twice over (impact damage plus the cost of the bursts drawn against them), breath ragged but recovering, and the Pressure-adjacent reserve completely unspent for the first time since Cael acquired it",
      "The third-exchange capability leaves no residual trace afterward -- no lingering ability, no soreness or cost tied to it, nothing usable going forward from this scene",
      "The aftermath: Brom sits down beside Cael on the floor, not standing over him in a winner's posture, and opens with wanting to understand the third exchange specifically -- this is what begins their friendship"
    ],
    "plants": [
      "The third exchange's read-failure is the first on-page appearance of a capability the planning layer tracks as possibly a fourth thing alongside Cael's named fragments; it must read as genuinely strange and isolated here, with no suggestion that this is part of a pattern or that anyone (including Cael) recognizes it as such"
    ],
    "payoffs": [],
    "prohibited_outcomes": [
      "Cael winning any exchange, or winning or drawing the bout",
      "Naming, explaining, mechanistically resolving, or expanding the third-exchange capability in any way -- no Path name, no category, no theory that reads as more than speculation Cael immediately can't confirm",
      "Any suggestion that Cael can summon, control, or intentionally repeat the third-exchange capability",
      "Ruling in or out any specific Path or classification for the capability, including via authorial implication, imagery, or Brom's dialogue",
      "Altering Brom's established character -- he must stay patient, composed, technically superior, and genuinely gracious in victory (sitting beside Cael, extending a hand); not smug, not cruel, not written as rattled into a different personality by the third exchange",
      "Injuries beyond the original end-state: nothing worse than 'compromised, not broken' legs and general exhaustion; no permanent damage; no injury to hands, arms, or ribs beyond what the absorbed strikes in exchange one already establish",
      "Iron Skin being defeated, bypassed, damaged, or permanently altered by anything that happens in this fight",
      "Disclosing any SECRET-tier fact (the Level 4 Suppression-Advisory Watch flag, the Architect's will) or any detail from Brom's Ch12 backstory reveal that is outside this scene's knowledge boundary"
    ]
  },
  "invention_budget": {
    "allowed": [
      "Terrain and tactical texture within the already-established Ironyard main floor (crowd reactions, lamp light, packed dirt, the circle itself)",
      ...
      "Dialogue in Cael's, Brom's, Lira's, and Vell's already-established voices, consistent with the aftermath beats already blocked in the chapter architecture"
    ],
    "approval_required": [
      "Any new named character, official, or crowd figure beyond those already in the registry",
      "Any new canon fact about Iron Skin, Wind-adjacent, or Pressure-adjacent beyond what is specified in this packet",
      "Any new detail about the nature, origin, or mechanism of the third-exchange capability"
    ],
    "forbidden": [
      ...
      "Resolving, naming, or explaining the fourth-capability mystery in any way",
      "Any knowledge outside pov.knowledge_boundary appearing in Cael's perspective or being implied as known to him",
      "Altering Brom's Iron Skin mechanics as established in this packet and in universe/CANON_RULES.md",
  ...
  "context_files": [
    {
      "kind": "canon",
      "label": "canon rules -- Brom, Iron Skin, fragment mechanics",
      "path": "universe/CANON_RULES.md",
      "required": true
    },
    {
      "kind": "arc",
      "label": "Book 2 chapter architecture -- Ch11 scene card",
      "path": "books/book-02-iron-circuit/CHAPTER_ARCHITECTURE.md",
      "required": true
    },
    {
      "kind": "state",
      "label": "state ledger -- fragment state, companion roster, open questions",
    ...
    },
    {
      ...
      "path": "v3-runs/book-02/packets/ch11-seam-before.md",
      "required": true
    },
    {
      "kind": "reference",
      "label": "verbatim seam immediately after the fight",
      "path": "v3-runs/book-02/packets/ch11-seam-after.md",
      "required": true
    }
  ],
  "verified_findings": [],
  "exceptions": [],
  "output": {
    "draft_path": "v3-runs/book-02/drafts/ch11-fight.md",
    "report_path": "v3-runs/book-02/reports/ch11-author.json",
    "editor_report_path": "v3-runs/book-02/reports/ch11-editor.json",
    "verifier_report_path": "v3-runs/book-02/reports/ch11-verifier.json",
    "target_words": 3920,
...
# CONTEXT — canon rules -- Brom, Iron Skin, fragment mechanics (universe/CANON_RULES.md)
...
# CONTEXT — Book 2 chapter architecture -- Ch11 scene card (books/book-02-iron-circuit/CHAPTER_ARCHITECTURE.md)
...
# CONTEXT — state ledger -- fragment state, companion roster, open questions (universe/STATE_LEDGER.md)
...
# CONTEXT — verbatim seam immediately before the fight (v3-runs/book-02/packets/ch11-seam-before.md)

Somewhere near the back, Cael caught sight of the old yard-owner, arms crossed over the low wall at the far corner he'd held for as long as anyone could remember, watching with the same patience he brought to everything. He didn't wave. He never did. But he'd found his way here for this one, out of a year of fights he'd mostly left Cael to attend without him, and Cael filed that fact away the way he filed everything that mattered too much for an immediate reaction.

Then the floor cleared, and it was just the two of them.

---

# CONTEXT — verbatim seam immediately after the fight (v3-runs/book-02/packets/ch11-seam-after.md)

The audience cleared faster than usual. Cael registered it distantly, still working through the arithmetic of what still worked and what didn't below his waist — something in the fight's shape had clearly signaled to the crowd that whatever came next wasn't theirs to watch, and even the loudest of them thinned toward the exits within a few minutes, leaving the main floor's usual after-bout murmur far quieter than normal.

Lira came to check on him first, kneeling briefly, running a practiced eye over the damage. "Nothing broken?"

"Nothing broken."

"Good." She didn't linger, reading something in the moment that told her this wasn't hers to sit through — a small, deliberate withdrawal that Cael noted and appreciated more than he'd have known how to say out loud. She retreated to the wall near Vell's table, close enough to watch, far enough to leave the actual space clear.

---

# MANUSCRIPT — v3-runs/book-02/drafts/ch11-fight.md

Vell did not raise her voice for the formalities. She never needed to. The main floor had its own acoustics — low ceiling, hard stone, forty years of bouts worn into both — and she had long ago measured exactly how little effort the room required of her.

"Cael. Assessed, Copper-equivalent." Her pen was moving before she finished the name. "Brom. Iron-equivalent. Both parties confirm the no-kill rule."

"Confirmed," Brom said.

"Confirmed," Cael said.

"Then it's a bout." She wrote one more line and looked up, and the room's noise changed shape — not quieter, exactly. Attentive. The largest crowd Cael had ever fought in front of, three deep at the rail and standing on benches behind that, settling into the specific hush of people who intended to remember what they saw.

He set the crowd aside the way he set aside anything that wasn't usable, and looked at the plan instead.

The plan was two lines. He had written them in the Power Log the night before and read them again that morning, because a rule that only existed in his head was a rule he'd renegotiate the first time it cost him something.

*Wind: read-fed bursts only. Never reactive.*

*Pressure: locked. Do not open it. Not once.*

The second line had a reason attached, and the reason was standing across the circle from him with his weight distributed so evenly that Cael's eye kept sliding off it, looking for the lean that wasn't there. Pressure-adjacent was impact amplification. Against most opponents, more force meant more result. Against a surface that hardened at the instant of contact and handed the force back, more force meant a larger donation. Every amplified strike he threw at Brom would come home with interest, at an angle of Brom's choosing. So the reserve stayed shut. Whatever happened tonight, it stayed shut.

Which left the hypothesis. Two weeks of watching Brom work the training posts in the side alcoves, session after session, and Cael had seen — or believed he'd seen — a seam. A softness in the Iron Skin between its two modes: the defensive set that met an incoming strike, and the offensive set that turned his own blows into something that arrived twice. A transition. A window. If it existed, it would open under alternation — if Cael could force the Iron Skin to switch modes fast enough, often enough, there would be a fraction of a second when it was neither, and a fraction of a second was a working space he'd fitted himself into before.

Vell said, "First exchange."

Cael went in at three-quarter speed, high line, nothing committed — a question, not an attack. Brom let it come. Cael's forearm met his shoulder, and for the first sliver of the contact it was a shoulder, ordinary muscle over ordinary bone with ordinary give in it — and then it was not. The set arrived under his arm like a floor arriving under a dropped stone. And the force he'd put in came back out.

Not blocked. Not absorbed. Returned — through the same contact point, rotated off his line by an angle no part of his structure had been braced against, so that his own strike climbed back up through his wrist and forearm and turned him a quarter-step to the left, into space he hadn't chosen. He recovered before the follow-up arrived, but the follow-up had been on its way before he'd finished turning. That was the economy of it. Brom didn't need to generate offense. He rented Cael's.

Cael reset and ran the alternation pattern. Speed changes, angle changes, contact high then low then high — feints that had to be answered as strikes, strikes shaped like feints. He was not trying to land anything. He was trying to make the Iron Skin change its mind quickly, over and over, and catch the moment between one mind and the next.

There was no moment.

By the fourth contact he understood the shape of his error, and it was an old error, the kind he filed with special care because it came from good procedure honestly executed. Two weeks of observation, thirty feet away, watching Brom work the posts — and what he'd read as a lag in the Iron Skin, a softness before the set, had been the post. Wood flexing under load. The give had belonged to the equipment, not the man. Live, at the length of his own arm, with real intent behind the contact, the transition from flesh to iron was not fast. It was not anything. There was no interval in it to be fast across. The window he had built two weeks of planning on did not exist, and had never existed, and the fifth contact confirmed it, and the sixth put the confirmation through his elbow hard enough to numb the forearm to the wrist.

Twice in that first exchange, the other thing offered itself.

The first time: one of his low probes turned Brom farther than usual, and for half a beat the ribs were there, open, square to him, and the Pressure-adjacent reserve leaned toward his hand — the familiar readiness, the sense of an account waiting to be drawn — and an amplified strike into that opening would have been the hardest hit he'd ever landed on anyone. On anyone else. He declined it. He put a plain strike there instead, because the opening was real even if the amplification was forbidden, and the plain strike met hardened surface and came back through his own elbow, and he paid for the refusal with half a step and an arm that rang like struck metal. The cost of keeping the rule was taking the redirect with nothing to show for it. He logged the cost and kept the rule.

The second time was worse, because it was better: a clean line to the sternum as Brom advanced, the kind of line that ended exchanges, and every trained instinct he had converged on it, and the reserve was right there. He declined again. Declining meant checking a motion he'd already half-committed, and the check left him square and stalled, and Brom's palm met his retreating guard and redirected the check itself — used the force of Cael's own stopping — and walked him two steps backward off the center of the circle. The cost of the second refusal was the ground. He gave it. The rule held.

Then Brom took the exchange, and took it out of the recovery Cael was proudest of. A redirect off the forearm turned Cael's cross-step into a spiral, and his balance went past the point his footwork could answer — genuinely past it, the stone coming up — and he spent the Wind burst.

Reactive. Unread. Exactly the deployment his own plan prohibited, fired not off a read but off a fall. It caught him, the short familiar surge putting his feet back under him a half-metre from where physics wanted him, and it worked perfectly, and it was still a violation. He felt the reserve drop by its usual amount. He had time to hate the arithmetic — *one line of the plan broken inside the first exchange* — and no time for more than that, because Brom had followed the recovery the way he followed everything, without hurry and without any gap to exploit, and the shoulder-drive that ended the exchange used the last of Cael's redirected momentum to sit him down on the pale-worn boundary line.

"First exchange," Vell said. "Brom."

Her pen scratched. The crowd's noise came up like weather and Cael filed it under irrelevant and walked back to his mark, cataloguing. Hypothesis: dead. The window was not at the point of contact. Contact was where the Iron Skin was perfect. But a read preceded the set — something told the surface where to harden, and a thing that reads must read *before*. If he could not be slow enough to slip between modes, perhaps he could be fast enough to arrive before the reading finished. Speed, then. Speed was the second door.

"Second exchange."

He went through the second door at the pace he'd been withholding all year.

There was no showing it in the alcove bouts; he'd been careful about that, keeping his fastest entries out of the circuit's visible record, and so the first angled entry of the second exchange was faster than anything Brom could have watched him do — a low diagonal that covered the distance in the time most fighters spent deciding to. It should have arrived before the read.

The read was waiting for him.

Not barely. Comfortably. The hardened set met him a full beat early, established, unhurried, and the redirect off it was almost gentle, a correction rather than a punishment, as if Brom were declining to spend force on an answer he'd had ready for a while. Cael broke off, circled, tried the mirror of it — high diagonal, opposite side, a tempo change inside the entry. Met again. Early again.

The observation record said Brom's read engaged at a certain speed. The record was wrong, and it was wrong in a specific, directional way, and midway through the third entry Cael concluded the thing he would have written down if he'd had a hand free: *the read has been modified against fast approaches.* Not natural talent outrunning his data — a tuned response, a door somebody else had tried before him, tried hard enough that Brom had rebuilt the lock. Every fast fighter Brom had ever faced had walked this same line, and Brom had closed it behind the last of them and kept the improvement. The two weeks of observation weren't worthless. They were a map of the previous version.

The hit came while he was mid-adjustment.

He'd committed to a low fast entry — weight in transfer, both feet loaded, the one instant in any step when the body is a bridge and not a stance — and Brom's redirect arrived not at his arms but *down*, through the line of his commitment, his own speed and mass returned through his hips at an angle nothing below his waist had been built to hold. It was not the glancing tax of the first exchange. It was weight-bearing, structural, both legs at once — hip to knee to ankle, the entire load-bearing arithmetic paying a bill in the same instant.

He went down. He got up, because getting up was still available. Everything held. Nothing held well. His knees answered him the way a rope bridge answers — present, functional, and honest about its new terms.

He tested the terms immediately, because untested terms were how fighters got finished: a read-fed Wind burst, by the plan, legal, to reopen the distance while Brom advanced. The burst fired. The reserve dropped by exactly its usual cost. And his body delivered perhaps a third of the usual ground, in not quite the direction he'd asked for — because the burst was not magic, had never been magic, it was force expressed through legs, and the instrument was compromised. Full price, fractional product. He tried nothing further with it. He shut the Wind-adjacent down the way he'd close a ledger with the ink still wet — deliberately, carefully, without any plan to reopen it tonight — because a resource that spent whole and delivered broken wasn't a resource. It was a leak.

Which made the accounting simple. Pressure: locked by rule. Wind: closed by damage. From here to the end of the bout, he had eyes, a plan's ruins, and whatever his legs had left.

Brom ended the second exchange almost kindly, if kindness could be measured in efficiency: one more entry Cael couldn't answer at speed, one more redirect, the floor. "Second exchange," Vell said. "Brom." Her pen was slower this time, adding something beyond the result, and Cael, back on his feet and breathing through the new information from his knees, ran the arithmetic he trusted more than hope. Two exchanges left in his mobility. At best. After that the legs would make the decision for everyone.

"Third exchange."

He came out with nothing, and fought with it.

No speed — speed was gone. No amplification — locked. No bursts — closed. He fought small: short angles, economical contact, weight kept over his feet like something carried in a shallow bowl. And he stopped trying to break the read. That was the one decision left to make and he made it consciously: the read could not be beaten head-on, so he stopped addressing it. He narrowed himself down to the next half-second, and the half-second after that. Where Brom's lead shoulder was. Where the floor was. What the distance was doing. Not how to solve the Iron Skin — just what, exactly, needed to happen next.

And something happened that he did not do.

He would try to reconstruct it afterward, many times, and every reconstruction would fail at the same place: there was no beginning to it. No decision he could locate, no draw against any account, none of the leaning readiness that the Wind-adjacent sometimes gave before it fired — nothing offered, nothing spent, nothing felt. He was moving through the small quiet arithmetic of the next half-second, all of his attention on the *what* of it, and then Brom's guard was pointed at a version of the floor where Cael was supposed to be standing.

And wasn't.

Cael saw it from the outside, the way he saw everything — Brom's weight checked mid-shift; the guard stayed committed to a line Cael had already left; and the composure that had governed every prior second of the bout produced its first graceless half-beat. Not fooled. Fooled implied the read had been handed a wrong answer. This looked like a read handed no answer at all — the hardened attention sweeping a space and finding nothing in it that it knew how to be hard against. Cael was there. Standing on the same stone, breathing the same air, close enough to touch. And for a stretch of time shorter than a full second, to the thing inside Brom that read the world, he was not.

He put contact into the gap because contact was what the half-second called for — a plain strike, the only meaningful offense he'd land all night — and Brom caught it late, off raw instinct, a hand arriving by eyesight and training rather than by the read, and the redirect that came back was imperfect for the first time: real, still stronger than anything Cael could answer, but *built in the moment* rather than waiting for him. Then the moment shut. Whatever it was ended without ending — no seam there either — and Brom's read had him again, and the exchange went on.

It went on three times longer than either exchange before it.

Cael measured it because measuring was what he had left. The first exchange had cost him roughly a minute. The second, less. The third ran long enough that the crowd's noise changed shape twice — the rising note of people watching an upset assemble itself, then the long uncertain vowel of a room that had stopped being sure what it was watching. Twice Brom built a solution and abandoned it half-built. He wasn't relying on the read anymore; Cael could see the difference, the eyes doing work the Iron Skin usually did, the approach of an excellent fighter navigating by sight and feel like everyone else in the world had to. It was enough. Of course it was enough — instinct at Brom's level was most fighters' best day — and the exchange ended the way the arithmetic said it must: a grip Cael's legs couldn't refuse, a turn, the stone. Controlled. Almost careful. Nothing new broken.

"Third exchange," Vell said. "Brom." A pause that hadn't followed the first two. Her pen moved for longer than a result required.

Walking back to his mark, Cael did the inventory, because the inventory was the only instrument he had pointed at himself.

Wind-adjacent: closed, and exactly as full as when he'd closed it. Pressure-adjacent: locked, untouched, whole. Nothing had been drawn. Nothing had been spent. There had been no warning before — none of the arrival the Wind step used to announce, back when it was new, present before being asked for. And there was nothing after. No ache that belonged to it. No drain, no residue, no echo he could follow back toward a source. He reached for it anyway, standing on his mark with his breath sawing — reached inward for whatever had been there in that half-second, some handle, some address — and found what a hand finds in a dark room that turns out to be empty. It had not asked him before, and it did not answer him now.

*It arrived the way the step arrived,* he thought — over a year ago, unasked, already his before he knew it existed — and he could not confirm even that. It was a shape, not a fact. He had no idea what he had done. He had no idea whether it could ever be done again, by him or by anything, and no way to find out, and nothing to write down except that Brom's read had swept across him and catalogued nothing, and that he had been, for less than one second, absent from a system built to see everyone.

Across the circle, Brom took the reset slowly. Slower than he needed to. He rolled his shoulders once, which he had not done all bout, and he watched Cael cross to his mark the whole way — and the composure was intact, the patience was intact, but the attention living inside them had changed its grip. Cael had spent two weeks learning the difference between Brom watching and Brom *watching*. This was the second one.

At the wall by Vell's table, Lira stood with her arms folded and her weight forward, saying nothing, which from Lira was its own report.

"Fourth exchange," Vell said.

Brom did not investigate. That was the thing Cael would remember about the fourth exchange — that a fighter who had just seen something impossible declined, professionally, to go looking for it again, because looking was not his job. His job was the bout, and the bout had a door standing open, and the door was Cael's legs.

He came in committed, at an angle that gave Cael no way to yield out of it — an entry that had to be met, structurally, with braced legs or not at all. Cael met it because the alternative was the same result with worse posture. He braced. The brace was the payment. Brom's redirect took the force Cael's own body was channeling into the floor and returned it down through the channel — clean, deliberate, exact, through both compromised legs at the one angle their new terms could not carry — and the terms were called, and the bridge went out, and the stone came up, and this time there was no getting up in it. Cael knew before he landed. His legs knew before he did.

The floor of the Ironyard was cool through the back of his shirt. The lamps burned steady in their brackets, the practitioner-installed light Vell had never let anyone modernize, and somewhere beyond his feet the crowd was making a sound too large for the room.

"Bout to Brom," Vell said, level as ever. "Four exchanges." And then the scratch of the pen, longer than four words needed.

Cael lay still and let the systems report in. Breath: ragged, but organizing, finding its count again the way it always did, two in, three out. Legs: paid twice over — once by the second exchange, and once more by every burst he'd drawn against them afterward, the damage and the spending stacked on the same two columns. And underneath it all, whole and shut and strange, the Pressure-adjacent reserve — completely untouched, for the first time since the night it had arrived. He had never once finished a bout without drawing on it. The one line of the plan that had survived contact with Brom, and it sat in him now with an odd weight, like a coin found unspent in a coat he'd been sure was empty.

Brom had not left the floor.

Cael registered that at the edge of vision — the winner's silhouette unmoving out there past his feet, in no hurry to be anywhere — and set it with everything else he wasn't ready to process. He started with his breathing, because it was nearest.
...
word_count=3463
target_range=3136-4704
word_target_state=WITHIN_TARGET

---

# AUTHOR REPORT — v3-runs/book-02/reports/ch11-author.json

{
  "schema_version": "3.1",
  "run_id": "b2-ch11-fight-r1",
  "scene_id": "b2-ch11-fight",
  "status": "DONE",
  "draft_path": "v3-runs/book-02/drafts/ch11-fight.md",
  "word_count": 3463,
  "obligations": [
    {
      "obligation": "Four exchanges total; Brom wins every exchange, with the fourth being the deliberate, fight-ending blow against Cael's already-compromised legs",
      "status": "MET",
      "evidence": "Vell calls all four exchanges to Brom on the page; the fourth is written as Brom declining to investigate the anomaly and instead forcing a braced entry, redirecting Cael's own bracing force down through both compromised legs to end the bout."
    },
    {
      "obligation": "Iron Skin hardens at the point and instant of contact and redirects incoming force back at an unanticipated angle rather than blocking or absorbing passively",
      "status": "MET",
      "evidence": "First contact: 'for the first sliver of the contact it was a shoulder... and then it was not... the force he'd put in came back out... rotated off his line by an angle no part of his structure had been braced against.' Reinforced across all four exchanges ('He rented Cael's [offense]')."
    },
    {
      "obligation": "Give-to-hardening transition is essentially instantaneous under real contact; no usable window; corrects Cael's pre-fight hypothesis",
      "status": "MET",
      "evidence": "Exchange one runs the alternation test and disproves it on the page: the perceived lag is traced to training-post flex ('The give had belonged to the equipment, not the man... There was no interval in it to be fast across')."
    },
    {
      "obligation": "Pressure-read responds faster against fast approaches than two weeks of observation suggested; Cael concludes it was modified specifically to counter speed-based attacks",
      "status": "MET",
      "evidence": "Exchange two: the read meets his fastest concealed entries 'a full beat early'; Cael's on-page conclusion: 'the read has been modified against fast approaches... a door somebody else had tried before him... Brom had rebuilt the lock.'"
    },
    {
      "obligation": "Cael entered with a written fragment-discipline rule: Wind read-fed bursts only, never reactive; Pressure locked entirely",
      "status": "MET",
      "evidence": "The two Power Log lines are quoted near the opening ('Wind: read-fed bursts only. Never reactive. / Pressure: locked. Do not open it. Not once.'), with the rationale for locking Pressure against a hardening surface."
    },
    {
      "obligation": "In the first exchange, Cael is tempted at least twice to break Pressure-adjacent discipline and declines each time; each refusal has a cost punished by Brom's redirects",
      "status": "MET",
      "evidence": "Temptation one (open ribs): declined, plain strike redirected back through his elbow, costing half a step and a numbed arm. Temptation two (sternum line): declined, the checked motion is itself redirected and he loses the center of the circle."
    },
    {
      "obligation": "Cael is forced to spend one reactive Wind-adjacent burst in the first exchange, against his own plan, to recover his footing",
      "status": "MET",
      "evidence": "Balance driven past recovery by a redirect off the forearm; the burst fires 'not off a read but off a fall'; Cael explicitly registers the violation ('one line of the plan broken inside the first exchange')."
    },
    {
      "obligation": "In the second exchange Cael takes a real, weight-bearing hit that compromises both legs (not broken, but unstable)",
      "status": "MET",
      "evidence": "The redirect arrives 'down, through the line of his commitment... through his hips... both legs at once'; state fixed as 'Everything held. Nothing held well,' with the rope-bridge terms image; nothing is broken."
    },
    {
      "obligation": "After the leg damage, Wind-adjacent still fires and spends full cost but delivers a fraction of its distance with no precision; Cael deliberately shuts it down",
      "status": "MET",
      "evidence": "One legal read-fed test burst: 'The reserve dropped by exactly its usual cost... perhaps a third of the usual ground, in not quite the direction he'd asked for'; he closes it 'the way he'd close a ledger with the ink still wet.'"
    },
    {
      "obligation": "From partway through the second exchange onward, Cael fights with neither fragment available",
      "status": "MET",
      "evidence": "Accounting paragraph after the test burst: 'Pressure: locked by rule. Wind: closed by damage. From here to the end of the bout, he had eyes, a plan's ruins, and whatever his legs had left.'"
    },
    {
      "obligation": "Third-exchange capability is explicitly not a fragment deployment: no reserve spent, no named account drawn, no anticipatory warning",
      "status": "MET",
      "evidence": "In the moment: 'no decision he could locate, no draw against any account, none of the leaning readiness that the Wind-adjacent sometimes gave.' Post-exchange inventory re-verifies both reserves untouched and 'no warning before.'"
    },
    {
      "obligation": "Effect: for under one full second, Brom's pressure-read fails to register Cael at all — not blocked, not evaded, simply absent from what the read can categorize",
      "status": "MET",
      "evidence": "'Not fooled. Fooled implied the read had been handed a wrong answer. This looked like a read handed no answer at all'; duration fixed at 'a stretch of time shorter than a full second'; Cael physically present throughout."
    },
    {
      "obligation": "Cael cannot explain what he did, in the moment or afterward, including directly to Brom in the post-bout conversation",
      "status": "MET",
      "evidence": "Draft covers the in-the-moment and immediate-afterward inability ('every reconstruction would fail at the same place'; the empty-room reach; 'He had no idea what he had done'). The direct exchange with Brom lands in the retained post-seam chapter text this draft flows into."
    },
    {
      "obligation": "Brom notices the read-gap is real; it costs him visibly more time than either earlier exchange, though he wins it by adapting on instinct",
      "status": "MET",
      "evidence": "Brom's guard commits to a space Cael has left; 'the exchange went on three times longer than either exchange before it'; 'Twice Brom built a solution and abandoned it half-built'; he closes 'by eyesight and training rather than by the read' and wins."
    },
    {
      "obligation": "Something in Brom's manner changes after the third exchange, shown through behavior rather than stated as an internal fact",
      "status": "MET",
      "evidence": "Shown in-fight: the deliberately slow reset, the shoulder roll he had not done all bout, watching Cael cross the full way ('This was the second one'), and remaining on the floor after the bout call. The sitting-down-beside beat itself occurs in the retained continuation."
    },
    {
      "obligation": "At the bout's end: legs compromised twice over, breath ragged but recovering, Pressure-adjacent reserve completely unspent for the first time since acquisition",
      "status": "MET",
      "evidence": "Closing systems-report paragraph: breath 'ragged, but organizing'; legs 'paid twice over — once by the second exchange, and once more by every burst'; the reserve 'completely untouched, for the first time since the night it had arrived,' with the unspent-coin image."
    },
    {
      "obligation": "The third-exchange capability leaves no residual trace afterward — no lingering ability, soreness, cost, or anything usable going forward",
      "status": "MET",
      "evidence": "'And there was nothing after. No ache that belonged to it. No drain, no residue, no echo he could follow back toward a source'; his deliberate attempt to reach for it again finds 'what a hand finds in a dark room that turns out to be empty.'"
    },
    {
      "obligation": "The aftermath: Brom sits down beside Cael on the floor, not in a winner's posture, and opens with wanting to understand the third exchange — beginning their friendship",
      "status": "NOT_APPLICABLE",
      "evidence": "Outside the drafted span. The required verbatim seam (ch11-seam-after.md: audience clearing, Lira checking first and withdrawing to leave the space clear) chronologically precedes Brom's approach, so the retained chapter text following the seam carries this beat. The draft hands off into it: Brom 'had not left the floor... in no hurry to be anywhere.'"
    },
    {
      "obligation": "PLANT: the read-failure is the first on-page appearance of a possible fourth thing; it must read as genuinely strange and isolated, with no pattern recognition by anyone",
      "status": "MET",
      "evidence": "The event has no located beginning, no mechanism, no name, and no category; Cael's only speculation ('It arrived the way the step arrived') is immediately marked unconfirmable ('It was a shape, not a fact'); no character or narration suggests a pattern, classification, or recurrence."
    }
  ],
  "inventions": [
    "Vell's per-exchange call convention ('First exchange. Brom.') and the brief pre-fight formalities dialogue, in her established terse register.",
    "The two written Power Log discipline lines quoted as remembered text, with Cael's stated reason for writing rules down ('a rule that only existed in his head was a rule he'd renegotiate').",
    "Exchange-internal choreography: the alternation probe sequence; training-post flex as the concrete source of the false transition-window read; the low fast entry caught mid-weight-transfer for the leg hit; the forced-brace entry that ends the bout.",
    "Terrain and crowd texture within the established Ironyard main floor: the pale-worn boundary line of the circle, benches behind the rail, lamp brackets, crowd noise 'changing shape' as an index of exchange length.",
    "Lira placed silently at the wall by Vell's table during the bout (consistent with her position at the top of the retained seam-after text).",
    "Vell's pen running longer than the result requires after exchanges three and four — an observational-notation beat consistent with her Ch1-established 'atypical movement pattern' ledger practice; no classification implied."
  ],
  "state_change_proposals": [
    "No state changes beyond the packet's closing_state (legs compromised twice over, Pressure-adjacent unspent, bout to Brom in four exchanges).",
    "Continuity flag only: Vell's ledger for this bout is implied on-page to carry an extended notation about the third exchange; if any later scene quotes her ledger entry for this bout, it should be consistent with an atypical-exchange note existing."
  ],
  "deviations": [
    "Word count 3463 vs target 3920 (-11.7%), inside the 20% tolerance band.",
    "Drafted span ends at the bout call and Cael's first breath-inventory, flowing directly into the required verbatim seam (ch11-seam-after.md). The packet's aftermath must_include items that chronologically follow that seam (Brom crossing and sitting down, the direct question) are therefore carried by the retained chapter continuation rather than duplicated in this draft; the sibling ch21 packet's seam-after confirms this assembly convention (its seam likewise opens the retained aftermath dialogue). The draft's final beats are built to hand off into it."
  ],
  "blockers": []
}
