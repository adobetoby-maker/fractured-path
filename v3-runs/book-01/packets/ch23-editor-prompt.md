...

{
  ...
  "pov": {
    ...
    "knowledge_boundary": [
      "Cael cannot categorize, name, or explain the unrehearsed combined arrival of the Wind-adjacent and Pressure-adjacent fragments in the fourth exchange — it registers only as something his body reached for faster than he could consciously decide, with no prior instance to compare it to and no account, even that same night in his notebook, of how or why it worked.",
      "Cael does not yet recognize the fourth-exchange combined use as a new or third fragment. It is the first time his two already-acquired fragments (Wind-adjacent, acquired Ch15; Pressure-adjacent, acquired Ch17) have functioned together, and he may feel that it exceeded anything he drilled, but no on-page recognition that this constitutes a new capacity belongs here.",
      "Cael has no advance knowledge of the full extent of Darrow's Iron Path resilience or technique beyond what two weeks of secondhand scouting (Feryn's notes, a former Copper-tier fighter's account, a circuit veteran's impressions) and Lira's coaching have given him. He is reading Darrow's guard, rhythm, and escalation live, exchange by exchange, with no foreknowledge of the fourth exchange's committed strike before it happens.",
      "Cael does not know what tonight's win will lead to beyond the fight itself and the immediate crowd reaction — no knowledge of the senior-level flag Coss will later find on his registry file, no knowledge of any stranger who will later watch him in the market, no knowledge of any academy interest. None of that exists in his awareness at this point in the book.",
      "Cael does not know, in the moment, whether the visibility strategy he built this bout to serve will actually work against the underlying threat from the Compact — only that it is the best option he has after concluding that quiet isn't protecting him."
    ]
  },
  "purpose": "Force Cael to win a publicly staged marquee bout against a genuinely superior, formally rated Bronze-tier Iron Path opponent by reading and exploiting the one structural gap in that opponent's resilience, surfacing as the fight's decisive turn an unplanned, costly, and still-unexplained first combined deployment of his two established fragments, and securing through the win the public visibility his whole strategy was built to generate.",
  "scene_shape": {
    "opening_state": "Cael arrives early at the packed Cinder House yard for the marquee bout he deliberately engineered, Lira steady beside him after two weeks of focused preparation, the crowd's betting running heavily against a fourteen-year-old assessed-Copper facing a genuine Bronze-tier professional with a real outside reputation.",
    "pov_goal": "Win by finding and exploiting the one gap in Darrow's Iron Path resilience through patient, precise, accumulating strikes rather than raw force — the method his whole approach was already built for — without needing to reveal more of his fragments than the fight forces him to.",
    "opposition": "Darrow Innes, Bronze Rank 1, Iron Path: dense, absorb-and-redistribute physical resilience that makes straightforward damage a losing strategy, an unhurried professional confidence that itself functions as a psychological weapon, and an escalating fourth-exchange press that abandons the earlier restraint for a fully committed strike meant to end the bout outright.",
    "turn": "In the fourth exchange, facing that committed strike with perfect clarity and no time to out-think it, the Wind-adjacent evasion alone is not enough to fully clear it — and in the same half-second his body reaches further, unbidden, for the Pressure-adjacent absorption as well, the two fragments arriving together for the first time and turning a portion of Darrow's own generated force back through the strike's origin, the same principle Darrow's own Iron Path relies on, met rather than avoided for the first time in his career.",
    "choice": "Cael commits to the combined response rather than fighting free of it or letting the moment cost him the win, absorbing the genuine bone-deep impact it still doesn't fully cancel, and uses Darrow's half-second of disorientation to close the distance and land the single precise strike at the one structural gap two weeks of patient study identified.",
    "outcome": "Darrow goes down — not dramatically, but decisively, the stillness of a body that has run out of capacity to keep absorbing — and Vell calls the match. Cael is genuinely hurt for the first time in the book: ribs aching, vision faintly wobbling, bruising he'll carry for a week, but he stands.",
    "closing_state": "Cael leaves the circle publicly and decisively established in Ardenmere exactly the way his strategy demanded, Darrow's respect and unsettled 'what are you' met with an honest 'I don't fully know yet,' Lira naming plainly that the combined use wasn't in the plan, and Cael that night committing to his notebook a line that admits, without resolving, that he still doesn't understand the mechanism underneath what his body just did."
  },
  "obligations": {
    "must_include": [
      "Cael wins the bout in the fourth exchange by forced fall/incapacitation; Vell's ledger later records it exactly as: 'Cael Hesk-ward, assessed-Copper, def. Darrow Innes (Bronze R1, Iron Path)'",
      "Darrow Innes's established fighting identity: Bronze Rank 1, Iron Path, dense absorb-and-redistribute physical resilience that makes straightforward damage ineffective, an unhurried professional confidence that functions as its own psychological weapon, and a shift in the fourth exchange into a fully committed strike meant to end the bout outright",
      "Cael's two-week tactical preparation with Lira (precision over power, accumulating damage at one compounding location rather than seeking a single knockout) and Feryn's scouting of Darrow's resilience-as-psychology as the visible foundation the fight tests and confirms",
      "The first combined deployment of the Wind-adjacent fragment (evasive angle) and the Pressure-adjacent fragment (force absorption/redirect) together, occurring in the fourth exchange against a strike Cael can see coming but cannot fully evade with either fragment alone: it must read as unplanned and instinctive, his body reaching for it faster than conscious choice, not a decision made in advance",
      "A real, visible physical cost from the combined use: a genuine bone-deep impact that still lands despite the redirect, an ache along Cael's ribs, a faint unfamiliar wobble in his vision, and bruising he will carry for a week — his first genuine injury in the book",
      "The boundary of what Cael still cannot do: he cannot explain, categorize, or reproduce the combination on command; the scene must close on his own notebook line admitting the mechanism is still unresolved: 'They're not separate things I switch between. They're one thing with parts I haven't found all of yet.'",
      "Darrow's post-fight reaction: composure replaced by genuine respect and unsettlement, explicit acknowledgment that nobody has ever met his Iron Path resilience with its own principle turned back on him, the question 'What are you?', and Cael's honest, insufficient answer, 'I don't fully know yet'",
      "Lira's post-fight reaction: immediately recognizing the combined use wasn't in the plan, naming it explicitly as the first time he's used both fragments together under real pressure, and the genuine fear she allows herself to show now that it has nowhere left to go",
      "The stakes the win changes, matching the chapter architecture exactly: no change to the underlying Compact threat or registry flag, but Cael becomes a publicly known person in Ardenmere that a specific, sizeable number of people would notice missing — the friction his visibility strategy was built to generate",
      "Vell's officiating cadence bookending the fight: her formal announcement of both fighters and the rules before the first exchange, and her call of the match closing it"
    ],
    "plants": [
      "The unexplained, uncategorized combined arrival of the two fragments in the fourth exchange — this is the plant for later fragment-mechanism development; it must read as a genuine, costly anomaly, not a mastered technique",
      "Cael's closing notebook line, 'They're not separate things I switch between. They're one thing with parts I haven't found all of yet' — plants the thematic beat the book's ending (Ch24) echoes"
    ],
    "payoffs": [
      "Payoff of Lira's two weeks of precision-over-power drilling against Iron Path resilience (Ch22): this is the fight that proves the method",
      "Payoff of Feryn's tactical scouting of Darrow's resilience-as-psychological-weapon pattern (Ch22): the read that shapes Cael's approach to the early exchanges",
      "Payoff of the Wind-adjacent fragment (planted Ch9, acquired Ch15) and the Pressure-adjacent fragment (acquired Ch17), both already individually established before this scene, now used together for the first time",
      "Payoff of Cael's deliberate visibility strategy (the reasoning he laid out to Lira and to Coss in Ch22): a decisive public win is the entire point of the marquee bout, not merely a fight to be won"
    ],
    "prohibited_outcomes": [
      "Cael losing, being incapacitated, forfeiting, or the bout ending on any exchange other than the fourth",
      "Naming, explaining, or mechanically resolving the combined-use capability as a new, third, or fourth fragment in any way — no on-page recognition that it is a distinct new capacity, no label for it, no explanation of how it works",
      "Expanding the combined use beyond its established boundary: no repeatable or on-demand version, no use of the combination anywhere in the scene outside the fourth exchange, no indication Cael can reproduce it at will",
      "Any injury or physical end-state for Cael beyond what is already established: no permanent damage, no injuries beyond rib/bruising-level impact and disorientation, no loss of consciousness",
      "Darrow losing consciousness, sustaining serious or permanent injury, or leaving the circle under anything but his own power",
      "Any killing blow or violation of the circuit's rules (to submission, incapacitation, or forfeit only)",
      "New named characters introduced into the bout itself or its immediate same-scene aftermath",
      "Disclosing any material that belongs to Chapter 24 or later: the senior-level registry flag Coss eventually finds, the unnamed stranger who later watches Cael in the market, or any academy interest — none of this exists in the story yet"
    ]
  },
  "invention_budget": {
    "allowed": [
      "Crowd and venue texture consistent with the Cinder House yard packed beyond capacity: torchlight-equivalent daylight detail, betting murmur, specific unnamed spectator reactions, and brief reactions from already-established background figures (Feryn, the baker, the errand boys, the old man from the yard's corner)",
      "Exchange-internal choreography: footwork, specific strike placement, breath, and physical sensation consistent with the established sequence of four exchanges and Cael's precision-accumulation method",
      "Background dialogue in established voices: Vell's officiating cadence, Lira's coaching register, Feryn's showmanship, Darrow's professional composure",
      "Sensory and physical detail of accumulating fatigue, adrenaline, and pain consistent with the injuries already established (ribs, bruising, disorientation)"
    ],
    "approval_required": [
      "New named characters of any kind, including additional named spectators",
      "New facts about Darrow's technique, background, or history beyond what canon and the state ledger establish (Bronze Rank 1, Iron Path, eight years of professional fighting)",
      "New facts about the Cinder House venue, the circuit's rules, or Vell's officiating beyond what is already established"
    ],
    "forbidden": [
      "New powers or fragments beyond the two already established for Cael (Wind-adjacent, Pressure-adjacent)",
      "Any change to the fight's outcome or method of victory",
      "Naming, explaining, or resolving the combined-use capability as a new or additional fragment",
      "Giving Cael knowledge outside the stated knowledge_boundary",
      "Altering the substance of Vell's ruling or ledger record",
      "Introducing new named characters into the bout or its immediate aftermath"
    ]
  },
  "context_files": [
    {
    ...
    {
      "kind": "arc",
      "label": "book 1 chapter architecture",
    ...
    {
      "kind": "previous_scene",
      "label": "seam immediately before the fight",
      "path": "v3-runs/book-01/packets/ch23-seam-before.md",
      "required": true
    },
    {
      "kind": "reference",
      "label": "seam immediately after the fight",
      "path": "v3-runs/book-01/packets/ch23-seam-after.md",
      "required": true
    }
  ],
  "verified_findings": [],
  "exceptions": [],
  "output": {
    "draft_path": "v3-runs/book-01/drafts/ch23-fight.md",
    "report_path": "v3-runs/book-01/reports/ch23-author.json",
    "editor_report_path": "v3-runs/book-01/reports/ch23-editor.json",
    "verifier_report_path": "v3-runs/book-01/reports/ch23-verifier.json",
    "target_words": 7220,
...
# CONTEXT — canon rules (universe/CANON_RULES.md)
...
# CONTEXT — book 1 chapter architecture (books/book-01-the-shattered/CHAPTER_ARCHITECTURE.md)
...
# CONTEXT — state ledger (universe/STATE_LEDGER.md)
...
# CONTEXT — name registry (craft/NAME_REGISTRY.md)
...
# CONTEXT — seam immediately before the fight (v3-runs/book-01/packets/ch23-seam-before.md)
...
# CONTEXT — seam immediately after the fight (v3-runs/book-01/packets/ch23-seam-after.md)

# Seam — immediately after the fight

The fight (and its same-chapter aftermath — crowd reaction, Darrow's concession, Lira's and Feryn's reactions, the old man's nod, the walk back to Torvin's, and Cael's notebook entry) is the entirety of Chapter 23 ("The Bout"), ending at line 139 of `books/book-01-the-shattered/chapters/chapter-23.md` ("...the district still murmuring about what it had watched that afternoon."), followed only by the file's closing section-break marker on line 141. There is no further prose inside chapter-23.md after the fight scene.

The next narrative content in the manuscript is the opening of Chapter 24 ("The Message"), which begins with the days-later aftermath of the win, including Vell's formal ledger record of the result. Verbatim, from `books/book-01-the-shattered/chapters/chapter-24.md`, lines 1–3:

---

# Chapter 24 — The Message

The days after the fight with Darrow Innes changed Cael's standing in Ardenmere exactly the way he'd hoped they would, though the shape of the change was quieter than he'd expected — less a dramatic shift and more a gradual settling into something that had already been building for months, now simply confirmed beyond argument.

Vell's ledger listed him, for the first time, by name rather than by rating — *Cael Hesk-ward, assessed-Copper, def. Darrow Innes (Bronze R1, Iron Path)* — a small administrative detail that carried, in the circuit's own logic, more weight than any amount of praise could have. He was, unmistakably now, a known quantity in a district that had learned, slowly and then all at once, to notice when he was there and to remark on it when he wasn't.

---

# MANUSCRIPT — v3-runs/book-01/drafts/ch23-fight.md

Cael arrived at the Cinder House yard two hours before the bout, which was one hour earlier than he had told anyone he would, and found that the yard had gotten there before him.

Not the crowd — the crowd was still arriving, would keep arriving until well past the point where arriving made sense — but the yard itself had already changed. Someone had cleared the training racks against the walls. Someone had chalked the circle wider than he'd ever seen it chalked, wide enough for a professional's range. The betting slates near the gate had been wiped and rewritten in a larger hand, as if the numbers themselves expected to be read from farther away. Cael stood in the entrance and did what he did with everything: he counted. Forty-one people already inside, at two hours out. The yard held perhaps three hundred standing, if nobody minded touching strangers. By the look of the queue forming along the outer wall, nobody was going to mind.

"Stop counting the house," Lira said, beside him. "The house isn't fighting you."

"The house is the point."

"I know the house is the point." She was carrying his wraps and her own nerves, and only one of those showed. "Count it after. When it's a number that means something."

He let it go, which she would know cost him nothing, because he already had the number he wanted. Three hundred witnesses, more outside. Two weeks ago, when he had asked Vell for this bout, that number had been the entire argument. A fourteen-year-old nobody could be made to disappear between one morning and the next, and the city would flow shut over the space he'd occupied. A fourteen-year-old that three hundred people had watched, wagered on, argued about — that was a different arithmetic. That was a boy whose absence would itch.

Whether the arithmetic actually worked — whether visibility could do the thing he had built this whole afternoon to make it do — was not something he could know yet. It was only the best answer he'd found to a problem that had no good ones, arrived at the night he'd understood that quiet wasn't protecting him. It had never protected anyone the Compact was interested in. It just made the paperwork easier.

Through the wall of sound behind them, the yard was filling the way a lock fills, pressure equalizing from every side. He could hear the errand boys who ran slate-changes for the bookmakers threading the crowd and calling numbers, their voices cracking with the importance of it. He could hear an argument about whether assessed-Copper meant anything against a real rating, and another argument about what the boy actually was, the word nobody said aloud sitting under both of them like a stone under cloth. The baker from the market lane had shut her stall for the afternoon — he'd seen her in the third row, arms folded, wearing the expression of a woman who had sold this boy bread at dawn for half a year and intended to see personally what the fuss was. In the far corner, on the bench that was his by decades of custom, the old man who kept the yard sat with his cane between his knees, still as furniture, missing nothing.

And then the crowd's sound changed pitch, and Cael knew without looking that Darrow Innes had come into the yard.

He looked anyway. That was the job.

Darrow crossed the open ground toward the circle the way other men crossed their own kitchens. He was not enormous. That surprised people, Feryn had warned — they expected the Iron Path to come wrapped in slabs, and instead it came in a broad, settled frame that had stopped needing to advertise years ago, a man with a fighter's economy and a face like the last page of a well-kept account book. He set his kit down at the far edge, nodded to Vell with genuine courtesy, and began his preparation without once glancing at the betting slates. He knew what they said. They had said some version of it for eight years.

He did glance, once, at Cael. It was not a hard look or a soft one. It was the look a professional gives a task: brief, complete, filed.

"He just measured you," Lira murmured.

"I know," Cael said. "I felt the tape."

Vell took the center of the circle without ceremony, and the yard, which had been shouting, discovered it could be quiet.

She stood the way she always stood, a woman in her fifties with her ledger under one arm and half a lifetime of the circuit's weight sitting on her patience. When she spoke she didn't raise her voice, and the yard bent close to meet it, which was the point.

"This is a recorded bout," Vell said. "Witnessed, wagered, and entered. Darrow Innes. Bronze, Rank One, Iron Path, eight years professional." A sound moved through the crowd, appetite and awe. "Cael Hesk-ward. Assessed-Copper, unclassified." A different sound. He was used to that sound. "The bout continues to submission, incapacitation, or forfeit, and nothing past my call. Nothing past my call," she said again, at the same volume, and somehow the second time was iron. "The circuit keeps this circle by keeping its rules. Anyone with an objection can carry it out through the gate."

Nobody carried anything anywhere.

"Fighters to the mark."

The chalked circle was wider than any circle Cael had fought in, and walking to the center of it took a long time and no time at all. Up close, Darrow smelled of cheap soap and old leather, and his breathing was the breathing of a man reading in a chair. He gave Cael a small nod — not warmth, not contempt, the plain acknowledgment of one tradesman arriving at a shared job.

"Whenever she says," Darrow said, mildly.

"Begin," said Vell.

For three full breaths, neither of them moved, and the crowd's silence took on weight. Cael spent the breaths the way he'd budgeted them: watching the stance settle. There it was, as advertised — the left side quiet, the right foot back and rooted, the whole architecture organized around receiving. Eight years of accounts had described it. None of them had conveyed the strange calm of standing in front of it, the sense of squaring off against a door in a hill.

Cael went in first, because someone had to and Darrow demonstrably wouldn't.

He opened with the best sequence he owned. There was no reason to hide it and every reason to spend it — a low feint flowing into a three-strike line he'd drilled until it lived below thought, elbow, ribs, jaw, each placement true, each landing exactly where he'd aimed it. He knew they were good strikes. He'd broken a Copper Rank 4's guard with the same line in the spring.

Hitting Darrow was like hitting the memory of a man. The strikes landed — he felt each one connect, clean — and the force went away. Not blocked. Not slipped. Received, the way the harbor wall received, and passed along somewhere with a courtesy that was worse than any counter. Darrow's head didn't move. His breathing didn't change. From half a pace away, Cael watched his own best work vanish into that broad frame like coins into deep water, and felt — measured, precise, unwelcome — the first cold touch of the thing Feryn had warned him was the actual weapon.

It doesn't matter. Nothing you do matters.

The crowd felt it too. Three hundred people made a sound like money changing its mind.

Darrow let him work for the length of the exchange, answering just enough to be honest — a push here, a short hooking counter that Cael gave ground before rather than test, one lazy-looking sweep that was nothing like lazy and that Cael escaped by a hand's width with his pulse suddenly loud. And all the while, under the futility, Cael did the thing he had actually come to do.

He took measurements.

Every strike that vanished told him where it went. He landed on the ribs and felt the load travel left and down. He landed on the shoulder and felt the same. Across, down, out through the rooted back leg — the road was real, exactly where two weeks of secondhand accounts had drawn it, and at the low left side, where ribs handed off to hip, he could feel the narrowing, the crossing, the one place on that whole quiet frame where the traffic had to slow. His body was learning the route the way Hesk's notebook had promised his body learned everything. Your body will learn before your mind does. His mind was taking notes anyway. That was the partnership.

They separated — Darrow stepped back first, unhurried, granting the exchange its end the way a man grants a break in a conversation — and the yard exhaled and began to roar, and the first exchange was on the books.

"Nothing," someone shouted from the slates, gleeful. "The boy landed six and nothing!"

Eleven to one drifted to fifteen.

At the circle's edge, Lira's face was carved calm. She held up one hand, fingers spread: the crossing. Confirmed?

Cael, circling, gave her the smallest nod. Confirmed.

The second exchange, Cael started boring.

He didn't look bored — he couldn't afford to look like anything but a boy fighting for his life, and mostly that required no acting. Darrow had decided the demonstration phase was over and had begun, without hurry, to fight, and the difference was immediate and educational. The counter that had looked lazy in the first exchange came again at real speed and Cael took it glancing across the forearm, a bright shock of pain that would be a bruise by evening, the yard's first blood-taste of what the odds were pricing. The sweep came again, paired with a short straight blow that Cael read half a beat late and escaped by giving up the whole center of the circle. Darrow walked him down calmly, cutting the space, thoroughly professional, entirely unbothered, and began teaching a second lesson with the same patient grammar as the first: you cannot hurt me, and I can hurt you whenever I decide the moment has arrived.

And Cael, paying for every opening in coin he could not afford many of, hit the crossing.

Not dramatically. That was the discipline Lira had run him through until he could have wept with the tedium of it — no wind-up, no announcement, nothing that looked like strategy. A short strike to the low left ribs in the middle of a scrambling retreat, thrown as if in desperation. A checked kick that skimmed the same handspan of side while his arms were busy surviving. An elbow, ugly and close, same place, as he was shoved out of a clinch he should never have been in. Same place. Every time. Even when it was boring. Even when it cost him — and it cost him: taking the angle that reached the crossing meant declining better angles, safer ones, twice meant eating a blow he'd seen coming, riding it with his frame the way he'd learned in a hundred circuit nights, jaw rattling, staying in.

Six strikes across the exchange, one address.

The seventh time, Darrow noticed.

It wasn't a stumble or a flinch — nothing so generous. It was a flicker of attention, an audit: the pale eyes dropped once to his own left side and came back up, and something behind them that had been running the bout on habit sat forward slightly. When the exchange broke — Cael backpedaling out of range, lungs burning, arm throbbing — Darrow didn't press. He stood in the middle of the circle he now owned, rolled his left shoulder a fraction as if consulting it, and looked at Cael with the first genuine expression of the afternoon. Mild. Interested. The way a man is interested in weather that has done something out of season.

"You've picked a spot," Darrow said. His voice didn't carry to the crowd. It was meant for two people. "They do that, now and again. The clever ones." He shook his head, not unkindly. "It's a wall, son. They keep thinking there's a door in it somewhere. There's no door."

Cael watched him settle into it. The stance deepened. The quiet left side came around square. The economy that had spent all afternoon receiving reorganized itself, plainly and without hurry, around sending — and the crowd saw it too, and the yard's roar sharpened into something with an edge of fright in it, and at the rope Lira's voice cut through everything, one word, his name, nothing else, because there was nothing else to coach. This was past the third. They had agreed not to plan here.

Vell had not moved. Her eyes were the only fast thing about her.

The fourth exchange began with Darrow crossing the circle like a tide.

Cael had perfect clarity. That was the terrible gift of it — no confusion, no blur, his fight-brain running clean and cold and fully lit, reading everything and mattering to none of it. He saw the feint that wasn't quite a feint, herding him left. He saw the second step close off the deep retreat. He saw the strike itself being born, down in the rooted legs, up through the hip, all of it, the whole committed account, eight years and a Bronze frame and every quiet exchange of the afternoon gathered into one blow whose only mercy was that it wasn't personal. He saw exactly where it would arrive and exactly when, and his mind — his good mind, his counting mind, the mind that had gotten him out of Denvash and through a dozen circuit bouts and past two Compact procedures — completed its arithmetic and returned the answer: not enough.

The Wind-adjacent angle was already rising through him. He'd stopped being able to prevent that days ago in drills; under real threat it came like flinching. And with the same cold clarity he could see it wasn't sufficient — the strike was too wide, too committed, thrown by a professional who had watched the impossible evasion once and priced it in. The clearance the Wind could buy him was a hand's width. He needed three.

What happened next, he did not decide.

He would go over it that night, and for many nights, and the honest account never changed: there was no moment of choosing. His body, already reaching along the Wind-adjacent line, reached further — past it, or under it, or through it, words all failed at the same place — and found the other thing, the Pressure-adjacent thing, Feryn's gift he'd only ever used alone and in fragments, and took hold of both at once.

They arrived together.

Not one then the other. Together — a single motion with two natures, the angle and the absorption, the escape and the receiving, folded into each other in a way he had never drilled, never imagined, never once produced in a hundred mornings of practice, and his body executed it with the fluency of something it had always known and simply never been asked.

He was inside the strike. Not clear of it — inside it, along it, the Wind-adjacent line threading him through the blow's committed geometry while the Pressure-adjacent thing opened and drank. Force came into him off Darrow's strike like a river finding a new channel — too much, far too much, more than the fragment alone had ever held — and some of it, some fraction his body metered by a logic he couldn't witness, turned. Reversed. Went back up the channel it had come down, through wrist and forearm and elbow and shoulder, back into the architecture that had generated it — Darrow's own force, arriving home along Darrow's own road, absorbed and redistributed into the one frame in the yard built on the principle that force must go somewhere.

For eight professional years, no one had ever sent it back.

The rest of the strike hit Cael.

Whatever his body had taken and turned, it hadn't taken all — the balance came through and landed, bone-deep, along his right side, a detonation of white that erased the crowd, the chalk, the count. He felt something in his ribs sound like a struck beam. The world tilted a half-degree and did not entirely tilt back; a wobble entered his vision at the edges, faint and liquid and wrong, like looking through the surface of disturbed water. Pain arrived a half-beat later, enormous, patient, moving in for a long stay. He was still on his feet. He didn't understand why. He didn't understand anything that had happened in the last half-second, and understanding was his whole method, and there was no time to mourn it, because in front of him, wrapped around the middle of his own returned strike, Darrow Innes had stopped.

Then he sat with his stylus over the page and tried to write down what had actually happened in the half-second that won it, and found that he couldn't.

Not wouldn't. Couldn't. He tried three openings and scratched all three out. It wasn't the Wind and then the Pressure — that was false, and the notebook was no place for false things. It wasn't a technique; techniques could be described to be repeated, and he could no more describe it than describe how he grew. He had reached for one thing and arrived holding both, and the how of it sat exactly where the light of his attention didn't reach, the way it had sat all evening, the way he suspected it would go on sitting no matter how many mornings he and Lira spent drilling for lightning. His body had known something all the way down. His mind had been informed afterward, like next of kin.

He wrote, finally, the only sentence that survived scratching out. It wasn't an explanation. It was a boundary marker — a fence around the thing he didn't understand, so that at least he'd always know exactly where his understanding stopped.
...
word_count=7294
target_range=5776-8664
word_target_state=WITHIN_TARGET

---

# AUTHOR REPORT — v3-runs/book-01/reports/ch23-author.json

{
  "schema_version": "3.1",
  "run_id": "b1-ch23-fight-r1",
  "scene_id": "b1-ch23-fight",
  "status": "DONE",
  "draft_path": "v3-runs/book-01/drafts/ch23-fight.md",
  "word_count": 7294,
  "obligations": [
    {
      "obligation": "Cael wins the bout in the fourth exchange by forced fall/incapacitation, consistent with Vell's later ledger line",
      "status": "MET",
      "evidence": "Fourth exchange: Darrow goes down after the tenth accumulated strike at the crossing ('his legs simply concluded... He tried to rise... and got silence. Not injury. Depletion.'). Vell calls it on-page: 'The bout is called. Cael Hesk-ward. By incapacitation. Fourth exchange... It goes in the book as it happened' — fully compatible with Ch24's ledger record 'Cael Hesk-ward, assessed-Copper, def. Darrow Innes (Bronze R1, Iron Path)'."
    },
    {
      "obligation": "Darrow's established fighting identity: Bronze Rank 1, Iron Path, absorb-and-redistribute resilience, unhurried confidence as psychological weapon, fourth-exchange committed strike",
      "status": "MET",
      "evidence": "Vell announces 'Darrow Innes. Bronze, Rank One, Iron Path, eight years professional.' Exchange one dramatizes futility-as-weapon ('It doesn't matter. Nothing you do matters'); Feryn's briefing names it explicitly ('The Iron Path is the floor. The futility is the fight'). Fourth exchange opens with Darrow visibly reorganizing from receiving to sending and committing the 'whole account' to one bout-ending strike."
    },
    {
      "obligation": "Two-week tactical preparation with Lira (precision over power, one compounding location) and Feryn's scouting (resilience-as-psychology) as the visible foundation",
      "status": "MET",
      "evidence": "Pre-fight: Feryn's last-time recital of the scouting (his notes, a former Copper-tier fighter's account, a circuit veteran's impressions); Lira's drill litany 'Same place. Every time. No matter what the rest of you is doing.' Execution: exchanges two and three are built on accumulation at the rib-to-hip crossing; the notebook entry credits it: 'Lira's method won this fight.'"
    },
    {
      "obligation": "First combined deployment of Wind-adjacent + Pressure-adjacent in the fourth exchange, unplanned and instinctive, against a strike neither fragment alone could answer",
      "status": "MET",
      "evidence": "'What happened next, he did not decide... his body, already reaching along the Wind-adjacent line, reached further... and found the other thing... and took hold of both at once. They arrived together.' The Wind angle is explicitly computed as insufficient beforehand ('The clearance the Wind could buy him was a hand's width. He needed three'). A fraction of Darrow's force is turned back through the strike's origin — his own principle met rather than avoided."
    },
    {
      "obligation": "Real visible physical cost: bone-deep impact, aching ribs, faint unfamiliar vision wobble, week-long bruising — first genuine injury of the book",
      "status": "MET",
      "evidence": "'The rest of the strike hit Cael... bone-deep, along his right side... He felt something in his ribs sound like a struck beam... a wobble entered his vision at the edges.' Night scene: 'deep, spreading dark under the skin, rib to hip... a week's tenant at least, his first real injury.' Lira prescribes a week off training."
    },
    {
      "obligation": "Boundary preserved: Cael cannot explain, categorize, or reproduce the combination; scene closes on the exact notebook line",
      "status": "MET",
      "evidence": "Notebook scene: 'he tried to write down what had actually happened... and found that he couldn't. Not wouldn't. Couldn't.' Three openings scratched out; no mechanism given anywhere, including the fragment notice ('Concurrent function: recorded' — no explanation). Final line of prose is verbatim: 'They're not separate things I switch between. They're one thing with parts I haven't found all of yet.'"
    },
    {
      "obligation": "Darrow's post-fight reaction: respect, unsettlement, acknowledgment that nobody has ever returned his Iron Path principle, 'What are you?', and Cael's 'I don't fully know yet'",
      "status": "MET",
      "evidence": "Darrow rises under his own power, crosses to Cael: 'Nobody ever gave it back... tonight the wall got its own principle handed back up the road it came down... I know every way that isn't possible.' Then the naked question 'What are you?' and Cael's verbatim answer 'I don't fully know yet.' Handshake and professional exit on his own legs."
    },
    {
      "obligation": "Lira's post-fight reaction: recognizes the combined use wasn't the plan, names it as the first time both fragments worked together under real pressure, and shows the fear now that it has nowhere left to go",
      "status": "MET",
      "evidence": "'That wasn't the plan,' followed by her naming it plainly: 'until this afternoon I had never once seen them at the same time — because it's never happened. Has it. That was the first time. Both of them. Together.' Then: 'she let the fear arrive... undefended, the whole afternoon's worth... because it finally had nowhere left to go,' plus her stated after/during arrangement."
    },
    {
      "obligation": "Stakes changed per chapter architecture: no change to Compact threat or registry, but Cael becomes a publicly known person a sizeable number of people would notice missing",
      "status": "MET",
      "evidence": "Opening frames the arithmetic (three hundred witnesses as the entire argument); closing walk renders it concretely: forty-one greetings counted, his name in strangers' mouths, 'three hundred threads woven made the only armor left.' Explicitly bounded: 'Whether it would hold against what was actually coming... was tomorrow's arithmetic' — no registry or Compact change claimed."
    },
    {
      "obligation": "Vell's officiating cadence bookending the fight: formal announcement of fighters and rules before the first exchange; her call closing the match",
      "status": "MET",
      "evidence": "Opening: 'This is a recorded bout. Witnessed, wagered, and entered... The bout continues to submission, incapacitation, or forfeit, and nothing past my call.' Closing: 'The bout is called. Cael Hesk-ward. By incapacitation. Fourth exchange.'"
    },
    {
      "obligation": "Plant: the unexplained combined arrival as a costly anomaly (fragment-mechanism development)",
      "status": "MET",
      "evidence": "The combination is never named, never explained, costs a genuine injury, and resists reproduction even in reflection ('drilling for lightning'). The spare fragment notice records concurrence without explanation, reinforcing the anomaly."
    },
    {
      "obligation": "Plant: closing notebook line echoed by Ch24/book ending",
      "status": "MET",
      "evidence": "The manuscript's final line is the exact planned sentence, standing alone as the last line of prose."
    },
    {
      "obligation": "Payoffs: Lira's precision drilling (Ch22), Feryn's scouting (Ch22), both fragments' individual establishment (Ch15/Ch17), and the visibility strategy (Ch22)",
      "status": "MET",
      "evidence": "Drilling pays off as the winning method (tenth strike at the crossing); scouting shapes exchanges one and two on-page; Wind-adjacent used alone in exchange three (consistent with its Ch17 combat debut), Pressure-adjacent attributed to Feryn ('Feryn's gift'); visibility strategy is the fight's stated purpose from the first scene and its payoff is the closing walk."
    }
  ],
  "inventions": [
    "The specific rendering of the structural gap in Darrow's resilience: absorbed force routes across, down, and out through his rooted back leg, narrowing at a rib-to-hip 'crossing' on his low left side; accumulation works by keeping the route loaded so redistribution slows (exchange-internal choreography implementing the packet's required 'one structural gap')",
    "Exchange-by-exchange choreography: exchange one as deliberate measurement-taking against permitted strikes; exchange two as six accumulating strikes at one address; exchange three as Darrow's geometric denial and squeeze including one solo Wind-adjacent evasion; exchange four as the committed strike, combined response, and finishing strike",
    "Crowd and venue texture: betting drift from eleven-to-one to fifteen-to-one and closing at thirteen, wiped and enlarged betting slates, roughly three hundred standing capacity as Cael's counted estimate, roped-off fighters' preparation corner (dressing on established Cinder House yard, no new venue facts asserted as canon)",
    "Brief reactions from established unnamed background figures per budget: the baker (closes her stall, third row, presses a loaf on Lira after), the errand boys (running slate-changes, shadowing the walk home), the old man in the yard's corner (one-degree nod)",
    "Dialogue in established voices: Vell's spare officiating, Lira's coaching litany and after/during 'arrangement', Feryn's showman-then-professional register and his eleven-to-one wager, Darrow's composed professional courtesy ('It's a wall, son... There's no door')",
    "Sensory cost detail consistent with established injuries: forearm bruise, small facial cut, glass-hinge ribs, liquid ghost at the edge of vision fading through the evening",
    "A terse combined-use fragment notice in the established notice format ('Concurrent function: recorded. Integration: partial. Tier equivalent: unknown.') — records concurrence only; names, explains, and resolves nothing"
  ],
  "state_change_proposals": [
    "Cael: first genuine injury — right-side rib bruising (rib to hip), roughly one week recovery; faint vision wobble on the fight night, fading by end of scene; no training until Lira clears him",
    "Cael: publicly established in Ardenmere as a known, named person (circuit and district level); visibility-as-armor strategy achieved its intended effect; no change to Compact threat, registry state, or monitoring",
    "Fragments: Wind-adjacent and Pressure-adjacent registered as functioning concurrently for the first time (fourth exchange only); not reproducible on command; mechanism unexplained in-world and on-page",
    "Darrow Innes: defeated by incapacitation (capacity depletion, no lasting injury), departed under his own power; holds genuine respect for and open curiosity about Cael ('When you find out, the circuit will hear it')",
    "Lira: has explicitly named the combined use as unplanned and unprecedented; intends structured investigation of it once Cael heals",
    "Vell's ledger: bout recorded — Cael Hesk-ward, by incapacitation, fourth exchange (formal ledger phrasing surfaces in Ch24 per canon)"
  ],
  "deviations": [
    "The chapter architecture stages a third fragment notice ('first combined-use integration') that the scene packet's must_include list omits. I included a minimal notice in the established format that records concurrent function without naming, explaining, or resolving the capability, reading the packet's prohibitions as barring recognition of a NEW capacity rather than barring the system's bare record of the two established fragments co-firing. If the editor reads the prohibition more strictly, the notice block (night scene) can be cut cleanly with no downstream dependency — the notebook close does not rely on it.",
    "Word count 7294 vs target 7220 (+1.0%), well inside the 20 percent tolerance."
  ],
  "blockers": []
}
