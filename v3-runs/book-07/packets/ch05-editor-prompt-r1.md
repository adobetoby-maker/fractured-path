...

{
  ...
  "revisions": {
    ...
    "arc": "arc-b7-v2 (books/book-07-void-roads/CHAPTER_ARCHITECTURE.md, editor PASS r4, Chapter 5 card)",
    "state": "state-b7-post-ch04 (v3-runs/book-07/STATE_RUNNING.md + base snapshot)",
  ...
  "pov": {
    ...
    "knowledge_boundary": [
      "Cael is eighteen; nine fragments + anomaly; party is FIVE. Injuries from Chapter 3 are still open but improving without a healer: Brom's forearm bound; Lira's ankle taped and never seen by a healer; Cael's calf mostly closed; Karis's hands healed to scars.",
      "Oxhollow (a ford settlement north) is named for the first time as the hold posting the contract; nobody from Oxhollow appears. Oryn is unmet; no healer; no Tide.",
      "'Quiet ground' is a rumor the party has heard once (Chapter 4); it is not on this route and is not discussed beyond, at most, one passing thought.",
      "Shale-backs are NEW to the party. The carters' rule comes from Pike, quoted by Seln: 'Never be below them. Never be loud below them.' Karis derives, from a day's observation, that the herd moves as a unit AWAY from declarations — the stillhounds' sense with the opposite response: flight, not hunt. On a slope, flight is a landslide with legs. This is derived on the page; the ledge collapse and the stampede are Chapter 6 and must NOT happen here.",
      "Teague's crew is on the hold contracts again; no contact."
    ]
  },
  "purpose": "The route-scouting contract set up with the care the series gives its hinge fights: the book's first true freedom chapter (five days of high country, cataloguing at scale, nothing measuring him, everything interesting) that also teaches the shale-backs properly before the mountain kills the cart in Chapter 6. Deliver Arc 3's promise whole here — Cael free — before the book complicates it.",
  "scene_shape": {
    "opening_state": "Lowmarch's board: a hold-posted, well-priced contract from Oxhollow's ford — scout the high traverse to Thornwater before the autumn carts: a scree route along a shale bench above a gorge, two days shorter than the void road, unused for three seasons since a slide. The five take it because it pays, because Teague's crew is on the hold contracts, and because Cael wants a job that is ground, not teeth — a scouting run is cataloguing at scale, and he has never once been paid to catalogue.",
    "pov_goal": "Map the traverse well enough that a hold will trust a cart to it — and, privately, to be somewhere nothing measures him and everything is interesting.",
    "opposition": "The ground: shale, a bench, a gorge; the injuries slowing them; and, from the second day, a herd of thirty shale-backs grazing the bench above — placid, armored, the size of carts, and a rule about them the carters live by.",
    "turn": "The walk up as freedom: Karis mapping, Lira running the bench ahead on a taped ankle, Brom load-balancing the cart on a road that wants to kill it, Seln finding campsites before anyone knows they need one, Cael writing in the log at every halt the way he wrote in the observation notebook at every bout. Then the shale-backs, introduced at distance and taught (charter §1.1): thirty on the bench above, grazing lichen off the shale; Seln quoting Pike's rule; Karis spending a day's halt on their movement and deriving the thing that will matter — the herd moves as a unit, and the unit moves AWAY from declarations; flight, not hunt; on a slope, flight is a landslide with legs.",
    "choice": "They keep going up, quiet, because the rule is simple and they have been quiet for four days; Cael writes the fourth-night entry: the traverse holds, the map's good, the loudest thing on the mountain is them and they've been quiet — 'First honest job I've ever had that didn't have a fight at the end of it.' He is choosing to believe the job has no teeth.",
    "outcome": "The traverse two-thirds scouted and mapped by the fifth night; the bench narrowing ahead to a ledge over the gorge; the herd above and behind them.",
    "closing_state": "The chapter ENDS ON THE LOG (the previous chapter ended on dialogue): the fifth night — Lira at the fire, taping the ankle that never got a healer, saying she'll run the ledge at first light to see if it holds a cart; and Cael's entry: 'The traverse holds. The map's good. Karis says the herd moves off declarations, which means the loudest thing on this mountain is us, and we've been quiet for five days. One more day. First honest job I've ever had that didn't have a fight at the end of it. Sleep.'"
  },
  "obligations": {
    "must_include": [
      "The contract taken at the board for the three stated reasons (pay; Teague's crew on the hold contracts; Cael wanting ground, not teeth — paid to catalogue for the first time).",
      "The freedom movement rendered as scene and cataloguing, not summary: high country, the gorge opening below, each companion at their competence (Karis mapping; Lira running the bench; Brom and the cart; Seln and the campsites), Cael logging at every halt. Injuries carried (taped ankle, bound forearm, the calf, the scarred hands).",
      "Shale-backs taught before they matter: seen at distance (thirty, armored, placid, the size of carts, grazing lichen); Pike's rule via Seln verbatim: 'Never be below them. Never be loud below them.'; Karis's day-long observation and derivation (unit movement; flight from declarations; 'on a slope, flight is a landslide with legs' or equivalent in her register). No stampede occurs.",
      "The fourth-night log entry (content as in scene_shape) mid-chapter.",
      "The chapter ENDS on the fifth-night image-then-log exactly as in closing_state — Lira taping the ankle and announcing the ledge; the final words are Cael's entry ending 'Sleep.'",
      "Cael's cataloguing at scale (a map, a bench, a herd) outside the log at least once; the three boxes in the cart glimpsed once (load-bearing in Chapter 6).",
      "Manuscript format: H1 '# Chapter 5 — Route', prose only, '---' breaks, ends on the last line of prose."
    ],
    "plants": [
      "Shale-backs flee declarations as a unit; below them is the wrong place to be loud (Chapter 6's engine).",
      "The ledge over the gorge that Lira will run at first light (Chapter 6 opens there).",
      "The three boxes riding in the cart (Chapter 6 costs the cart).",
      "Lira's ankle, never seen by a healer (Chapter 6).",
      "Oxhollow as a ford settlement on the route (Oryn's route, Chapter 7)."
    ],
    "payoffs": [
      "Chapter 4's want-lines lived: Lira running, Brom holding, Karis mapping, Seln scouting — each priced by what they do.",
      "Chapter 3's stillhound sense rhymed and inverted by the shale-backs (Karis names the rhyme)."
    ],
    "prohibited_outcomes": [
      "No ledge collapse, no stampede, no fight, no new injury — those are Chapter 6.",
      "No fragment use by anyone; no declarations (the mountain is walked quiet).",
      "No Oryn, healer, Tide; no quiet ground beyond one passing thought at most; no ruins/stakes/Quieting.",
      "No Teague contact; no letters; no Vastin; no watchers.",
      "No new named people; no new places beyond Oxhollow (named), the bench, the gorge, the traverse (descriptive).",
      "The chapter does not end on dialogue or an image; it ends on the log entry.",
  ...
  "invention_budget": {
    "allowed": [
      "Mountain sensory detail (shale, lichen, wind, cold, the gorge's sound, campsite texture); the cart's mechanics on scree; the herd's appearance and grazing behavior; five days compressed with scenes at halts.",
      "Dialogue in established voices; Karis's derivation in her method-register; Seln's one-line rule.",
      "Cael's log entries at halts in his plain register (more than one)."
    ],
    "approval_required": [
      "Any new named entity; any shale-back behavior beyond herd cohesion, placidity, and flight from declarations; any fact about Oxhollow beyond 'a ford settlement north on the route'."
    ],
    "forbidden": [
      "The collapse/stampede; fragment use; healing; Part 2 knowledge; a dialogue or image ending; metadata."
    ]
  },
  "context_files": [
    {
    ...
    {
      "kind": "previous_scene",
      "label": "Chapter 4 as drafted — the immediate seam (injuries, wants, Pike's line)",
      "path": "v3-runs/book-07/drafts/ch04.md",
      "required": true
    },
    {
      "kind": "reference",
  ...
  "exceptions": [],
  "output": {
    "draft_path": "v3-runs/book-07/drafts/ch05.md",
    "report_path": "v3-runs/book-07/reports/ch05-author-r1.json",
    "editor_report_path": "v3-runs/book-07/reports/ch05-editor-r1.json",
    "verifier_report_path": "v3-runs/book-07/reports/ch05-verifier-r1.json",
    "target_words": 4600,
...
## After Chapter 5 (draft r1 with editor; provisional until PASS) — the high traverse, fifth night
...
# CONTEXT — Chapter 4 as drafted — the immediate seam (injuries, wants, Pike's line) (v3-runs/book-07/drafts/ch04.md)

# Chapter 4 — What the Board Prices

The calf held for eleven paces at a time.

He learned the number on the second morning, crossing the yard from the loft to the well, because the leg was a thing he owned now and he inventoried what he owned. Eleven paces on the flat; then the bite reminded him, in and out, where the teeth had gone, and he put the weight forward onto the other foot for a pace and started the count again. Twelve if the ground fell away. Nine if it climbed. By the third day he had the yard mapped in elevens.

Inventory, taken at the foot of the loft ladder each morning, because the ladder was where everyone passed.

Brom's forearm: bound wrist to elbow in the woman's boiled cloth, the cloth gone dark at the wrist by the second day and cut off on the third. The woman came up the ladder with the pot and did it without asking. Brom held the arm out and looked at the wall while she washed the thing under the cloth and wound new cloth over it, tighter, and when she said "Don't use it," he said "No," as if it were the same conversation continued. He carried nothing. It was the first time Cael could remember seeing the three boxes on a floor with Brom standing beside them and not under them.

Lira's ankle: off the ground three days on the woman's order, and on the fourth a stick, a hay-fork's handle Seln had cut down to her height without being asked. The swelling had gone down far enough to show the shape, and the shape was not the shape of the other one. It bent where an ankle bent, but less, and later. She walked the yard on it with the stick and her mouth shut, and on the fifth day she came back from the gate and said, to nobody, "It's setting stiff," and the woman, passing with buckets, said, "It'll set how it sets," which was a verdict and not a comfort.

Karis's hands: wrapped still, the fingers free from the second knuckle out, and the palms under the cloth a thing she did not look at when the wrapping was changed. She could hold a cup between the heels of both hands. She could not hold a pen — and then, on the fifth day, she could, if holding was the word for it: the pen laid across the wrapped palm and pinned there by two fingertips and a thumb, the whole hand moving from the elbow because the wrist would not close. She took the notebook back from him that morning without saying anything about it, and he let her, and read over her shoulder what came out. The letters were twice their size and leaned two ways at once. Above the day's first line she had written, slowly, and it was still bad: *Hand poor. Fifth day after. Entries stand as written.* Then she had gone back and underlined *stand*.

And the calf, in elevens.

Four of five. He had written it the first night and Pike had written it on the slip and the yard confirmed it every morning at the ladder: four people healing slow or healing wrong, and one who was not hurt and went down to the ford at every dusk and came up at full dark and said "Nothing."

Nobody mentioned the limp. He had expected Lira to. She looked at his leg once, on the second day, at the well, and then at her own foot, and did not.

---

The steading had a table.

It stood at the barn's far end, a long plank on trestles where the woman set out bread for the carters at harvest, and there was no harvest and no bread on it, and Karis asked for it on the third day the way she had asked the woman for the ford's lore: plainly, with the notebook open under her arm. The woman looked at the wrapped hands, and at the three boxes at the ladder's foot, and said the table was a table, and went away.

Brom could not lift the boxes and did not try. Seln and Cael brought them down one at a time and set them on the plank in the order Karis named — left, middle, right — and she opened them with her fingertips, one lid, then the next, then the third, and stood back.

He had seen inside them a hundred times and catalogued them anyway, because it was the first time all three had been open at once, in daylight, on a surface that was not a floor. Paper, mostly: copies in her hand, in Prynn's, in hands he did not know, tied in bundles by subject, the subject on a slip under the string. A folding rule. Chalk. A tin of pencils. Two bound books carried out of three academies and never once opened on a road. Three years of a researcher's life packed as a carter packed grain: tight, by weight, nothing loose.

She could not lift the bundles, so she pointed, and Seln lifted, and by noon the boxes were empty and the plank was full, and it was — he looked for the word and found the one she would have used — a library. Shelves with no wall behind them. The bundles stood on end in rows with their slips facing out, and she walked the length of the plank with her wrapped hands held behind her back and read the slips like a woman reading a street she had lived on for years and never seen from above.

"There," she said. "That's everything I know."

"It's a lot," said Brom, from the door.

"It's everything I know about the wrong country." She had reached the right-hand end. "Every line on this table was written inside. Registry stone, academy stone, copies of copies from archives with doors on them. All of it is *before the Line*. I've walked eight weeks in a place where nothing is verified and every cart that passes me has a man on it who knows something, and I have not got one line out of any of them I could set on this table under a slip." She looked at the hands. "And I couldn't write it if I had."
...
The grain moved on the fifth day, because the ford was clear and the rain was a day off. Six carts came up from the Lowmarch road empty in the morning and stood in the yard loading, and with the carts came carters, and with two of the carters their wives, who drove; and Karis went out into the yard with the notebook against her forearm and the pen pinned in the wrapped hand and asked every one of them the same thing.

The question was the void roads. Not the dogs — the dogs were under a slip. The roads: which ones, and where they went, and what a carter knew about the stretches that the map on Pike's plank drew as a dashed line stopping in nothing.

Most of them told her which roads. Two told her where they went. One, a man with a clouded eye, told her he did not talk about roads to paper, and she wrote that down too.

The carter's wife was on the fourth cart, a woman of forty in a coat cut for a bigger person, the reins once round her fist and a boy of ten beside her on the board. She listened to the whole question with her head to one side, and when Karis had finished she said:

"You mean the quiet ground? Everybody knows the quiet ground. Nobody goes in."

Karis stood very still.

Cael, at the barn door with the calf on its ninth pace, watched her not ask. He watched her want to — the whole body leaned toward the want, the pinned pen coming up — and then the woman clicked at the mule and the cart went forward a length in the line, and the boy on the board looked back at the two of them once, with no expression at all, and that was the end of it. The woman had said it the way the steading's woman had said *it's because you die*: as a stair is a stair. There was nothing under it that a question could reach.

Karis wrote it down where she stood. Three sentences, the letters twice their proper size and leaning, the hand moving from the elbow. He read them upside down as they went in. Then she went back over the second sentence and underlined, twice, the two words that were not a place and not a rule but a claim: *everybody knows*.

"That," she said, "is a source." She closed the book on it. "Not a good one. The first."

She did not say anything else about it, and neither did anyone, that day or the next, because the grain was moving and they were moving with it, and a rumor with a line under it was a thing that kept.

---

They went down with the grain, because there was no other way to move three boxes with one man who could carry them and could not lift his arm.

The boxes rode on the second cart, roped, with Karis walking at the rope's end with her wrapped hand on it, not holding, touching. Lira walked the first mile on the stick and then got up on the tail of the lead cart and announced that it was her decision, and it was. Brom walked beside the wheel with the bound arm against his chest and the other hand on the cart's rail. Seln was ahead. He was always ahead. The stretch came at noon, at the hour he had named, and the scrub made its ordinary noise the whole two miles, and the carters, who had not walked this road in a month, talked the whole way through and did not know they were doing it.

Cael walked in elevens.

The steading's woman had said the last of it at the gate, to Lira and not to any of them, with the buckets down for once. "It's set stiff. It'll set stiffer. Healer would've had it straight in an hour." Lira, from the cart's tail: "There isn't one." The woman: "There's not. They stop inside, where the tiers are." And she had gone back through the gate, and the count of it — one healer for a country, walking a route, not due — went into his head beside the ledger with no tier column in it, and he did not put a verb between the two, because it was not his sentence to write yet.

They camped the first night at the road's turn above the wash, six carts in a ring and the mules inside it, and a fire the carters lit without asking anyone, because the stretch was behind them.

Brom's cloth had gone dark again at the wrist.

He unwound it himself, one-handed, teeth on the end when a hand was short, and did not ask for help, and Cael got up and held the loose end without being asked, because that was the arrangement. Under the cloth the forearm was closed along most of its length and open at the wrist, where the bone had been nearest the air, and it was clean, and it was not right, and Brom looked at it with the face he had for a lock somebody else had built. He wound the new cloth from the wrist up. "Tighter," he said, once, and Cael pulled, and Brom tied it off with his teeth and the good hand and put the arm back against his chest.

Lira had watched from the cart's tail. She had the boot off and the foot in the firelight, turning it as far as it turned, which was not far.

"At Norhold," she said, "I told them I wanted to become something they hadn't seen yet."

She said it to the fire. Not to Cael; not to any of them. Karis, across the ring with her hands in her lap, went still the way she went still for a source.

"They wrote it down. It was the thing you were supposed to say, and I meant it, and they wrote it in the column for things people say." She turned the foot the other way. "The Silver bracket was the ladder. Every rung has a number on it and the number is how you know you've climbed, and a panel at the top of every flight tells you what you've become since the last one. I walked out of it." A pause, with the fire in it. "On purpose, at full price, and I'd do it again. I'm not saying anything about that."

"You're saying something," said Brom.

"I'm saying that on the bar I was fast." She put the foot down. "Faster than I've been with Wind. I don't know if that's true. Nobody was counting. I know it's what it felt like, and I know I did it on a floor I can't run on anymore, and the next time I run there's going to be nobody at the end of it with a number." She found the exact sentence and said it to the fire. "So what am I becoming, exactly, if nobody's measuring?"

Nobody answered at once.

"Fast," said Brom, eventually, because it was the word he had.

"I know I'm fast. I was fast at fourteen. Fast was the *floor*." She reached for the boot. "Something they haven't seen yet, I said. Well. They haven't seen it. They're not here to see it. That isn't the same as becoming it, and I don't know what would be."

Karis said, quietly, "Neither do I. I'd write it down if I could."

"Write it when you can."

Cael did not answer, because it had not been asked of him, and because he had spent four years being the thing no instrument could read and had never once heard it put as her question. The same fact could be his relief and her want. He filed that, and did not write it down that night, because it was hers first.

Lira got the boot on. She did not ask it again. It was the ankle she rubbed, afterward, not the question.
...
"Thornwater," he said, to the page. "Read it at the plank a week ago. Saying's tonight, at the book, if you want to hear it said."

"We do," said Cael.

"Then tonight." The pen did not stop.

Cael read the board. Fourteen slips where there had been sixteen. The ford was gone from it. The autumn road was gone — HOLD, Teague, sixty and fed; walked, then, or being walked — and the grain escort at thirty, and in their places two escorts and a fence-line and a well to be cleared, priced at four. He read all fourteen twice and sorted, and while he sorted Seln read them beside him, and Cael stopped sorting and watched Seln read.

He had watched Seln read rooms for four years. He had not watched him read a board. The eyes went down the fourteen slips once and came back up them once and stopped on three, and the three were the ones Cael would have marked as the only ones that paid for what they asked, and Seln had not been counting marks. He had been placing them. The well was on the south road, which he had walked; the fence-line was the steading's that had called them cheap, which he had walked round. He had walked every road out of Lowmarch in the four days before the ford, the way he had walked every road out of Thornwater, and had told nobody, because nobody had asked.
...
"Fifteen years," Seln said. "Every road, every ford, every door. Somebody asked. Somebody always asked; that was the whole of it; the asking was the job and I was the answer, and I never liked one of them." He took the finger off the slip. "Eight weeks. I've walked every road out of two places. Nobody's asked."
...
"No." Seln turned, finally. "Not if you ask. That's the thing I'm finding out. I don't want to be asked. I've been asked. I wanted to see what I did with it when nobody did." He looked at the board a moment longer. "It turns out I take the well, and I walk it first, and I say nothing. It's the same craft. It weighs less." He went back to the slips, and that was the report.

---

Brom had gone to the plank's near end while they read, and stood there with the bound arm against his chest, and waited for Pike to reach the end of a line.

Cael was at the plank's far end with the fourteen slips and did not move, because Brom had gone there to say something without the crew, and a man who wanted the crew went where the crew was. He heard it anyway. He heard everything at a plank, and Brom did not lower his voice so much as flatten it.

"What does the board pay a man with no Path at all."
...
Brom took a slip off Pike's stack of old ones, the carters' stack, backs of backs, and Pike let him. He wrote on it, on the plank, with the wrong hand, because the right one was in cloth. Five words on one line and three on the next. He read it once, folded it twice, and put it inside his shirt against the skin, and gave the pencil back, and said nothing, and went to stand with Lira at the roof's edge.

Brom had written down what somebody said to him once before in his life that Cael knew of. Rooke, on the third day of a season that had made him worse on purpose. He had said so at the time, and had said he was quoting, and had quoted, and it had been the only time in four years Cael had seen a pencil in that hand.

That made two.

Pike had not looked up. "He had a number, then," he said, to the page. "Inside."

"He found it," said Cael. "They never wrote it in."

"Then it's the same as mine." Pike wiped the pen. "Copper. Thirty years on the roads. I stopped carrying the paper the second year, because it weighs, and out here nobody's buying the weight." A pause, at the pen. "Held a dog with a shoulder and a river, that one. That's on a line in my book. There's no line for the other thing, and nobody's ever asked me to make one."

---

The ferry came in at the fourth hour after noon, with the sack.
...
Paper folded to a palm's width, and a hand on the outside that he had known before he could read: the cramped, exact, instrument-maker's letters that had written every label in a shop in Denvash for twenty years, as if a letter were a gauge and the address its calibration. *Cael. Past the Line.* Nothing else. It had come through three hands and a ferry to exactly the man it named, because past the Line there was one board where names were kept, and Hesk had counted on that without ever having seen it.

He did not open it at the plank.

He opened it under the ash, ten paces on from where the ash had been theirs, sitting on a box, with the log open on his knee because that was where letters went when he had read them. The date at the top was three weeks gone — written, he worked out, while they were still walking the first road jobs. Before Thornwater. Before the ford. Hesk had known where they were and nothing of what they had done there, and had written anyway, into the space where the knowing would be.

*Past the Line. Your grandmother crossed it once, before you were born, on a trade run; she said the roads were honest and the food wasn't. Mind the roads. Send word when there's a roof. — H.*

He read it once. That was the whole of it, and it was, for Hesk, long.

He put it in the satchel, flat, against the leather book, where the others were. Then he sat a while with the log open and the pen not moving and looked at the ash, which was not a roof, and at the meadow, which was not one either. The ferry went west again in a month. He had a month to find a roof or to write that there was not one, and he found that he did not know which he would rather send.

He had not known about the grandmother. He filed that as what it was: one sentence, from a man who did not spend sentences, and a new fact about his own life arrived by ferry three weeks old. He did not ask it anything. Hesk had said *mind the roads* and underlined nothing, because Hesk did not underline, and it landed as an instruction that was also the whole of what the man could say.

Then he wrote, because the letter was in the satchel and the log was on his knee and it was the sixtieth day.

---

*Sixtieth day. Lowmarch. The meadow, under the ash, ten paces from where it was ours.*

*Inventory. Nine confirmed, one anomaly, patience. Deployment since the Line: one, the ford, paid. Shadow tried at the landing when the ferry came in and stopped when I did nothing about it. Anchor wants the inn door. Eighteen. Calf: eleven paces on the flat, nine uphill, twelve down. Nobody mentions it, which I have decided to count as a kindness rather than a finding. Fifty-eight marks earned. Forty-eight in hand. No roof.*

*Hesk wrote. Three weeks old, written before the ford, into where the ford would be. Filed. I have a grandmother who crossed the Line on a trade run and said the roads were honest. I did not know that this morning.*

*Everyone I came out here with is finding out what they're worth without a number on it. Lira's fast without Wind — faster, she thinks, and nobody was counting, which is the whole of her question. Brom's a wall without Iron Skin, and he asked Pike what the board pays a man with no Path, and Pike said same as anyone, what'd he do, and Brom wrote it down. Second time in his life. Karis found a rumor in a cart-yard and underlined it, twice, and I watched her not ask the next question, which cost her more than the hands. Seln keeps waiting to be debriefed. He took the well. He'll walk it first and say nothing, and he's finding out that's what he does when nobody asks, and I think he minds less than he expected to.*

*The board prices what we did. Tonight it says the ford out loud, and moves us or it doesn't. I'd rather be priced by the man who's better than me than by anyone who isn't. That's the whole sentence. I notice I'd rather it were Teague than a panel, and I notice that's new.*

---

The board's room, with the light gone off the water.

Pike carried the book up from the landing under his arm and set it on the table by the fire and put the stone on it, and the room did what the room did, which was go on drinking with half its attention on the book. Six tables. The carters at the two by the road door. A crew of three at the middle table, new faces, new canvas. The best table by the fire empty, the four chairs pushed in, the jug on it full and untouched — the autumn road, sixty and fed, and its crew somewhere on it with a cart that was not in a river. The five of them at the table by the road door, because Brom could see both doors from it. Lira's stick against the wall. Karis's notebook open, the pen pinned. And on the long wall between the fire and the door, at head height, on four wooden pegs: the sheet.
...
He said it once. The carters by the road door had stopped talking for it and started again after. The crew of three at the middle table looked over, at the stick against the wall and the arm against the chest and the wrapped hands on the notebook, and looked at each other, and that was a verdict too, of a kind, and Cael filed it beside the others without needing to hear it.

"That's said," Pike told the book. He shut it. Then he got up, and took the pegs out of the sheet on the wall one-handed, top left, top right, and let it roll down into his hand from the bottom two, and brought it back to the table and laid it flat under the stone, and took a clean sheet from under the book's cover, and sat, and began to write.

He did not hurry it and it was not slow; it was the pace of a man copying a thing he had written before and did not need to think about, until the twelfth line, where he stopped, and looked at the old sheet, and looked at the ledger's shut cover, and wrote five names.

Cael watched the five names go in from across the room, upside down, in the same hand and the same ink and the same size as the eleven above them. Then Pike wrote the thirteenth line, which was the crew the old sheet had named by its mule, and set the pen down, and wiped it, and got up, and pinned the new sheet to the wall on four pegs in the same four holes, and came back and sat down behind the book.

The carters had looked at the wall while it was bare, and looked at it again now that it was not, and one of them said something to the other that Cael could not hear and did not need to.

He counted. Top line, one word. Ten names between. Then theirs. Then the mule.

Twelfth. One line. He had been placed by panels and by seedings, and he had never once been placed by a man who unpinned a sheet in front of the people it named and wrote the whole of it out again by hand so that one line would be in a different place, and read nothing aloud while he did it, because the reading had already been done.

Lira had her hand on the stick. Brom had not moved. Karis had written something and stopped. Seln was looking at the door.

Pike looked at the sheet a moment longer, the way he had looked at Teague's name on the slip before he drew the line through it, and then he said the rest, to the room, at the pitch of a price, asked by nobody.

"Teague's still eleven up. He'll speak to you when you've cost him something. That's not rudeness. That's the ledger."
...
# MANUSCRIPT — v3-runs/book-07/drafts/ch05.md
...
Pike entered it at the pitch of a price, with the five names under it, and said the things he said.
...
"Shale-backs," said Seln, from ahead, at the pitch of the road. "Pike's rule. He said it twice, so I'm saying it twice." He was not looking at the herd; he was looking at the bench under them and the bench above. "Never be below them. Never be *loud* below them."
...
Karis said, without heat, at the pitch of a request she had already priced: "I want a day."
...
# AUTHOR REPORT — v3-runs/book-07/reports/ch05-author-r1.json

{
  ...
  "obligations": [
    {
      "obligation": "must_include: The contract taken at the board for the three stated reasons (pay; Teague's crew on the hold contracts; Cael wanting ground, not teeth — paid to catalogue for the first time).",
      "status": "MET",
      "evidence": "The slip read at the plank on the seventieth day and the three reasons counted in order. Pay: 'It paid. Seventy marks was the ford's price and three-quarters again, for a walk.' Teague's crew: 'Teague's crew was gone on the hold contracts, a week out and a week back, and Oxhollow's slip had come in on a carter behind them and sat four days on the plank with nobody's finger on it.' Ground, not teeth: 'And the third reason, which he counted last because it was his: it was ground. Not teeth.' / 'He had never once been paid to catalogue.' The take: '\"That one,\" he said.' and Seln moving the slip a quarter-inch. No contact with Teague's crew: they are gone before the chapter opens and are mentioned only as an absence."
    },
    {
      "obligation": "must_include: The freedom movement rendered as scene and cataloguing, not summary: high country, the gorge opening below, each companion at their competence (Karis mapping; Lira running the bench; Brom and the cart; Seln and the campsites), Cael logging at every halt. Injuries carried (taped ankle, bound forearm, the calf, the scarred hands).",
      "status": "MET",
      "evidence": "The bench and gorge catalogued in scene: 'The bench, when they reached it, was a shelf.' / 'On the right the shelf stopped, and past where it stopped there was nothing for a long way down, and at the bottom of the nothing a white line that was a river.' Four companion paragraphs each opening on the competence: 'Lira went ahead.' ('Shale that held a walker held nothing, she said; shale that held a runner held a wheel.'); 'Karis mapped.' (cord, stride count, pitch, dropped stone, 'a line, kinked, with figures along it'); 'Brom kept the cart on the mountain.' ('a cart on scree did not roll; it floated.'); 'Seln was ahead of Lira.' ('\"Here,\" he said, which was the whole report.'); 'Cael wrote.' at every halt. Injuries carried on the page: the yard inventory (calf 'Uphill it still said nine'; Brom's forearm 'bound wrist to elbow still ... The hand was allowed to hold. It was not allowed to pull.'; Lira's taping described in full; Karis's palms 'two lines across each palm, pink and raised'), then on the mountain: 'the calf said nine the entire way', Lira taping at the fan's foot and at every night's fire, Brom's bound arm inside the shaft, Karis's 'scarred hand'/'scarred finger'."
    },
    {
      "obligation": "must_include: Shale-backs taught before they matter: seen at distance (thirty, armored, placid, the size of carts, grazing lichen); Pike's rule via Seln verbatim; Karis's day-long observation and derivation (unit movement; flight from declarations; 'on a slope, flight is a landslide with legs'). No stampede occurs.",
      "status": "MET",
      "evidence": "Seen at distance on the second day, two hundred meters up, counted three times and kept at thirty: 'got twenty-nine and then thirty-one and then thirty, and kept thirty.'; armored ('Plated across the back in slabs that overlapped like the stone of a roof'), cart-sized ('the size of the cart with its load and Brom in the shafts'), grazing lichen, placid ('Placid was Pike's word for them, by Seln's report, and from below it was the word'). Pike's rule verbatim through Seln: '\"Never be below them. Never be *loud* below them.\"' (and repeated without emphasis on Karis's request). Karis's day: spacing, unit drift, sound and a rock doing nothing ('That's not flight. That's a step.'), then the plate slip and the whole herd moving uphill one length at once ('They moved as a unit. Away.'); the derivation against the ford page ('The herd's answer is the ford's answer with the sign changed: a hunter comes to it; a grazer goes from it. Flight, not hunt.'), the direction ('If the loud thing is below them—' / 'They go up' / 'And if it's *above* them.' / 'Then they come down.'), and the line: '\"On a slope, flight is a landslide with legs.\"' Entered as derived, not tested. No stampede: the herd's only movement is one body's length uphill, then grazing; it is above and behind the party at the close."
    },
    {
      "obligation": "must_include: The fourth-night log entry (content as in scene_shape) mid-chapter.",
      "status": "MET",
      "evidence": "Fourth camp entry, seventy-sixth day: '*The traverse holds. So far. The map's good — Karis's, not mine; mine's the check. The herd's above the eighth narrowing tonight, thirty, grazing along. Karis says they go off declarations, as a unit, away, and on a slope away is down; which means the loudest thing on this mountain is us, and we've been quiet four days. Not one of us has had to try.*' and 'First honest job I've ever had that didn't have a fight at the end of it. I'm writing that before it's finished, which I don't do. Note that I did.*' The sentence is written on the fourth night and written again on the fifth, which is the chapter's rendering of 'choosing to believe the job has no teeth'."
    },
    {
      "obligation": "must_include: The chapter ENDS on the fifth-night image-then-log exactly as in closing_state — Lira taping the ankle and announcing the ledge; the final words are Cael's entry ending 'Sleep.'",
      "status": "MET",
      "evidence": "Image: Lira at the fire taping the ankle ('It was the ankle that had never been seen by anyone who could do more for it than boil the cloth.'), then '\"I'll run it at first light,\" she said. \"See if it holds a cart.\"' Then 'He took the log out.' and the final lines of the file: '*The traverse holds. The map's good. Karis says the herd moves off declarations, which means the loudest thing on this mountain is us, and we've been quiet for five days. One more day. First honest job I've ever had that didn't have a fight at the end of it. Sleep.*' — verbatim to closing_state, the last line of prose, no metadata after it."
    },
    {
      "obligation": "must_include: Cael's cataloguing at scale (a map, a bench, a herd) outside the log at least once; the three boxes in the cart glimpsed once (load-bearing in Chapter 6).",
      "status": "MET",
      "evidence": "Outside the log: the fan catalogued from the bottom; the bench catalogued ('He wrote that down first, at the first halt, because it was the fact everything else stood on.'); the herd counted as a crowd is counted; the narrowings numbered one through nine with widths; the two-thirds count on the tail-board on the fifth night. The three boxes: roped on at Lowmarch ('the front box over the axle and the other two behind it'), re-roped by Brom at every halt, and glimpsed in scene on Karis's day: 'The three boxes rode roped at its front, the foremost over the axle where Brom kept it, the middle one with a corner worn white where the rope ran'."
    },
    {
      "obligation": "must_include: Manuscript format: H1 '# Chapter 5 — Route', prose only, '---' breaks, ends on the last line of prose.",
      "status": "MET",
      "evidence": "First line is '# Chapter 5 — Route'; eleven '---' breaks; no headings, notes, or counts; the file ends on the log entry's 'Sleep.'"
    },
    {
      "obligation": "plant: Shale-backs flee declarations as a unit; below them is the wrong place to be loud (Chapter 6's engine).",
      "status": "MET",
      "evidence": "Karis's derivation in scene ('They moved as a unit. Away.' / 'Away from the declaration.' / 'Then they come down.' / 'On a slope, flight is a landslide with legs.'), plus Cael's arithmetic on the rule: 'The first half was a carter's wish. The second half was the job.' and the second-camp log: 'We are below them. Every cart Oxhollow ever sends will be below them. So the rule out here is the second half'."
    },
    {
      "obligation": "plant: The ledge over the gorge that Lira will run at first light (Chapter 6 opens there).",
      "status": "MET",
      "evidence": "'The fifth day showed them the ledge.' — the bench 'pinching down to a lip that was, at that distance, a line. A ledge.', the herd 'above them and ... behind them now', Karis unable to measure it from the camp, and Lira's announcement at the fire, restated in the final log's dateline: 'The ledge is in sight; Lira runs it at first light.'"
    },
    {
      "obligation": "plant: The three boxes riding in the cart (Chapter 6 costs the cart).",
      "status": "MET",
      "evidence": "Boxes roped on at Lowmarch because there is nowhere to leave them, Brom re-roping them at every halt to keep the weight over the axle, and the middle box opened for the ford page on Karis's day."
    },
    {
      "obligation": "plant: Lira's ankle, never seen by a healer (Chapter 6).",
      "status": "MET",
      "evidence": "Taping described in the yard inventory, at the fan, at the fourth camp, and at the fifth-night fire: 'It was the ankle that had never been seen by anyone who could do more for it than boil the cloth.' / 'She had not stopped taping it.'"
    },
    {
      "obligation": "plant: Oxhollow as a ford settlement on the route (Oryn's route, Chapter 7).",
      "status": "MET",
      "evidence": "Named on the slip ('Oxhollow ford') and held to the packet's boundary: 'Oxhollow was a ford, north, a week by the void road; that was the whole of what the plank knew about it.' Payment is at Oxhollow; the bench 'went on toward Oxhollow'. Nobody from Oxhollow appears; no other fact about it is asserted."
    },
    {
      "obligation": "payoff: Chapter 4's want-lines lived: Lira running, Brom holding, Karis mapping, Seln scouting — each priced by what they do.",
      "status": "MET",
      "evidence": "Lira: runs the bench without Wind ('not a burst; a burst was a shout') and prices herself at the fire: '\"That's what I'm for up here. That's the job.' Brom: holds the cart with his body and the strap, the bound arm inside the shaft ('a lock somebody else had built, being held shut by hand'). Karis: the map is hers ('The map's good — Karis's, not mine; mine's the check') and the herd is her first primary source ('First primary source I've had on this side of the Line. It's got a hundred and twenty legs and it doesn't know I'm here.'). Seln: asks Pike about the shale-backs unasked, finds every camp before anyone knows they need one, and reports in one word."
    },
    {
      "obligation": "payoff: Chapter 3's stillhound sense rhymed and inverted by the shale-backs (Karis names the rhyme).",
      "status": "MET",
      "evidence": "Karis has the ford page read aloud and names it: 'Those turn as one to the loudest thing and then follow the first to go. These go as one and there's no first. Same shape, upside down.' and 'The herd senses discharge — the ford's sense.' — the same sense, the opposite response, in her method-register, entered as derived."
    },
    {
      "obligation": "prohibited_outcomes (all): no collapse/stampede/fight/new injury; no fragment use or declaration by anyone; no Oryn/healer/Tide/quiet ground beyond one passing thought; no Teague contact, letters, Vastin, watchers; no new named people or places; ends on the log, not dialogue or image; no modern idiom, no feeling/growth declarations, tic caps, no metadata.",
      "status": "MET",
      "evidence": "No ledge collapse (the ledge is only seen), no stampede (the herd moves one body's length), no fight, no new injury. Nobody declares; Cael's log records 'Nothing drifting' and 'Nothing's drifted in four days'; Lira runs without a burst; Karis refuses any trial. No healer, Tide, or Oryn; quiet ground appears as one passing thought only: 'There was a rumor with two lines under it in that box too, near the bottom, and she did not take it out.' Teague's crew is absent for the whole chapter; no letters, Vastin, or watchers. New proper nouns: none (Oxhollow was pre-authorized; the bench, gorge, fan, ledge, and traverse are descriptive). Ends on the log entry. Tic greps all zero; no modern registers; no feeling or growth declarations."
    }
  ],
  "inventions": [
    "The Oxhollow slip's wording and price: seventy marks on the map, paid at Oxhollow; the traverse reckoned by Pike at seven or eight days for a cart; the slide dated 'three seasons' ago and placed on the Thornwater end, a mile short of the steading, with a knocked-over cairn where the traverse leaves the road. Oxhollow itself held to 'a ford, north, a week by the void road' and nothing more.",
    "Board state on the seventieth day: thirteen slips, two of them HOLD/Teague hold contracts; Teague's crew came in off the autumn road and went out again with the hold slips while the five were at the well on the south road (Seln's Chapter 4 slip), so there is no contact and no look exchanged. Pike's pricing of why nobody had taken the slip ('Pays on the map, at Oxhollow ... the crews that could take it are the crews with the pick').",
    "The cart: a smith's second-best two-wheeled hand-cart with shafts and a chest-strap, hired for six marks against its return on Pike's instruction ('You want to tell a ford it holds a cart, you'd better have had one on it'); Brom in the shafts with the bound arm inside the right shaft. The boxes go because Lowmarch has no wall and no warehouse and nothing left in a meadow stays.",
    "Pike telling Seln, privately, to ask him about the shale-backs; Seln asking with his back to the room; Cael deliberately not going to hear it — so that Pike's rule arrives on the mountain in Seln's mouth, verbatim, twice.",
    "Injury texture at three weeks: Cael's flat-ground count abandoned past twenty ('a number that large was not a limp, it was a leg'), uphill still nine; Brom's wrist closed on the sixty-sixth day and re-wrapped anyway, the hand allowed to hold but not pull; Lira's stick abandoned on the sixty-fourth day and Pike standing it behind the plank; Lira's taping method in full (boiled-linen strips from the arch over the joint to the shin, morning and, on the mountain, night); Karis's palms as two raised pink lines she flexes against the pen.",
    "Mountain detail: the fan as a field-wide spill of loose plates hauled up on a rope in a morning; the bench as a roof-pitched shelf a cart and a half wide with an upper bench two hundred meters above; the gorge that gives every sound back late from the far wall ('It was the loudest thing about the place, that it repeated you'); the shale-backs' grinding heard before they are seen; overhang camps; nine numbered narrowings with widths (a cart and a hand at the fourth, a clean break at the eighth); the ledge sighted from the ninth.",
    "Karis's mapping method (stride paced against the folding rule, cord widths, pitch by cord and stone, gorge depth by dropped-stone count, 'a line, kinked, with figures along it'); Brom's scree mechanics ('a cart on scree did not roll; it floated', weight over the axle and up-slope, himself on the down-slope shaft as counter); Lira's rule ('shale that held a walker held nothing; shale that held a runner held a wheel') and her hundreds.",
    "Karis's day of observation as a sequence of trials with results: spacing (never closer than a body, never further than three), the line moving without any animal seen to move, a tail-board bang and a falling rock producing only a step, and one plate tilting under an edge animal — the herd taking one body's length uphill at the same instant with no leader. The derivation is built only from that, the ford page (read aloud by Cael from the page in his hand), and the carters' word 'loud'; she enters it as derived and refuses any test.",
    "Marks arithmetic in the first log: sixty-two earned (Chapter 4's fifty-eight plus the four-mark well), forty-six in hand after the cart's six.",
    "Cael's log lines on idle drift stopping on the mountain ('Anchor wanted the inn door; there is no door up here' / 'Nothing's drifted in four days. I'm writing that as a fact and not as a meaning') and on being 'paid by the line' — both kept as observations, not meanings.",
    "Karis's dry line for her want: 'First primary source I've had on this side of the Line. It's got a hundred and twenty legs and it doesn't know I'm here.'"
  ],
  ...
  "deviations": [
    "Word count 5,235 against a 4,600 target — inside the 15% tolerance (ceiling 5,290) but above target, in line with Chapters 1–4 (5,269 / 5,169 / 5,150 / 5,273). The first pass ran to ~6,400 and was cut by density in three passes; every mandated beat, both log entries, the verbatim rule, the derivation line, and the exact ending are intact. Further compression toward 4,600 is available in the board section, the yard inventory, and the companion-competence paragraphs without touching obligations.",
    "The 'First honest job I've ever had that didn't have a fight at the end of it' sentence appears twice by design: the scene_shape assigns it to the fourth-night entry and the closing_state to the fifth. The fourth-night entry adds 'I'm writing that before it's finished, which I don't do. Note that I did.' so the repetition reads as Cael choosing to believe the job has no teeth; the fifth-night entry is verbatim to closing_state.",
    "The scouting party walks the traverse from the Thornwater end toward Oxhollow (the fan is on the Thornwater end where the slide came down; payment is at Oxhollow). This is a choice the card leaves open; it was made so that Chapter 6's 'overdue on the traverse' and Chapter 7's four-day walk down to Oxhollow are geographically coherent. The editor may prefer the opposite direction; only the fan's placement and 'toward Oxhollow' would need changing.",
    "A hired hand-cart (no mule) is used so that Chapter 6 can lose the cart into the gorge without an unaccounted animal. The cart's origin (Lowmarch's smith, six marks against return) is invented within the 'cart's mechanics' latitude and is reported here for the ledger.",
    "The interval between Chapter 4 (day 60) and the board (day 70) is compressed into two clauses (the well on the south road; Teague's crew in and out). Seln's four-mark well is assumed done in that gap and appears only in the marks arithmetic; if the editor prefers the well left open, the log's 'Sixty-two earned. Forty-six in hand' becomes fifty-eight / forty-two.",
    "Pike's word 'placid' is attributed to him through Seln's report ('Placid was Pike's word for them, by Seln's report') — a small extension of the off-page conversation the card licenses ('Ask me about the shale-backs before you go').",
    "'Karis, who has never seen a large animal she did not want to document' is rendered by behavior (the day requested and spent; 'First primary source ... a hundred and twenty legs') rather than stated by narration."
  ],
  "blockers": []
}
