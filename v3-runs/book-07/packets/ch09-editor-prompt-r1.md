...

{
  ...
  "revisions": {
    ...
    "arc": "arc-b7-v2 (books/book-07-void-roads/CHAPTER_ARCHITECTURE.md, editor PASS r4, Chapter 9 card)",
    "state": "state-b7-post-ch08 (v3-runs/book-07/STATE_RUNNING.md + base snapshot)",
  ...
  "pov": {
    ...
    "knowledge_boundary": [
      "Cael is eighteen; nine + anomaly. Party FIVE leaving Lowmarch; SIX from Thornwater when Oryn joins the walk east (she is adding the crew to her route as a stop; she is not 'joining the crew'). Cael's ribs and calf knitted enough to walk two days.",
      "Known: Pike's folklore of quiet ground (the sigil sleeps; carters walk around; stillhounds live in it; nobody goes in twice; 'your Arbiter tells you — it stops'). NOT known: the perimeter's size or shape, the fused stone, the survey stakes, any theory. The word 'Quieting' does not exist yet (Karis coins it in Chapter 15).",
      "Two letters arrive on the last ferry and are carried on the walk; their texts are fixed (must_include): Ephram's from Halcenvane and Vell's from Ardenmere. NOTE: the name registry's dispositions slate 'Halcenvane' and 'Bracken' for rename before Book 2's audio; use them as they stand in Books 4–6 (no rename has executed) — 'Halcenvane', 'Bracken', 'Withrow', 'Rooke' as in the letter text.",
      "Oryn's two reasons for coming (in her words): a patient she wants to read whole and still, which needs a day of him not fighting anything; and the carters' claim that a healer's hands stop working on quiet ground, which she has never been able to check — 'I'd like to know if that's true before somebody bleeds on the wrong side of it.' She has walked past the Fallow Ring's line on the void road eleven times in two years and never stepped off the road.",
      "At the line: every Arbiter in the party goes silent at the same stride except Cael's, which has been dark since his Kindling and does not change. Cael feels NOTHING change either direction and SAYS NOTHING (the bible's 'he doesn't mention this immediately' begins here). Lira: 'It's like the air got thick.' Brom: 'Like a door closing behind me.' Karis: 'My Arbiter's gone.' Seln: 'Back up. Ten paces. Tell me when it comes back.' Oryn stops with her hands half-raised and says nothing. Karis marks the line with a stone. Nobody crosses it in this chapter; nobody measures it (Chapter 10)."
    ]
  },
  "purpose": "The approach: two days east on a road the Compact draws as a dashed line ending in nothing — the title's first meaning on the page (Cael's void-style map against a carter's hand-copied map with three circles) — Oryn joining the walk at Thornwater as a stop on her route, two letters from inside carried east, and the road's last mile turning in the body before the mind: every Arbiter in the party stopping at a line Karis can mark with a rock, and Cael's not, and Cael saying nothing.",
  "scene_shape": {
    "opening_state": "Leaving Lowmarch on the Fallow road with the recovery contract; Cael walking with the Compact-style map open, cataloguing the difference between the ink (dashes ending in nothing) and the ground (a road, real, rutted, used); Karis with the carter's copy on which the same road runs solid and bends three times around blanks drawn as circles. 'Their map has no roads. His has no quiet ground. Between them you get the country.'",
    "pov_goal": "Reach the Fallow Ring; read Oryn's reasons; find the line Pike said his Arbiter would tell him about — and learn what his Arbiter, dark for four years, will tell him.",
    "opposition": "The letters' weight (the inside still writing); Oryn's route-arithmetic (she is spending days she owes elsewhere); and the line itself.",
    "turn": "Thornwater on the ninth day: Oryn at the gate with her mule, as promised; her two reasons; six on the road, the sixth chair walking with the five for the first time and the book not underlining it. Ephram's letter and Vell's letter read on the walk (texts fixed). The last mile: the carter's-map bend, the ground rising to a low ridge, scrub thinning — and the sensations, each described differently: Lira, Brom, Oryn (hands half-raised, silent), Karis ('My Arbiter's gone'). Seln's procedure: back up ten paces, tell me when it comes back. It comes back at a line Karis marks with a stone.",
    "choice": "Cael, who backed up with them and felt nothing change either direction, says nothing — and writes the reason he says nothing in the log: he does not know what it means and nobody asked.",
    "outcome": "The stone at the line; past it, in the failing light, a ring of broken uprights on a floor that catches the last sun like water. The log, written at the stone, mid-chapter: 'Quiet ground. Karis's Arbiter stopped at a line she can mark with a rock. So did Lira's, Brom's, Seln's, Oryn's — same line, same step. Mine didn't. Mine's been stopped since I was fourteen. I don't know what that means. Nobody asked. Tomorrow we go in.'",
    "closing_state": "The chapter ENDS ON AN IMAGE: the stone at the line, the ridge, the ring of broken uprights on a floor catching the last sun like water — and Oryn, at the line, lowering her hands."
  },
  "obligations": {
    "must_include": [
      "The two maps as objects and the void-roads convention shown through Cael's cataloguing (dashes ending in nothing versus ruts; the carter's three circles); Karis's line about the two maps verbatim.",
      "Oryn at Thornwater's gate on the ninth day; her two reasons in her register (the still-and-whole patient; the carters' claim about a healer's hands, 'before somebody bleeds on the wrong side of it'); her eleven times past the line; six on the road; the crew added to her route, not the reverse.",
      "Ephram's letter, in full: the Crown yard's new cohort captain; Withrow's tenure holding; a registry query about 'former enrollees' last known direction of travel' answered by Bracken with a map reference to the Line and nothing past it — 'which is true, and which Bracken enjoyed being true'; and the line Cael reads three times: 'Rooke says the yard's quieter. He didn't say it was worse. He also didn't say it wasn't.' (Compose the letter in Ephram's own register around these fixed facts and the fixed final line.)",
      "Vell's letter, verbatim: 'Filed with your record. It reads: left in good standing, undefeated on paper. I've kept this ledger forty years and never had a line like it. The session still stands. The road still runs through Ardenmere. — V.'",
      "The last mile staged in the body before the mind: the four spoken reactions verbatim (Lira, Brom, Karis; Seln's procedure), Oryn's silent half-raised hands, the ten paces back, the stone.",
      "Cael feels nothing change and says nothing; the mid-chapter log entry verbatim.",
      "The chapter ENDS on the image (the ring in the last light; Oryn lowering her hands) — not on the log (the previous chapter ended on the log).",
      "Manuscript format: H1 '# Chapter 9 — The Void Road', prose only, '---' breaks, ends on the last line of prose."
    ],
    "plants": [
      "Every Arbiter fails at the same stride the same way (Book 9 plant, observed, not interpreted).",
      "Cael's Arbiter unchanged because it was already dark (Book 9 plant; his silence begins).",
      "Oryn's hands — the healer's claim to be checked (Chapter 10 trial, Chapter 11 crisis).",
      "'Tomorrow we go in.'"
    ],
    "payoffs": [
      "Pike's 'Your Arbiter tells you. It stops.' paid at the stride.",
      "Chapter 7's 'Thornwater in nine days' paid at the gate."
    ],
    "prohibited_outcomes": [
      "Nobody crosses the line; nobody measures it; no fused stone described beyond 'a floor that catches the last sun like water'; no stakes; no 'Quieting'; no theory from anyone.",
      "Cael does not tell anyone his Arbiter did not change; nobody asks.",
      "No fight; no fragment use; no stillhounds seen (the den is Chapter 10).",
      "No Teague; no Vastin.",
      "No new named people or places; Ephram's letter may reference Halcenvane, Withrow, Bracken, Rooke only.",
      "The chapter does not end on a log entry or dialogue.",
  ...
  "invention_budget": {
    "allowed": [
      "The road east in sensory detail (ruts, scrub, the ridge, failing light); Thornwater's gate; the ferry's mail; Oryn's manner walking (economical, sure-footed, never fast); the letters' paper and hands.",
      "Ephram's letter composed in his register around the fixed facts; Cael's reactions.",
      "Dialogue in established voices; Cael's interior cataloguing; the log entry at the stone."
    ],
    "approval_required": [
      "Any new named entity; any fact about the site beyond what is visible from the line at dusk; any Arbiter behavior beyond 'gone at the stride, back at the stride'."
    ],
    "forbidden": [
      "Crossing the line; measuring; theory; disclosure by Cael; fights; fragment use; a log or dialogue ending; metadata."
    ]
  },
  "context_files": [
    {
    ...
    {
      "kind": "previous_scene",
      "label": "Chapter 8 as drafted — the immediate seam (the contract, Pike's folklore, the council)",
      "path": "v3-runs/book-07/drafts/ch08.md",
      "required": true
    },
    {
      "kind": "reference",
  ...
  "exceptions": [],
  "output": {
    "draft_path": "v3-runs/book-07/drafts/ch09.md",
    "report_path": "v3-runs/book-07/reports/ch09-author-r1.json",
    "editor_report_path": "v3-runs/book-07/reports/ch09-editor-r1.json",
    "verifier_report_path": "v3-runs/book-07/reports/ch09-verifier-r1.json",
    "target_words": 4600,
...
# CONTEXT — Chapter 8 as drafted — the immediate seam (the contract, Pike's folklore, the council) (v3-runs/book-07/drafts/ch08.md)
...
# MANUSCRIPT — v3-runs/book-07/drafts/ch09.md
...
# AUTHOR REPORT — v3-runs/book-07/reports/ch09-author-r1.json

{
  ...
  "obligations": [
    {
      "obligation": "must_include: The two maps as objects and the void-roads convention shown through Cael's cataloguing (dashes ending in nothing versus ruts; the carter's three circles); Karis's line about the two maps verbatim.",
      "status": "MET",
      "evidence": "The registry sheet as object and convention: 'A road east of the Line on a registry sheet was a row of dashes that thinned as if the pen had been lifting, and stopped in white paper, and the white went to the edge of the sheet. Seven roads left the Line going east on the printed sheet, and every one of them ended in nothing. / That was the void style. ... a road drawn in the void style was a road the registry would not vouch for.' The catalogue: 'Ink: a dash the width of a pen, a gap, a dash. Ground: a road two carts wide at the wash and one on the rises, rutted to the depth of his hand ... Ink: nothing at the end. Ground: Lowmarch behind him with a ferry and a board and thirteen crews on a wall ... The dashes were not a lie. They were where the registry had stopped being willing to say so.' The carter's map: 'A carter's map. No seal, no brand, no waystation at either end of anything ... And three times he had counted a road on Pike's map go out of true. Bent, as a road bends round a bog, and came back to its line a finger's width on. Inside each bend the carter's hand had drawn a circle with nothing in it.' Karis verbatim: 'Karis had watched him look from one sheet to the other four times, and had waited for the fifth, and said: \"Their map has no roads. His has no quiet ground. Between them you get the country.\"'"
    },
    {
      "obligation": "must_include: Oryn at Thornwater's gate on the ninth day; her two reasons in her register (the still-and-whole patient; the carters' claim about a healer's hands, 'before somebody bleeds on the wrong side of it'); her eleven times past the line; six on the road; the crew added to her route, not the reverse.",
      "status": "MET",
      "evidence": "At the gate: 'And at the gate itself, tied to the post, a second mule, with panniers, and a bench pulled into the wall's shade, and a woman on the bench with a carter's hand in both of hers.' Ninth day: '\"Ninth day. I said nine. You've counted.\" / \"Ninety-third.\" / \"Then that's both of us.\"' Reason one: '\"Two reasons. I'll give you both, because you'll count them anyway. The first is a patient I want to read whole and still. The long one. That wants a day of him not fighting anything, and I've not had one of those with him yet, and I'll not get one on my route, because my route's a table and a road and a table. So I'm putting one on it. A day.\"' Reason two: '\"Every carter on this road will tell you a healer's hands stop working on quiet ground. Every one. Not the sigil. The hands. ... I've walked past that line on the Fallow road eleven times in two years. I've never once had a reason to put my hands on anybody at it, and nobody's ever bled at it in front of me, so I've never been able to check. I'd like to know if that's true before somebody bleeds on the wrong side of it.\"' Never off the road: '\"I've never stepped off the road there. Never wanted to.\"' Crew added to her route: '\"You're a stop. I've added you. Two days east is on my route as far as the bend. Past the bend it isn't, and a day standing at it isn't, and that's a day I'll owe at the next hold, and I've been late there before. Don't make it a long stop.\"' Six on the road, stated once and not underlined: 'Six on the Fallow road out of Thornwater's east gate on the morning of the ninety-fourth, in the order the road set: ...'"
    },
    {
      "obligation": "must_include: Ephram's letter, in full: the Crown yard's new cohort captain; Withrow's tenure holding; the registry query about 'former enrollees' last known direction of travel' answered by Bracken with a map reference to the Line and nothing past it — 'which is true, and which Bracken enjoyed being true'; and the line Cael reads three times.",
      "status": "MET",
      "evidence": "Letter composed in Ephram's register around the fixed facts, italicized as in-world writing: '*The Crown yard has a new cohort captain. The intake came up the bluff a fortnight ago, forty-one of them, and they've put a third-year over them who was a second-year when you left and whose name you would not know, so I'll not spend the ink.*' '*Withrow's tenure holds. That is the whole of the sentence.*' '*A query came down to the registry from somewhere above it. Bracken would not say where and I did not ask twice. It wanted former enrollees' last known direction of travel. Bracken answered it. He gave them a map reference to the Line and nothing past it — which is true, and which Bracken enjoyed being true.*' Fixed final line: '*Rooke says the yard's quieter. He didn't say it was worse. He also didn't say it wasn't.*' Read three times: 'He read the last line three times. / Once for what it said, which was a sentence about a yard. Once for what it did not say, which was more, and left out on purpose. The third time because it was last.' Only Halcenvane, Withrow, Bracken, Rooke are named in connection with the letter; the new captain is deliberately unnamed in Ephram's own words."
    },
    {
      "obligation": "must_include: Vell's letter, verbatim.",
      "status": "MET",
      "evidence": "'*Filed with your record. It reads: left in good standing, undefeated on paper. I've kept this ledger forty years and never had a line like it. The session still stands. The road still runs through Ardenmere. — V.*' Carried as an object: 'A strip of ledger paper, cut straight along the rule with a knife, folded once.' Read aloud to Lira on the Fallow road; 'the session still stands' filed as unexplained: 'He did not know what *the session still stands* meant. He knew it was not nothing, because she had spent a line of ledger paper on it, and he put it on the shelf as it was, unexplained.'"
    },
    {
      "obligation": "must_include: The last mile staged in the body before the mind: the four spoken reactions verbatim (Lira, Brom, Karis; Seln's procedure), Oryn's silent half-raised hands, the ten paces back, the stone.",
      "status": "MET",
      "evidence": "Body first: 'Lira stopped. / Her hand came up as it had come up on the first walk out of Thornwater ... and stayed up.' Then: '\"It's like the air got thick,\" she said.' Brom: 'the shoulders, which did not move for anything, moved, once ... \"Like a door closing behind me,\" Brom said.' Oryn: 'her hands came up. Half up. Not to her face and not to anything; to the height she raised them over a hurt before they went down on it, and she held them there, open, over nothing, and did not say anything at all.' Karis: '\"My Arbiter's gone,\" Karis said. / Precise. Four words, said over an instrument.' 'Everyone stopped.' Seln: '\"Back up. Ten paces. Tell me when it comes back.\"' The ten paces and the line: 'On the third stride back Brom said, \"Back,\" ... and Karis, on her third, at the same place on the road, said, \"Back\"; and Seln ... said it on his fourth, which was the same place; and Lira ... said it when she came level with the others, on the same ground, to the stride.' '\"Ten,\" Seln said, and they went to ten, because the procedure was ten, and stood.' The stone: 'Then she walked forward, to the place, and not one step past it, and bent, and took up a stone from the road's edge the size of two fists, and set it in the rut at her heel, on the near side.'"
    },
    {
      "obligation": "must_include: Cael feels nothing change and says nothing; the mid-chapter log entry verbatim.",
      "status": "MET",
      "evidence": "At the stride: 'He looked at the place. Dark. The same dark, exactly, unchanged in any way he had a word for. Nothing had gone from it, because nothing had been in it. Nine fragments, held to nothing: nothing drifting, nothing different. The air was not thick. No door had closed. He stood on the road beside Karis, at the stride where four people had felt a thing, and he felt nothing change, and he did not say so.' On the way out: 'He had backed up ten paces on a road with five people who had felt a thing stop and start, and he had felt nothing stop and nothing start, in either direction, and nobody had asked him. ... he looked for the reason and found two: he did not know what it meant, and nobody had asked.' The log, mid-chapter (a full section of prose follows it), with a dateline line in the established convention: '*Ninety-fifth day. The Fallow road, second day east of Thornwater; the rise, the bend, the shoulder. A hundred and eight in hand; nothing owed. A stone in a rut.* / *Quiet ground. Karis's Arbiter stopped at a line she can mark with a rock. So did Lira's, Brom's, Seln's, Oryn's — same line, same step. Mine didn't. Mine's been stopped since I was fourteen. I don't know what that means. Nobody asked. Tomorrow we go in.*'"
    },
    {
      "obligation": "must_include: The chapter ENDS on the image (the ring in the last light; Oryn lowering her hands) — not on the log.",
      "status": "MET",
      "evidence": "Final paragraphs: 'Past the ridge the ground fell away and opened, a shallow bowl of short grey grass, and in the bowl, off the road, a long stone's throw and more, there were the stones Pike had said. Some standing. Uprights, broken, most of them, at different heights, as teeth are broken, in a ring ... And under them, a floor. ... the floor took the light as water takes it, all of it at once, bright along its whole width, so that the ring of broken uprights stood on a pool of light with the dusk already in the grass around it.' Last line of the file: 'She held her hands out over the line for as long as the floor held the sun, and when it had gone off the floor and there was only the ridge lit, and then not even that, she lowered them.' Scene-closer: IMAGE (Chapter 8 closed on a log entry; no repeat)."
    },
    {
      "obligation": "must_include: Manuscript format: H1 '# Chapter 9 — The Void Road', prose only, '---' breaks, ends on the last line of prose.",
      "status": "MET",
      "evidence": "First line: '# Chapter 9 — The Void Road'. Five '---' section breaks. No metadata, headings, or notes after the final prose line; grep for 'End of Chapter', 'approximately', 'word count' returns zero."
    },
    {
      "obligation": "plant: Every Arbiter fails at the same stride the same way (Book 9 plant, observed, not interpreted).",
      "status": "MET",
      "evidence": "Observed in the body and in Cael's count, never interpreted: 'Brom came level with her and stopped where she had stopped, at the same place on the road'; 'She was a stride behind Brom and she stopped at the same place'; 'She stood at the same place on the road as the other three'; on the way out, each voice at 'the same place'; 'Pike had said they would know. Five of them had known, at a stride, and had known again, at the same stride, going the other way.' 'Same line. Same step. ... \"Same stride. All of us.\"' Karis's notebook entry is described as a stride, not a hypothesis: 'it was not a hypothesis, because he knew the shape of her hand when it was writing one, and this was the shape it had when it was writing down a stride.' No character offers a theory."
    },
    {
      "obligation": "plant: Cael's Arbiter unchanged because it was already dark (Book 9 plant; his silence begins).",
      "status": "MET",
      "evidence": "The dark sigil set up before the line: 'He had a place he could look. He had had it since he was fourteen, since eleven seconds in a registry room with a sigil in front of him that had come, and had looked at him, and had gone dark and stayed dark, and in four years it had never once had anything in it.' At the line: 'Dark. The same dark, exactly, unchanged in any way he had a word for. Nothing had gone from it, because nothing had been in it.' The silence begins and is given its reason: 'he had a sentence, and that it was true, and short, and that he was not going to say it, and he looked for the reason and found two: he did not know what it meant, and nobody had asked.' Log: 'Mine didn't. Mine's been stopped since I was fourteen.'"
    },
    {
      "obligation": "plant: Oryn's hands — the healer's claim to be checked (Chapter 10 trial, Chapter 11 crisis).",
      "status": "MET",
      "evidence": "The claim stated as hers to check: '\"Every carter on this road will tell you a healer's hands stop working on quiet ground. ... I'd like to know if that's true before somebody bleeds on the wrong side of it.\"' The hands at the line, unchecked: 'her hands came up. Half up. ... she held them there, open, over nothing, and did not say anything at all.' At the stone at dusk: 'her hands half up again, open, held out over the rut and the road beyond it ... She held her hands out over the line for as long as the floor held the sun ... she lowered them.' No trial is run in this chapter; nobody's hands touch anyone at the line."
    },
    {
      "obligation": "plant: 'Tomorrow we go in.'",
      "status": "MET",
      "evidence": "Final sentence of the mandated log entry: '*... Nobody asked. Tomorrow we go in.*' Reinforced by the camp: 'He did not go past the stone. Nobody went past the stone.'"
    },
    {
      "obligation": "payoff: Pike's 'Your Arbiter tells you. It stops.' paid at the stride.",
      "status": "MET",
      "evidence": "Set up on the rise: 'because a man who had kept a ledger for thirty years had said *your Arbiter tells you*, and he wanted to know what a dark thing would say.' Paid: '\"My Arbiter's gone,\" Karis said.' and 'Pike had said they would know. Five of them had known, at a stride, and had known again, at the same stride, going the other way.' The payoff is inverted for Cael in the same beat: his Arbiter tells him nothing, because it has nothing to stop."
    },
    {
      "obligation": "payoff: Chapter 7's 'Thornwater in nine days' paid at the gate.",
      "status": "MET",
      "evidence": "'\"Ninth day. I said nine. You've counted.\" / \"Ninety-third.\" / \"Then that's both of us.\"' Oryn is at Thornwater's gate with her mule on the afternoon of the ninety-third day, the ninth day from the eighty-fourth."
    }
  ],
  "inventions": [
    "Timeline: the slip marked at the plank on the morning of the NINETY-FIRST day and the five leave Lowmarch the same morning; a noon halt at the wash on the ninety-second (Ephram's letter read); Thornwater reached on the afternoon of the NINETY-THIRD (Oryn at the gate; her table till dark; the crew in the grain loft); six leave by Thornwater's east gate on the morning of the NINETY-FOURTH (Vell's letter read at the noon halt); the rise, the bend, and the line reached in the hour before dusk on the NINETY-FIFTH; camp on the road on the near side of the stone, no fire. Cael is eighteen (not restated on the page this chapter; no age reference given).",
    "The monthly mail sack arrives on the ferry on the morning of the ninety-first (a month after Chapter 4's sack on the sixtieth) and is sorted aloud at the plank: twenty-two pieces, the last two for Cael. Both letters are carried unopened off the landing and read on the walk.",
    "The registry's printed continental sheet (the wall map of every registry office, the Weaver's Row schoolroom, and Ilsev's desk) is in Karis's middle box among her copies of registry print; Cael walks with it open from Lowmarch to Thornwater and returns it to the box at Thornwater's east gate because the Fallow road is not on it at all — the surveyors' dashes stop at Thornwater's fork and the sheet is white east of it. Seven dashed roads leave the Line going east on the sheet; the Lowmarch–Thornwater road is the third from the Line. The void style's rule as Cael learned it at Ilsev's desk: a road drawn in the void style is a road the registry will not vouch for.",
    "Karis finished copying Pike's plank map whole on the morning of the ninety-first while the slip was marked (she had copied the Fallow road's bend on the ninetieth). The copy is a carter's map: no seal, no brand, roads solid and not straight; three roads go out of true round three circles drawn blank; one of the three is the Fallow road's second-day bend.",
    "Ephram's letter: composed in his register (plain, in order, the deciding line last). Invented details around the fixed facts: the intake of forty-one came up the bluff a fortnight before; the new cohort captain is a third-year who was a second-year when Cael left, deliberately unnamed by Ephram ('I'll not spend the ink'); Withrow's tenure held after a week in which 'there had been' a longer sentence; Bracken told Ephram about the query at the plaque wall with his hands behind his back and then told him he had not told him; Ephram still loses their bout to Cael 'every time I run it' and has stopped running it in the yard. Signed '— E.' No date. Ephram knows nothing of the mechanism and says nothing of it.",
    "Vell's letter is written on a strip of her own ledger paper cut along the rule, folded once — the first piece of that paper Cael has ever held that was his. He reads it aloud to Lira at the noon halt on the Fallow road; Lira's reading of it: '\"On paper,\"' / '\"The road still runs through Ardenmere. She put that last.\"' / Cael: '\"She puts the thing that decides it last.\"' / Lira: '\"So does Ephram.\"'",
    "Thornwater's gate on the ninety-third: the same bowman on the gate-walk (Chapter 3's), who calls nothing down; a bench in the wall's shade where Oryn runs a surface reading on a carter's hand (a count of ten; 'keep it dry and you'll not lift with it for six days'); her mule tied to the gate-post. She looks the five over as patients (Lira's leg — a nod; Brom's forearm — nothing; Karis's hands — a count of one; Seln — nothing; Cael's tape through the shirt — 'Seventeen days.' / 'Breath stops at it.' / 'It'll do that till it's off.'). She does NOT read Cael (no fourth surface reading; count unchanged at three). She knows where the crew is going because a carter who was at the plank when the slip was marked came into Thornwater the day before.",
    "Oryn's table at Thornwater that evening, watched by Cael from the loft door: nine on the bench in the order she set (a child with a wrist first; then the three that mattered; then the rest); one sit-down between the fourth and fifth; nobody asks her for paper or tier. Her route arithmetic in her words: the Fallow road east of Thornwater is on her route as far as the bend; past the bend is not; a day at the bend is a day she will owe at the next hold (unnamed, a brand on Pike's map past the bend), where she has been late before. Twelve times past the line after this walk.",
    "Order of march on the Fallow road: Seln out of sight ahead; Lira twenty paces on; Brom with two boxes by strap; the third box on Oryn's mule; Oryn on the mule's down-slope side; Karis with the carter's map; Cael. Oryn's walking catalogued: economical, sure-footed, never fast; does not look at the ground, does not look back, stops when the mule stops. Lira looks back at her twice in the first hour and then stops looking.",
    "The last mile: the road climbs out of thinning scrub (waist to knee to grass and stone) to a low ridge running across the road's line, with a shoulder to the left where the road bends hard left round it and out of sight; the calf says nine on the climb; the ribs stop his breath at the tape. Seln comes back down the road at the foot of the rise and takes the rear without a word. Lira sets her own lead at six paces. The line crosses the road at the shoulder's foot, where the road begins to leave its line — on the road, as Pike's folklore has it ('a place on it where your Arbiter stops').",
    "The line found on the way out, not by re-entry: each Arbiter returns at the same place on the road (Brom and Karis on their third stride back, Seln on his fourth from a pace further in, Lira when she comes level from six paces further in); Oryn gives Seln one nod at that place with her hands still up and does not speak; Cael says nothing and nobody asks him. Karis walks forward to the place and not one step past it and sets a two-fist stone in the rut at her heel on the near side. The procedure is completed to ten paces as Seln said.",
    "Camp: on the road, on the near (Thornwater) side of the stone, at Seln's word; no fire, at Seln's word, unquestioned 'because Pike had said where the dogs lived'. Brom sets the three boxes on the Thornwater side of the stone. Lira re-tapes the ankle. Seln stands at the stone and goes no further. Karis writes a short entry Cael reads as a stride, not a hypothesis. Nobody passes the stone.",
    "The view from the stone at dusk, limited to what is visible from the line: past the ridge, a shallow bowl of short grey grass; off the road, 'a long stone's throw and more', a ring of broken uprights of different heights ('as teeth are broken'), uncounted; under them a floor that takes the last sun 'as water takes it', a pool of light with dusk in the grass around it. No fused stone, no lip, no carvings, no measurement, no colour of the stone, no count of the uprights.",
    "Cael's shelf of kept sentences gains Karis's 'Between them you get the country' (filed beside 'sixty-four'), Vell's 'undefeated on paper', and Ephram's last line."
  ],
  ...
  "deviations": [
    "Length: the draft came in at 5,249 words by wc -w — inside the packet's tolerance (4,600 ±15%, ceiling 5,290) but at the top of the band. Process note, reported honestly: the first pass ran to 6,026 words and was compressed to length in three targeted passes (cuts to descriptive catalogue, letter reaction, gate narration, and the last-mile setup); no obligation text was touched by the compression. The line-edit pass may wish to take a further ~300–500 words from the map catalogue and the Thornwater table paragraph.",
    "Age: the packet's knowledge boundary states Cael is eighteen; the chapter contains no age reference (neither 'eighteen' nor any conflicting number), so there is no drift, but Chapter 8's inventory-line convention ('Eighteen.') is not repeated here. If the editor wants the age restated once per chapter, one word can be added to the Fallow-road inventory line ('Nine, held to nothing ...').",
    "Where the line lies: the packet does not specify whether the party meets the line on the road or off it. The draft places it ON the road at the shoulder of the rise where the road begins its bend — consistent with Pike's 'You walk a road, and there's a place on it where your Arbiter stops ... and you walk on past and it's back' and with Oryn's 'walked past that line on the void road eleven times ... never stepped off the road'. The ring is off the road, 'a long stone's throw and more', visible from the stone. This leaves Chapter 10's pacing free to establish the perimeter's shape; nothing in this chapter asserts a shape.",
    "The packet lists 'Their map has no roads. His has no quiet ground. Between them you get the country.' as Karis's verbatim line; the draft renders it as one uninterrupted quotation with the attribution before it ('... and said: \"Their map has no roads. His has no quiet ground. Between them you get the country.\"') so the sentence order is exact. 'His' refers to Pike's plank map (a carter's map); the packet calls the second map 'a carter's copy' and Chapter 8 established Karis copied it from Pike's plank — the draft reconciles both by having Karis finish copying Pike's plank map whole on the morning of the ninety-first (the ninetieth's copy covered the Fallow road's bend only).",
    "The dateline line before the mandated log entry ('*Ninety-fifth day. The Fallow road, second day east of Thornwater; the rise, the bend, the shoulder. A hundred and eight in hand; nothing owed. A stone in a rut.*') follows the established Chapter 4/7/8 convention (dateline line plus the mandated text); the mandated text itself is verbatim and unaltered.",
    "Ephram's letter names the new cohort captain's existence but not his name, by Ephram's own choice on the page ('whose name you would not know, so I'll not spend the ink'), to honour the no-new-named-people rule; the intake count (forty-one) and 'a fortnight ago' are invented weather-report detail within the letter's allowed composition.",
    "No fourth surface reading: Oryn does not put hands on Cael at Thornwater or at the line (she looks at the tape through the shirt and speaks to it), preserving the architecture's count of three failed surface readings before the Chapter 13 deep reading. Her 'whole and still' reason is stated; the day for it is deferred to the site."
  ],
  "blockers": []
}
