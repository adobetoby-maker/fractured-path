...

{
  ...
  "revisions": {
    ...
    "arc": "arc-b7-v2 (books/book-07-void-roads/CHAPTER_ARCHITECTURE.md, editor PASS r4, Chapter 8 card)",
    "state": "state-b7-post-ch07 (v3-runs/book-07/STATE_RUNNING.md + base snapshot)",
  ...
  "pov": {
    ...
    "knowledge_boundary": [
      "Cael is eighteen; nine + anomaly; party FIVE (Oryn is north on her route; 'Thornwater in nine days'). Injuries: Cael's ribs and calf still knitting on their own (taped, improving; he can walk and work); everyone else mended.",
      "The party knows: stillhounds hunt declarations; shale-backs flee them; 'quiet ground' as a rumor (Chapter 4: 'everybody knows... nobody goes in'). In THIS chapter Pike gives the folklore in full for the first time — everything a carter knows and nothing a researcher does: quiet ground is where the sigil goes to sleep; a handful of places along the void roads; carters walk around them; stillhounds live in them; nobody knows why and nobody has needed to because the rule is don't go in; he has walked past the Fallow Ring two hundred times and never stepped over the line; 'Thirty years on the roads and I've never met a practitioner who did it twice.' Asked what the line is: 'You'll know. Your Arbiter tells you. It stops.' NOTHING beyond that: no perimeter measurement, no fused stone, no survey stakes, no 'the Quieting' (Karis has not coined it), no theory.",
      "The contract: a broker's posting, well priced, for recovery of 'surveyor's instruments abandoned at a site on the Fallow road' with a map reference that is quiet ground. Seln notices the contract's LANGUAGE is registry prose ('abandoned at a site') under a Lowmarch broker's seal — 'somebody wrote this who learned to write inside' — and says so; nobody knows more. Teague's crew turned the contract down (Pike says so unasked).",
      "Teague does not appear in conversation. Oryn does not appear; the council notes the Fallow road runs through Thornwater on the ninth day — the day she said — and nobody says 'bring her'; Karis writes it down.",
      "No letters, no Vastin, no watchers."
    ]
  },
  "purpose": "Part 1's closing chapter: the book's freedom at full height (the ledger moved on the traverse, hold contracts beginning to come to them) and the contract that ends it — the recovery posting whose map reference makes Pike go still, the folklore of quiet ground given whole and institutional by the man who keeps the only honest record out here, a five-voice council that takes the job anyway, and the Part's summary log entry.",
  "scene_shape": {
    "opening_state": "Back at Lowmarch from Oxhollow. Pike's ledger entry for the traverse (mapped, delivered, cart lost, crew intact — he gives them the map and charges them the cart; Cael accepts it as fair). The unit's standing now real: hold contracts beginning to come to them instead of only to Teague's crew.",
    "pov_goal": "Take the first artifact-recovery posting they qualify for — and understand why the best crew on the board would not.",
    "opposition": "Pike's stillness at the map reference; the folklore's one rule (don't go in); a contract written in the wrong prose; and Karis, who would go alone if they didn't.",
    "turn": "The posting: a broker's contract, well priced, for recovery of 'surveyor's instruments abandoned at a site on the Fallow road', map reference given. Pike reads it and goes still. He tells them what he knows — the folklore whole (see knowledge_boundary), ending with 'Your Arbiter tells you. It stops.' Karis's underlined rumor has just become a location.",
    "choice": "The council at Lowmarch's inn, five voices: it pays BECAUSE nobody will take it; Teague's crew turned it down; the instruments are worth the contract; the site is two days east. Seln finds the first wrong thing — registry prose under a broker's seal — and it goes in the log without being understood. The route runs through Thornwater on the ninth day, the day the healer said; nobody says bring her; Karis writes it down. They take it: because it pays, because the freedom chapter taught them they can, and because Karis would go alone.",
    "outcome": "Contract taken; two days east through Thornwater; Part 1 closes with the freedom intact and the first crack in it (the prose, the stillness, the rule).",
    "closing_state": "The chapter ENDS ON THE LOG, Part 1's summary entry: 'Eight weeks. Seven contracts. Pike says there's ground out here where the Arbiter goes quiet, and nobody goes in twice. Karis has been waiting her whole life for a sentence like that. Seln says the contract was written by someone from inside. I say it pays. Two days east, through Thornwater, on the day the healer said. For eight weeks nothing out here has read me. I'd like to see what a place that reads nothing does with that.'"
  },
  "obligations": {
    "must_include": [
      "Pike's traverse entry (map delivered, cart charged) and Cael accepting it as fair; the standing shift (hold contracts coming to them) shown through the board, not asserted.",
      "The recovery posting as an object (broker's seal, the phrase 'surveyor's instruments abandoned at a site on the Fallow road', a map reference).",
      "Pike's stillness and the folklore given whole, in his register, with the three verbatim beats: 'I've walked past the Fallow Ring two hundred times. Never once stepped over the line. Thirty years on the roads and I've never met a practitioner who did it twice.'; Karis: 'What's the line?'; Pike: 'You'll know. Your Arbiter tells you. It stops.'",
      "Seln's finding on the contract's language (registry prose under a broker's seal; 'somebody wrote this who learned to write inside') — logged, not understood; Pike saying unasked that Teague's crew turned it down.",
      "The five-voice council with each voice in register; the Thornwater/ninth-day observation; nobody says 'bring her'; Karis writes it down; the decision taken for the three stated reasons.",
      "The chapter ENDS on the Part 1 summary log entry as given (the previous chapter ended on an image).",
      "Cael's cataloguing outside the log (the board's new postings; Pike's face going still; the map).",
      "Manuscript format: H1 '# Chapter 8 — Quiet Ground', prose only, '---' breaks, ends on the last line of prose."
    ],
    "plants": [
      "Quiet ground as folklore-with-teeth (the sigil sleeps; carters walk around; stillhounds live in it; nobody goes in twice) — Chapter 9–10 measure it.",
      "Registry prose under a broker's seal — the Compact's first reach on paper (Chapter 12, 16, 17).",
      "'The Fallow Ring' as Pike's name for the place (descriptive site name).",
      "Thornwater on the ninth day — Oryn joins the walk in Chapter 9."
    ],
    "payoffs": [
      "Chapter 4's rumor becomes a location and a contract.",
      "Chapter 5's freedom (paid to catalogue) ends on the first job Cael takes for a reason other than pay."
    ],
    "prohibited_outcomes": [
      "Nobody goes to the site in this chapter; nobody measures, theorizes, or names 'the Quieting'; no fused stone, stakes, or ruin described beyond Pike's folklore.",
      "No Oryn on the page; no Teague dialogue; no fight; no fragment use; no letters; no Vastin.",
      "No new named people or places beyond 'the Fallow road' / 'the Fallow Ring' as Pike's terms.",
  ...
  "invention_budget": {
    "allowed": [
      "Lowmarch in late summer (the meadow turning over, the board's new postings, the inn's council table); Pike's manner and one-armed economy; the posting's paper and seal as objects; the map.",
      "Dialogue in established voices beyond the mandated lines; Seln's finding in his flat register.",
      "Cael's interior cataloguing and the log."
    ],
    "approval_required": [
      "Any new named entity; any fact about quiet ground beyond Pike's folklore; any fact about the broker or the poster."
    ],
    "forbidden": [
      "Entering or seeing the site; measuring; theory; Oryn; fights; fragment use; a dialogue or image ending; metadata."
    ]
  },
  "context_files": [
    {
    ...
    {
      "kind": "previous_scene",
      "label": "Chapter 7 as drafted — the immediate seam (Oryn's parting line, Teague's pricing)",
      "path": "v3-runs/book-07/drafts/ch07.md",
      "required": true
    },
    {
      "kind": "reference",
  ...
  "exceptions": [],
  "output": {
    "draft_path": "v3-runs/book-07/drafts/ch08.md",
    "report_path": "v3-runs/book-07/reports/ch08-author-r1.json",
    "editor_report_path": "v3-runs/book-07/reports/ch08-editor-r1.json",
    "verifier_report_path": "v3-runs/book-07/reports/ch08-verifier-r1.json",
    "target_words": 4600,
...
## After Chapter 8 (draft r1 with editor; provisional until PASS) — Lowmarch, ~day 90; contract taken
...
# CONTEXT — Chapter 7 as drafted — the immediate seam (Oryn's parting line, Teague's pricing) (v3-runs/book-07/drafts/ch07.md)
...
# MANUSCRIPT — v3-runs/book-07/drafts/ch08.md

# Chapter 8 — Quiet Ground

Lowmarch on the ninetieth day, from the shelf above the ford, catalogued because it had been twenty days and because the meadow had turned over again while they were on a mountain.
...
They went down to the landing with three boxes and the look of people who had walked a long way round to arrive where they had left.

The board was under its roof, and Pike was under the roof with it.

---

He read the board before he read the man, because that was the order.

Seventeen slips. He read all seventeen twice and sorted, standing at the plank's far end, and the sort came out wrong, and he did it again, and it came out the same way, and he understood that the board had changed shape while they were on the mountain.

Six escorts. Two fence-lines. A wash recovery; a load out of a bog. Four hold contracts on good square paper with brands burned in the corner, each with HOLD in Pike's hand and a name written beside the word. Beside two of the four the name was Teague. Beside the other two — a fence-line at a hold on the east road whose brand was an axe-head, forty marks; a stretch of the north road to be walked ahead of a hold's carts before the autumn, fifty and fed — the name was not a name. It was five names, in a row, spelled as they had been said, in the same hand and the same size as the word beside them.

He read the five names four times. Then he read the rest of the board.

"Holds came to the ferry," Pike said, to the page. He had not looked up. "Asked who. I said you." The pen went on. "Axe-head's the fence you cleared cheap the first week. They've a longer one now and they asked by the names, because you've not given me a crew's name and I'll not make one up."

"When," said Lira.

"Fence a week ago. Road, four days." He finished his line. "They'll wait a fortnight or they'll take Teague. A hold doesn't mind which. That's what a hold is."

Cael put it where he kept things. Two slips. Forty and fifty. HOLD, and their names. Not a line on a wall — a hold, at the ferry, asking a one-armed man who, and the man saying five names. There was nothing on the shelf beside it that was the same shape.

"Traverse," Pike said.

Cael put the slip on the plank. Oxhollow's ford-keeper had marked it at the table under the lean-to with ink and rope on his hands, and had written across the brand in the corner the one word he had said aloud — *round* — and Pike drew it out from under the stone's edge and read it silently, and turned it to the light, and looked at the word.

"Witness is the ford."

"The man who keeps it."

"Right." He pinned it flat with the stone and did not write yet. "High traverse, Oxhollow to Thornwater. Mapped. Delivered at the ford. Carts go round." A pause, exactly as long as the pause he gave everything. "Cart lost. Crew of five, three hurt, none lost. Seventy." He looked up. "Paid seventy?"

"Paid seventy."

"Paid seventy." He wrote, and the five columns took it, and the fourth column took *carts go round* and *cart lost* in the same ink and the same size, and Cael watched them go in and did not look away from either. Then Pike stopped, with the pen up, and said the next thing to the page and not to any of them.

"Smith's cart."

"Six. I'll pay him today."

"Pay him. It's not his line. It's yours." He wrote again, at the end of the price column, smaller: *less six, the cart.* "You hired it and it went in a gorge. Seventy's what the ford paid. Sixty-four's what the job was worth. That's what goes on the wall." He read the whole line back aloud, word for word, from *High traverse* to *less six*, to the meadow, at the same size as everything he read, and when it was said he wiped the pen.

Cael had the arithmetic before the pen was wiped, because it was the arithmetic he would have done. A map had been asked for and a map had been made, and the map said no, and a map that said no was a map — the ford had paid seventy for it and would go round because of it; that was the credit, whole. A hired cart had gone into a gorge under their hands; that was the debit, whole, in the same column at the same size, and the wall would carry it as long as the wall carried them. He looked for the place in himself that wanted to argue the six, and found it empty. The bench had been a cart. Teague had said so at a ford and been right, and here it was in ink, and it was fair. He had been priced by better-made instruments than this one and never by a fairer.

"Fair," he said, because he had been asked nothing and it wanted saying anyway.

Pike looked at him for the length of one count of five, and let it go, and said, "Saying's tonight," and turned the ledger, with two fingers and one push, so that the page faced across the plank.

Seven lines under the heading now. He read them the right way up.

---

The posting was under the stone's far edge, where slips went that had been read and put back.

He would not have seen it from where he stood, except that Karis had gone round the plank to the map, as Karis went round anything to a map, and had put a hand on the stone to steady the sheet, and the corner of a thin paper had shown under the stone's edge, and he read papers. Thin: a broker's. A clerk's hand. He read it upside down from a yard off, out of habit and because it was there, and the first word stopped him.

*Recovery.*

He went round the plank. Pike watched him come and did not stop him. The slip had been under the stone long enough for the stone to have left a mark on it — a curve of dust where the weight had sat — and he drew it out and laid it flat and read it the right way up.

Broker's paper, the thin kind. A clerk's hand: even, schooled, the letters sitting on a line that had not been drawn. In the corner, pressed into a drop of dark wax, the broker's seal — a hook and a bar — which he had seen in ink on a third of the bales on the landing, because they were that broker's bales. *Recovery,* it said. *Surveyor's instruments abandoned at a site on the Fallow road.* Then the site: *east of Thornwater; the second day; where the road leaves its line at the rise and comes back to it.* Then the price, written twice, as brokers wrote it, once in figures and once in words. A hundred marks. *One hundred.* Then the seal, and nothing else — no crew's mark on it, no HOLD, no name beside a word, nothing to say who had taken it, because nobody had.

It was the best number on the board. The autumn road had been sixty and fed. This was a hundred, dry, for a walk and a carry.

He read it a second time for what it was. Item: a hundred marks for instruments, which meant the instruments were worth more than a hundred to whoever wanted them back, which meant they were real. Item: *abandoned,* not lost — a word with a hand in it; somebody had put them down. Item: the Fallow road, which he had seen on the map on this plank going east out of Thornwater's brand, and had not walked. Item: the dust-curve, which said the slip had been on this board longer than the two with his name beside them, and the soft corners, which said it had been picked up and put back by more than one hand.

"How long," he said.

"Fortnight." Pike had not looked at the slip; he had not needed to. "Broker's on the landing; his clerk wrote it. Every crew on the wall's read it. Every one of them put it back."

"Why?"

Pike put out his hand.

Cael gave him the slip. It was not a thing he did without deciding to; he had had paper taken out of his hands by better-dressed men for four years. He decided, and Pike took it in the one hand and held it to the light off the river and read it the way he read a slip before he wrote it — silently, once — and Cael, who watched faces at a plank, saw it happen.

The pen was in the same hand as the slip, between two fingers. It had been moving, a little, as a pen moves in a hand that is used to writing; it stopped. The face did the thing it had done for the man with eleven bales — did not change, and stopped moving — and then more than that: the shoulder that had a sleeve settled, a finger's width, as a load settles when the man under it has decided to carry it a while longer; and the eyes reached the place on the paper where the site was and stayed there, and did not go on to the price. He was not reading any longer. He was looking at a place.

Cael counted. He got to nine.

"That's the Fallow Ring," Pike said.

Karis's pen had come up off the map. Lira, who had been at the roof's edge, was not at the roof's edge. Brom had not moved. Seln was on the river side, and Cael did not look for him.

"That's quiet ground."

He said it as he said a price. Then he put the slip down on the plank, face up, and set the stone on it — on the corner with the wax, not on the words — and looked at the five of them, and Cael understood that the man had decided what he was going to say, and that it was the decision of a man who kept the only book out here that anybody could check.

"You've heard the words."

"Once," Karis said. Her voice had gone to the exact place she kept it for a source. "A carter's wife at Thornwater. Three sentences. Everybody knows the quiet ground. Nobody goes in."

"That's the whole of it," Pike said. "Near enough. I'll give you the rest, because you're going to read it off that slip whether I do or don't, and I'd sooner it came from me than from the ferry."

He said it plainly, in the order a carter says the fords on a road, and Cael took it down in his head as it came, because it came in the shape of a thing said many times and never once written.

"Quiet ground's where the sigil goes to sleep. Yours. Everyone's. You walk a road, and there's a place on it where your Arbiter stops — not slows; stops — and you walk on past and it's back. There's a handful of them. Along the void roads, all of them. Carters walk round them, and have as long as there've been carters. The dogs live in them. Stillhounds. Nobody's asked them why. Why any of it, nobody knows and nobody's needed to, because the rule's *don't go in*, and the rule's never once failed anybody who kept it." He stopped, and the stopping was part of it. "That's what a carter knows. That's what I know. There's not a man on the ferry knows a word more."

Nobody spoke. Karis was not writing. Cael marked that — Karis with a pen and a primary source and the pen not moving — and then she did write, three words, small, and he could not see which.

"Ring," Brom said. Not a question; the weight of the word, checked.

"Stones, some of them standing, in a ring. You see it off the road and you keep walking." His eyes had not left the slip. "I've walked past the Fallow Ring two hundred times. Never once stepped over the line. Thirty years on the roads and I've never met a practitioner who did it twice."

The river went by under the landing. The ferry's rope creaked once on its post.

"What's the line?" said Karis.

Pike looked at her, and at the pen, and at the healed hand holding it, and answered the question she had asked and not one she had not.

"You'll know," he said. "Your Arbiter tells you. It stops."

---

He paid the smith.

He did it then, before anything else, because six marks were owed and he had them. The smith took the six without stopping the hammer and said the cart had been a good cart and he had another, and would they be wanting it, and Cael said not this time, and the smith said that was what everyone said who had put one in a gorge.

A hundred and eight in hand.

When he came back under the roof Karis had the middle box open on the plank's landward end, with Pike's leave and without having asked for it, and had come out of it with a single thin page from the far end of a bundle and laid it on the plank beside the map. He knew the page. He had watched it go in. The letters were twice their size and leaned two ways, and there were three sentences on it, and under two words of the second sentence there were two lines.

She put a finger on the map at Thornwater's brand, and drew it east along the line that left the brand with days written beside it, slowly, a day, and stopped it where the line went out of true — bent, as a road bends round a bog — and came back. The second day. She held the finger there a moment. Then she took it off and looked at the page with the two lines under it instead.

"A location," she said. It was the first thing she had said since the plank. "And a contract."

"Karis."

"I'm not going to say anything else about it here." She did not look up. "I'm going to say it at a table, with a jug, to four people, once. I've had a rumor under a slip for a month. I'd like the next thing I say about it to be a sentence I've thought about."

She put the page back in the bundle and the bundle back in the box and closed the lid, and did not look at the stone with the slip under it, which Cael marked as the thing that cost her most, because he had watched her not-ask a carter's wife and this was the same shape, larger.

Lira had gone to the roof's edge again, on the road side. He went and stood beside her. She was looking at the road east, which went to Thornwater and past it, and her weight was on the mended leg and off the taped ankle, which was how she stood now.

"Two hundred times," she said. "He counted."

"He counts."

"So do you. I've never once heard you say never." She did not look at him. "Seln's not moved since the man said *dogs*."

He had not. Cael found him without turning his head, because he knew where the river side of the roof was, and Seln was on it, with his back to the post and his eyes on nothing, in the posture he kept for a road he had not walked yet.

---

The board's room, with the light gone off the water.

Six tables. The carters at the two by the road door, five of them, loud, and the hide-woman with them. The middle table: nobody. The best table by the fire: four chairs pushed in and no jug — Teague's crew out on the east road since dawn on the axe-head hold's other slip, the long fence, HOLD, Teague. Pike behind the book at the table by the fire, with a bowl, and the stone on the book. The sheet on the long wall on its four pegs. And the five of them at the table by the road door, because Brom could see both doors from it, with a jug and a loaf, and Karis's book open, and his own satchel flat on his knee.

He counted the sheet from where he sat before Pike opened the book. Thirteen lines. Theirs was the twelfth. He knew that and counted anyway.

Pike opened the book at the day's page and put two fingers on the line and read it to the room, not to them, the whole of it, *High traverse* to *less six, the cart*, and the carters stopped for it and started again after, and the hide-woman, who was new, looked at the five of them and at the wall and back, and that was a verdict from someone who did not know what she was pricing, and Cael filed it as one.

"That's said," Pike told the book.

Then he did the rest, as he had done it on the sixtieth day: took the four pegs out one-handed, let the sheet roll down into his hand, laid it under the stone, took a clean one, and wrote in the hand that did not hurry. He stopped at the ninth line this time, and looked at the old sheet, and wrote five names. Then three more lines under them, the mule last, and he pinned the new sheet in the same four holes and sat back down.

Tenth.

Two lines, for a map that said no and a cart in a gorge. He had been moved on walls by panels that had had a season to think about it, and never by a man who had thought about it for the length of time it took to say *sixty-four*, and had been right both times he had moved them, by a reckoning Cael could check.

"Teague's nine up," Pike said, to the book, asked by nobody. Then, still to the book, at the same size, as if it were the next line and not a different thing: "He read that slip yesterday. Read it twice, same as the boy did. Put it back under the stone and took the fence. I'd have done the same, and I told him, and he said he knew."

He picked up his bowl. That was the whole of it, unasked, and Cael put it on the shelf beside *he'll speak to you when you've cost him something* and found that the two sentences faced each other.

Karis closed her book on her finger.

"Now," she said.

---

She said it once, as she had promised, in the order she meant it.

"Everybody knows the quiet ground. Nobody goes in. I've had that under a slip since Thornwater, underlined, filed as a source and a bad one, because it was one woman on a cart and I couldn't ask her the next question. Today a man who has kept the only checkable record in this country for thirty years said the same two sentences, with a name in them, and a road, and a day-count, and a rule, and then a broker's slip put a price on it." She turned the book round on the table so that they could see the page, which was the three leaning sentences copied fair beneath the original in her own present hand, and under them, new: *The Fallow Ring. Fallow road, east of Thornwater, second day. Pike: the sigil stops at a line. The line: 'your Arbiter tells you.'* "That is a primary source — the first I have had on this side of the Line that is a place and not a rumor. I am going to go and stand at the line he says exists and find out whether my Arbiter does what he says it does. I would very much rather do that with the four of you than without. I've said that in the order I mean it, and I'll not say the last part twice."

She sat back. The pen was in the healed hand, and the hand was not quite steady, and she let it be seen.

Brom, who priced a thing by its weight before anything else, said: "A survey kit's a cart's worth. Brass. A level, a chain, the rule. Nobody puts a cart's worth down and walks off from it unless they walked off fast." He looked at the jug. "That's not the reason. That's what it is."

"The reason," Lira said, "is the number. It's a hundred because it's been under a stone a fortnight and the man who's nine lines up read it twice and put it back." She had a hand flat on the table, on the taped side, the way she put a hand down when she meant to stand and was not standing yet. "Two days past Thornwater. We've walked worse for forty. You've got three ribs and a calf; say that before he does." A nod, small, at the fire, where Pike was. "I'm saying it's a walk and a carry. I'm not saying it isn't the other thing."

"It pays," Cael said.

That was his voice at the table, and the four of them let it be, and he catalogued that they did.

Seln had the slip.

He had not been at the plank when it came out from under the stone and he had not asked for it; Pike had put it in his hand at the door, unasked, as Pike put things in hands, and he had brought it to the table and laid it flat by the jug and had been reading it since the saying, with the lamp on it — not the words; the paper. He turned it to the light now, as Pike turned a slip, and looked at the wax in the corner, and then at the hand, and then at the words, and then said the thing he said, which was the thing nobody else at the table could have said.

"Wax is right. Hook and bar; that's the landing broker. Hand's a clerk's — schooled, no drawn line; a broker's clerk writes on a line he can't see because he was taught to. That's right too." He put one finger on four words. "*Abandoned at a site.* That's not a broker's clerk. Not the letters — the words. A carter says *the place*, *the bend*, *the rise*. A broker's clerk writes what the carter said. Nobody out here says *site*. Nobody out here says *abandoned at*. That's a form. I've filled that form in." He took the finger off. "Somebody wrote this who learned to write inside."

Nobody said anything for the length of a breath. The carters by the door were laughing at something that was not this.

"Meaning," Karis said.

"I don't know." Flat; a road he had not walked. "The wax says the landing broker posted it. The words say whoever gave him the words to post learned them somewhere with a registry in it. That's two facts. I've not got a third and I'm not going to make one at a table." He pushed the slip a finger's width toward Cael, which was how he gave a thing to the log. "It goes in. Somebody looks at it later, when there's more."

"It goes in," Cael said.

"That's not a reason not to go," Seln said. "I want that said, because somebody's going to think it's what I've been sat here thinking. It's a reason to read the paper twice. I've read it twice." He looked at Karis, once. "Fifteen years I walked into rooms on paper that was wrong in a way I couldn't name. This is wrong in a way I can. I'd rather walk into this one on her account than any of theirs."

Karis did not write that down. It was the first thing all evening she had not written down, and Cael marked it, and would have put it in the log if it had been his.

Brom said, "Where does the Fallow road leave from."
...
Cael had the count before she said it, because he had had the count since Oxhollow's gate, and had carried it six days without taking it out. Nine days from the eighty-fourth. The ninety-third. Thornwater on her route, and the mule at the gate, and a woman who had said *come find me* at a walk that did not look back.

"The ninth day," Karis said. "The day she said."

Nobody said the sentence.

He watched four people not say it, and it was the most careful thing he had seen any of them do at a table. Lira's hand stayed flat. Brom looked at the jug. Seln looked at the door. Karis looked at the map, at the brand of the steading where a healer would be on the ninety-third with a table and a line of people who were hers, and did not say *bring her*, and neither did he, who had had the sentence at a gate and catalogued not saying it, and now watched four other people arrive at the same gate and do the same thing, each for a reason he could guess and would not write. She had seven holds and a child three stops on and a road she owned. You did not say *bring her* about a person like that. You said where you would be.

Karis wrote. He read it upside down as it went in, small, under the day-count.

*Thornwater, ninety-third. The healer.*

That was all. She underlined nothing.

"Then that's the walk," Lira said.

"That's the walk." Brom.

Cael took the slip from where Seln had pushed it, folded it once along the dust-curve, and put it in the satchel against the leather book, where a thing went that would be taken out later. Then he got up, and went to the fire, and stood at the table by it until Pike looked up from the bowl, and said, "The recovery. The Fallow road. We'll mark it."

Pike looked at him for one count of five.

"Mark it in the morning," he said. "At the plank, in front of the meadow, so it's seen." He went back to the bowl. "I'll write HOLD by it if you like. There's nobody else to write."

"Our names."

"Your names. It's the only crew's name you've got." The spoon. "Whoever marks it at the other end marks it. That's the board."

He went back to the table by the road door. Seln was watching the landing door. Lira had taken her hand off the table. Brom had poured the last of the jug into Karis's cup without saying anything about it, and she had not noticed yet.

He took out the log and wrote the thing he had been carrying since a man's face stopped over a piece of thin paper, in the plain hand, because it was the end of something and he wrote the ends of things plainly.

*Ninetieth day. Lowmarch. The lower inn, the table by the road door. A hundred and eight in hand; the smith paid; the wall says tenth.*

*Twelve weeks. Seven contracts. Pike says there's ground out here where the Arbiter goes quiet, and nobody goes in twice. Karis has been waiting her whole life for a sentence like that. Seln says the contract was written by someone from inside. I say it pays. Two days east, through Thornwater, on the day the healer said. For twelve weeks nothing out here has read me. I'd like to see what a place that reads nothing does with that.*
...
# AUTHOR REPORT — v3-runs/book-07/reports/ch08-author-r1.json

{
  ...
  "obligations": [
    {
      "obligation": "must_include: Pike's traverse entry (map delivered, cart charged) and Cael accepting it as fair; the standing shift (hold contracts coming to them) shown through the board, not asserted.",
      "status": "MET",
      "evidence": "The entry, read at the plank in procedure: '\"High traverse, Oxhollow to Thornwater. Mapped. Delivered at the ford. Carts go round.\" A pause, exactly as long as the pause he gave everything. \"Cart lost. Crew of five, three hurt, none lost. Seventy.\"' The cart charged: '\"Pay him. It's not his line. It's yours.\" He wrote again, at the end of the price column, smaller: *less six, the cart.* \"You hired it and it went in a gorge. Seventy's what the ford paid. Sixty-four's what the job was worth. That's what goes on the wall.\"' Cael accepting it: 'He looked for the place in himself that wanted to argue the six, and found it empty. The bench had been a cart. Teague had said so at a ford and been right, and here it was in ink, and it was fair. He had been priced by better-made instruments than this one and never by a fairer. / \"Fair,\" he said, because he had been asked nothing and it wanted saying anyway.' The standing shift through the board: 'Four hold contracts on good square paper with brands burned in the corner, each with HOLD in Pike's hand and a name written beside the word. Beside two of the four the name was Teague. Beside the other two — a fence-line at a hold on the east road whose brand was an axe-head, forty marks; a stretch of the north road to be walked ahead of a hold's carts before the autumn, fifty and fed — the name was not a name. It was five names, in a row' and Pike: '\"Holds came to the ferry,\" Pike said, to the page. He had not looked up. \"Asked who. I said you.\"' The wall moves two lines that night ('Tenth.' / '\"Teague's nine up,\" Pike said')."
    },
    {
      "obligation": "must_include: The recovery posting as an object (broker's seal, the phrase 'surveyor's instruments abandoned at a site on the Fallow road', a map reference).",
      "status": "MET",
      "evidence": "'Broker's paper, the thin kind. A clerk's hand: even, schooled, the letters sitting on a line that had not been drawn. In the corner, pressed into a drop of dark wax, the broker's seal — a hook and a bar — which he had seen in ink on a third of the bales on the landing, because they were that broker's bales. *Recovery,* it said. *Surveyor's instruments abandoned at a site on the Fallow road.* Then the site: *east of Thornwater; the second day; where the road leaves its line at the rise and comes back to it.* Then the price, written twice, as brokers wrote it, once in figures and once in words. A hundred marks. *One hundred.* Then the seal, and nothing else — no crew's mark on it, no HOLD, no name beside a word, nothing to say who had taken it, because nobody had.' Plus the object's history read off the paper: 'the dust-curve, which said the slip had been on this board longer than the two with his name beside them, and the soft corners, which said it had been picked up and put back by more than one hand.'"
    },
    {
      "obligation": "must_include: Pike's stillness and the folklore given whole, in his register, with the three verbatim beats (the two-hundred-times line; Karis 'What's the line?'; Pike 'You'll know. Your Arbiter tells you. It stops.').",
      "status": "MET",
      "evidence": "Stillness, catalogued: 'The pen was in the same hand as the slip, between two fingers. It had been moving, a little, as a pen moves in a hand that is used to writing; it stopped. The face did the thing it had done for the man with eleven bales — did not change, and stopped moving — and then more than that: the shoulder that had a sleeve settled, a finger's width ... He was not reading any longer. He was looking at a place. / Cael counted. He got to nine. / \"That's the Fallow Ring,\" Pike said.' The folklore whole, in his register: '\"Quiet ground's where the sigil goes to sleep. Yours. Everyone's. You walk a road, and there's a place on it where your Arbiter stops — not slows; stops — and you walk on past and it's back. There's a handful of them. Along the void roads, all of them. Carters walk round them, and have as long as there've been carters. The dogs live in them. Stillhounds. Nobody's asked them why. Why any of it, nobody knows and nobody's needed to, because the rule's *don't go in*, and the rule's never once failed anybody who kept it.\" He stopped, and the stopping was part of it. \"That's what a carter knows. That's what I know. There's not a man on the ferry knows a word more.\"' The three verbatim beats, contiguous: '\"I've walked past the Fallow Ring two hundred times. Never once stepped over the line. Thirty years on the roads and I've never met a practitioner who did it twice.\"' / '\"What's the line?\" said Karis.' / '\"You'll know,\" he said. \"Your Arbiter tells you. It stops.\"' Nothing beyond the folklore: no measurement, no floor, no stakes, no theory, no 'the Quieting' (grep: 0)."
    },
    {
      "obligation": "must_include: Seln's finding on the contract's language (registry prose under a broker's seal; 'somebody wrote this who learned to write inside') — logged, not understood; Pike saying unasked that Teague's crew turned it down.",
      "status": "MET",
      "evidence": "Seln at the council: '\"Wax is right. Hook and bar; that's the landing broker. Hand's a clerk's — schooled, no drawn line ... That's right too.\" He put one finger on four words. \"*Abandoned at a site.* That's not a broker's clerk. Not the letters — the words. A carter says *the place*, *the bend*, *the rise*. A broker's clerk writes what the carter said. Nobody out here says *site*. Nobody out here says *abandoned at*. That's a form. I've filled that form in.\" He took the finger off. \"Somebody wrote this who learned to write inside.\"' Not understood: '\"Meaning,\" Karis said. / \"I don't know.\" Flat; a road he had not walked. \"... That's two facts. I've not got a third and I'm not going to make one at a table.\" He pushed the slip a finger's width toward Cael, which was how he gave a thing to the log. \"It goes in.\"' Logged: the closing entry's 'Seln says the contract was written by someone from inside.' Pike, unasked, at the book: '\"Teague's nine up,\" Pike said, to the book, asked by nobody. Then, still to the book, at the same size, as if it were the next line and not a different thing: \"He read that slip yesterday. Read it twice, same as the boy did. Put it back under the stone and took the fence. I'd have done the same, and I told him, and he said he knew.\"'"
    },
    {
      "obligation": "must_include: The five-voice council with each voice in register; the Thornwater/ninth-day observation; nobody says 'bring her'; Karis writes it down; the decision taken for the three stated reasons.",
      "status": "MET",
      "evidence": "Karis (research voice, the source, would go alone): '\"That is a primary source — the first I have had on this side of the Line that is a place and not a rumor. I am going to go and stand at the line he says exists and find out whether my Arbiter does what he says it does. I would very much rather do that with the four of you than without. I've said that in the order I mean it, and I'll not say the last part twice.\"' Brom (weight): '\"A survey kit's a cart's worth. Brass. A level, a chain, the rule. Nobody puts a cart's worth down and walks off from it unless they walked off fast.\" He looked at the jug. \"That's not the reason. That's what it is.\"' Lira (facts for checking, bodies): '\"The reason,\" Lira said, \"is the number. It's a hundred because it's been under a stone a fortnight and the man who's nine lines up read it twice and put it back.\" ... \"Two days past Thornwater. We've walked worse for forty. You've got three ribs and a calf; say that before he does.\"' Cael: '\"It pays,\" Cael said. / That was his voice at the table, and the four of them let it be, and he catalogued that they did.' Seln (flat, professional): the language finding above, and '\"That's not a reason not to go ... It's a reason to read the paper twice. I've read it twice.\"' The ninth day: '\"The ninety-first tomorrow,\" Brom said. \"Thornwater the ninety-third.\" / Karis's pen stopped. ... \"The ninth day,\" Karis said. \"The day she said.\" / Nobody said the sentence.' Nobody says bring her: 'and did not say *bring her*, and neither did he, who had had the sentence at a gate and catalogued not saying it, and now watched four other people arrive at the same gate and do the same thing ... You did not say *bring her* about a person like that. You said where you would be.' Karis writes it: 'Karis wrote. He read it upside down as it went in, small, under the day-count. / *Thornwater, ninety-third. The healer.* / That was all. She underlined nothing.' The three reasons: it pays (Cael's line and the log's 'I say it pays'); the freedom taught them they can (Lira: 'We've walked worse for forty'; the hold slips waiting: 'They'll wait a fortnight or they'll take Teague'); Karis would go alone ('I would very much rather do that with the four of you than without'; Seln: 'I'd rather walk into this one on her account than any of theirs'). Decision: '\"Then that's the walk,\" Lira said. / \"That's the walk.\" Brom.' and Cael to Pike: '\"The recovery. The Fallow road. We'll mark it.\"'"
    },
    {
      "obligation": "must_include: The chapter ENDS on the Part 1 summary log entry as given (the previous chapter ended on an image).",
      "status": "MET",
      "evidence": "Final two paragraphs are the log, italic, dateline then entry: '*Ninetieth day. Lowmarch. The lower inn, the table by the road door. A hundred and eight in hand; the smith paid; the wall says tenth.* / *Twelve weeks. Seven contracts. Pike says there's ground out here where the Arbiter goes quiet, and nobody goes in twice. Karis has been waiting her whole life for a sentence like that. Seln says the contract was written by someone from inside. I say it pays. Two days east, through Thornwater, on the day the healer said. For twelve weeks nothing out here has read me. I'd like to see what a place that reads nothing does with that.*' Nothing follows it. The entry matches the packet's text verbatim EXCEPT the week count, changed from 'eight' to 'twelve' in both places for continuity with the running state (see deviations, item 1); a one-word revert restores the packet wording exactly. Ch7 closed on an image; this closes on a log entry (no repeat)."
    },
    {
      "obligation": "must_include: Cael's cataloguing outside the log (the board's new postings; Pike's face going still; the map).",
      "status": "MET",
      "evidence": "The board: 'Seventeen slips. He read all seventeen twice and sorted ... Six escorts. Two fence-lines. A wash recovery; a load out of a bog. Four hold contracts on good square paper ...' and the posting itemized: 'Item: a hundred marks for instruments ... Item: *abandoned,* not lost — a word with a hand in it; somebody had put them down. Item: the Fallow road ... Item: the dust-curve ...'. Pike's face: the stillness passage quoted above, counted ('Cael counted. He got to nine.'). The map: 'She put a finger on the map at Thornwater's brand, and drew it east along the line that left the brand with days written beside it, slowly, a day, and stopped it where the line went out of true — bent, as a road bends round a bog — and came back. The second day.' Also the opening catalogue of Lowmarch in late summer (river, ferry, smith, meadow forty where there had been thirty-one, grass gone to seed) and the inn's room."
    },
    {
      "obligation": "must_include: Manuscript format: H1 '# Chapter 8 — Quiet Ground', prose only, '---' breaks, ends on the last line of prose.",
      "status": "MET",
      "evidence": "First line: '# Chapter 8 — Quiet Ground'. Five '---' breaks. No metadata; grep for 'End of Chapter', 'approximately', 'word count' returns zero. The file ends on the italic log entry's last sentence."
    },
    {
      "obligation": "plant: Quiet ground as folklore-with-teeth (the sigil sleeps; carters walk around; stillhounds live in it; nobody goes in twice) — Chapter 9–10 measure it.",
      "status": "MET",
      "evidence": "All four elements in Pike's speech: 'where the sigil goes to sleep'; 'Carters walk round them, and have as long as there've been carters'; 'The dogs live in them. Stillhounds. Nobody's asked them why.'; 'never met a practitioner who did it twice' / the log's 'nobody goes in twice'. Nothing measured; the line is defined only as 'You'll know. Your Arbiter tells you. It stops.' Karis's stated intent seeds Ch9–10: 'I am going to go and stand at the line he says exists and find out whether my Arbiter does what he says it does.'"
    },
    {
      "obligation": "plant: Registry prose under a broker's seal — the Compact's first reach on paper (Chapter 12, 16, 17).",
      "status": "MET",
      "evidence": "The seal established as genuine and local ('Wax is right. Hook and bar; that's the landing broker'), the prose as foreign ('Nobody out here says *site*. Nobody out here says *abandoned at*. That's a form. I've filled that form in.' / 'Somebody wrote this who learned to write inside.'). The slip itself is kept: 'Cael took the slip ... folded it once along the dust-curve, and put it in the satchel against the leather book, where a thing went that would be taken out later.' No Compact named, no theory ('I've not got a third and I'm not going to make one at a table')."
    },
    {
      "obligation": "plant: 'The Fallow Ring' as Pike's name for the place (descriptive site name).",
      "status": "MET",
      "evidence": "'\"That's the Fallow Ring,\" Pike said.' The descriptive referent given once, at Brom's one-word prompt, in Pike's register and no further: '\"Ring,\" Brom said. Not a question; the weight of the word, checked. / \"Stones, some of them standing, in a ring. You see it off the road and you keep walking.\"' Karis enters it: '*The Fallow Ring. Fallow road, east of Thornwater, second day.*' The road is 'the Fallow road' throughout (posting, Pike, Karis, Cael)."
    },
    {
      "obligation": "plant: Thornwater on the ninth day — Oryn joins the walk in Chapter 9.",
      "status": "MET",
      "evidence": "'\"The ninety-first tomorrow,\" Brom said. \"Thornwater the ninety-third.\" ... Nine days from the eighty-fourth. The ninety-third. Thornwater on her route, and the mule at the gate, and a woman who had said *come find me* at a walk that did not look back. / \"The ninth day,\" Karis said. \"The day she said.\"' Written: '*Thornwater, ninety-third. The healer.*' Log: 'Two days east, through Thornwater, on the day the healer said.' Oryn is not on the page and is not named (grep 'Oryn': 0); she is 'the healer' / 'she'."
    },
    {
      "obligation": "payoff: Chapter 4's rumor becomes a location and a contract.",
      "status": "MET",
      "evidence": "The Ch4 page physically returned to: 'had come out of it with a single thin page from the far end of a bundle and laid it on the plank beside the map. He knew the page. He had watched it go in. The letters were twice their size and leaned two ways, and there were three sentences on it, and under two words of the second sentence there were two lines.' Then, with her finger at the bend on the map: '\"A location,\" she said. It was the first thing she had said since the plank. \"And a contract.\"' Her council speech names the arc: 'I've had that under a slip since Thornwater, underlined, filed as a source and a bad one ... Today a man who has kept the only checkable record in this country for thirty years said the same two sentences, with a name in them, and a road, and a day-count, and a rule, and then a broker's slip put a price on it.'"
    },
    {
      "obligation": "payoff: Chapter 5's freedom (paid to catalogue) ends on the first job Cael takes for a reason other than pay.",
      "status": "MET",
      "evidence": "The freedom at full height: two hold contracts with their names on them, waiting ('They'll wait a fortnight or they'll take Teague'), and the crew chooses the posting nobody will take. Cael's stated reason is pay ('\"It pays,\" Cael said.' / 'I say it pays.'); the real one is the last line of the log: 'For twelve weeks nothing out here has read me. I'd like to see what a place that reads nothing does with that.' — and the council's shape makes the other reason legible ('I would very much rather do that with the four of you than without'; Seln: 'I'd rather walk into this one on her account than any of theirs'). The reason is not asserted by narration."
    },
    {
      "obligation": "prohibited_outcomes honored: nobody goes to the site; no measuring, theory, or 'the Quieting'; no fused stone, stakes, or ruin beyond Pike's folklore; no Oryn on the page; no Teague dialogue; no fight; no fragment use; no letters; no Vastin; no new named people or places beyond 'the Fallow road' / 'the Fallow Ring'; no dialogue or image ending; no modern idiom; tic caps; no metadata; no 'at the pitch'.",
      "status": "MET",
      "evidence": "The chapter never leaves Lowmarch. Grep counts: 'Quieting' 0; 'Oryn' 0; 'Vastin' 0; 'Architect' 0; 'at the pitch' / 'at that pitch' 0; all §9 capped phrases 0; 'okay/literally/basically/gonna' 0; 'heard about it later' family 0; 'End of Chapter' 0. Teague is referred to (by Pike and in Cael's catalogue) and speaks no line; his crew is off-page on a hold fence. No declaration by anyone ('Nine confirmed. One anomaly. No deployment since the ford.'). No letters, no ferry mail. The only new proper nouns are 'the Fallow road' (from the posting) and 'the Fallow Ring' (Pike's). Unnamed by design: the landing broker, the hide-woman, the axe-head hold, the smith. Pike's one sentence on the Ring's referent ('Stones, some of them standing, in a ring') describes no floor, material, stake, or size. Ends on a log entry. Single-word paragraphs: 2 ('*Recovery.*', 'Tenth.') — at the cap, not over."
    }
  ],
  "inventions": [
    "Timeline: six days from Oxhollow (left the eighty-fifth), Lowmarch reached on the NINETIETH day past the Line at midday; Teague's crew a day ahead on the same road, reached Lowmarch on the eighty-ninth, read the posting twice, and left at dawn on the ninetieth on a hold contract (the axe-head hold's long fence, HOLD, Teague) — off-page for the whole chapter.",
    "Lowmarch in late summer: forty tents and carts where there had been thirty-one; grass gone to seed; fewer fires; a hide-woman with a hand-cart under the ash; the smith working; the ferry loading on the near bank.",
    "Lira's replacement right boot: a carter's, bought at Oxhollow's gate for two marks on the eighty-fifth, a size wrong and packed with the healer's linen (marks 116 → 114). Brom's arm in full use from the eighth morning after the mend (the eighty-eighth). Cael's calf count gone on the flat ('past twenty on the flat it was a leg'), still 'nine' on the shelf's climb.",
    "The board on the ninetieth: seventeen slips — six escorts, two fence-lines, a wash recovery, a bog load, four hold contracts (two HOLD Teague; two HOLD with the five names: an east-road hold whose brand is an axe-head, a longer fence-line, forty marks, posted a week; a north-road walk ahead of a hold's autumn carts, fifty and fed, posted four days), plus the recovery posting. Pike's account: 'Holds came to the ferry. Asked who. I said you.' — asked 'by the names, because you've not given me a crew's name and I'll not make one up.' The holds will wait a fortnight or take Teague.",
    "The traverse slip witnessed by Oxhollow's ford-keeper, who wrote 'round' across the brand. Pike's ledger line and the charged cart ('less six, the cart'; 'Sixty-four's what the job was worth'). Cael's 'Fair.' Seven completed lines on their page.",
    "The recovery posting as object: Lowmarch landing broker's seal (a hook and a bar) pressed in wax; clerk's hand; price a hundred marks written twice; site reference 'east of Thornwater; the second day; where the road leaves its line at the rise and comes back to it'; posted a fortnight; a dust-curve from the stone and soft corners from many hands; every crew on the wall has read it and put it back. The broker is unnamed; nothing is said about who paid him.",
    "Pike's stillness rendered as the pen stopping mid-motion, the shoulder settling, the eyes stopping at the site and not going on to the price; Cael counting to nine. Pike's framing lines around the mandated folklore: 'I'll give you the rest, because you're going to read it off that slip whether I do or don't, and I'd sooner it came from me than from the ferry.' / 'That's what a carter knows. That's what I know. There's not a man on the ferry knows a word more.' / the Ring's referent at Brom's prompt: 'Stones, some of them standing, in a ring. You see it off the road and you keep walking.'",
    "The smith exchange (paid six; 'that was what everyone said who had put one in a gorge'); marks 114 → 108.",
    "Karis retrieving the Ch4 page from the middle box, her finger on Pike's map at the second-day bend, 'A location. And a contract.', and her refusal to say more until the table: 'I'd like the next thing I say about it to be a sentence I've thought about.' Her copying the Fallow road (days and bend) onto the back of her own sheet in the last light. Her notebook lines: '*The Fallow Ring. Fallow road, east of Thornwater, second day. Pike: the sigil stops at a line. The line: 'your Arbiter tells you.'*' and '*Thornwater, ninety-third. The healer.*'",
    "Lira at the roof's edge: 'Two hundred times. He counted.' / 'So do you. I've never once heard you say never.' / 'Seln's not moved since the man said dogs.'",
    "The inn: the hide-woman's look as a third-party verdict; the best table with chairs pushed in and no jug; the wall rewritten with the five names at the ninth line (tenth position), 'Teague's nine up'; Pike's unasked line about Teague's refusal; Brom pouring the last of the jug into Karis's cup.",
    "Council lines beyond the mandated ones, in established voices: Karis's four-sentence case and 'I'll not say the last part twice'; Brom's 'A survey kit's a cart's worth ... That's not the reason. That's what it is.'; Lira's 'It's a hundred because it's been under a stone a fortnight' and 'You've got three ribs and a calf; say that before he does.'; Seln's form-language argument ('Nobody out here says site ... That's a form. I've filled that form in.') and 'That's not a reason not to go ... I'd rather walk into this one on her account than any of theirs.'",
    "Cael's decision at Pike's table ('The recovery. The Fallow road. We'll mark it.') and Pike's procedure: mark it at the plank in the morning in front of the meadow; HOLD with the five names because 'It's the only crew's name you've got'; 'Whoever marks it at the other end marks it. That's the board.'",
    "The route reckoning at the table: Thornwater's east gate; two days Lowmarch to the steading, two on to the rise — 'Four.' Leave the ninety-first; Thornwater the ninety-third."
  ],
  ...
  "deviations": [
    "Week count in the mandated closing log entry: the packet's text reads 'Eight weeks. Seven contracts.' and 'For eight weeks nothing out here has read me.' The draft reads 'Twelve weeks' in both places. Reason: the running state (After Chapter 7) fixes Oxhollow at the EIGHTY-FOURTH day past the Line and Thornwater 'in nine days' at the ninety-third; Lowmarch is therefore reached no earlier than the ninetieth day, which is twelve weeks and six days past the Line — the log's own dateline convention (Ch4 'Sixtieth day', Ch7 'Eighty-fourth day') and Ch1's 'Six weeks' at day 46 make 'eight weeks' a visible continuity contradiction on the same page as 'Ninetieth day'. 'Seven contracts' is consistent with the state (four in Ch1, the ford, Seln's well, the traverse) and is kept. The architecture's 'eight weeks' derives from its own compressed timeline, which the drafted state has already superseded with accepted deviations (Ch1's four days at Thornwater; the traverse's length). Proposed decision: accept 'Twelve weeks' (rounded down per the Ch1 precedent), or, if the lead prefers the arc wording, revert the single word in both places — no other text changes.",
    "Length: first full draft came out at 5,576 words (over the 5,290 ceiling); a compression pass of 37 targeted cuts (redundant clauses and doubled beats, no scene or obligation removed) brought it to 5,189, inside the +15% tolerance. Reported because the instruction was to draft to length rather than overshoot and trim.",
    "'The site is two days east' (council point) is rendered as two days east of THORNWATER along the Fallow road (four days from Lowmarch), because Thornwater is itself two days from Lowmarch in every drafted chapter (Ch3, Ch4, Ch5) and the architecture's Ch13 puts Thornwater 'two days back along the void road' from the Ring; the mandated log line 'Two days east, through Thornwater, on the day the healer said' is kept verbatim and reads consistently with that.",
    "Pike gives one descriptive sentence for the referent of the name 'Ring' at Brom's one-word prompt ('Stones, some of them standing, in a ring. You see it off the road and you keep walking.'). This is offered as the descriptive-site-name plant made intelligible aloud; it adds no floor, material, size, stake, or measurement. If the editor reads it as beyond Pike's folklore, the two sentences can be cut without touching anything else.",
    "Teague's crew is placed off-page (left Lowmarch at dawn on the ninetieth on a hold fence) rather than seated silently at the best table, so that Pike's unasked line about their refusal is the only Teague beat and no reading of 'Teague does not appear in conversation' is strained; the packet's HOLD-Teague board presence is preserved through the slips.",
    "Em dashes: 34 in 5,189 words, above the 22–25 range of Chapters 4–7; not a capped tic, noted for the line-edit pass.",
    "Single-word paragraphs: 2 ('*Recovery.*' and 'Tenth.'), at the charter's cap of 2 per chapter, not over."
  ],
  "blockers": []
}
