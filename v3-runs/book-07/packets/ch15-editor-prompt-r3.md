...

{
  ...
  "purpose": "REPAIR RUN (r3). One replacement from drafts/ch15-r2.md: the weathering sentence's 'oldest dressed stone in Valdris' → 'oldest dressed stone I have' (ED-B7CH15-002 fully repaired). No other passage changes.",
  "scene_shape": {
  ...
  "output": {
    ...
    "report_path": "v3-runs/book-07/reports/ch15-author-r3.json",
    "editor_report_path": "v3-runs/book-07/reports/ch15-editor-r3.json",
    "verifier_report_path": "v3-runs/book-07/reports/ch15-verifier-r3.json",
    "target_words": 4600,
...
# AUTHOR REPORT — v3-runs/book-07/reports/ch15-author-r3.json

{
  ...
  "deviations": [
    "r3 differs from r2 in one sentence; r2 preserved as drafts/ch15-r2.md."
  ],
  "blockers": []
}
