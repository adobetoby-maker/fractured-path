...

{
  ...
  "context_files": [
    ...
    },
    {
      ...
      "path": "v3-runs/book-07/drafts/ch05-r1.md",
      "required": true
    }
  ],
  "verified_findings": [
    {
      "id": "ED-B7CH05-001",
      "severity": "HIGH",
      "gate": "obligations.prohibited_outcomes / VOICE_CHARTER §9",
      "evidence": "r1 lines 25, 59, 107, 115: 'at the pitch' ×4 (book total 14).",
      "consequence": "Attribution scaffolds converge across Pike, Seln, Karis on an audible house tic.",
      "repair_target": "Vary all four; no replacement scaffold repeated."
    }
  ],
  "exceptions": [],
  "output": {
    "draft_path": "v3-runs/book-07/drafts/ch05.md",
    "report_path": "v3-runs/book-07/reports/ch05-author-r2.json",
    "editor_report_path": "v3-runs/book-07/reports/ch05-editor-r2.json",
    "verifier_report_path": "v3-runs/book-07/reports/ch05-verifier-r2.json",
    "target_words": 4600,
...
# CONTEXT — THE DRAFT UNDER REPAIR (r1) (v3-runs/book-07/drafts/ch05-r1.md)
...
# AUTHOR REPORT — v3-runs/book-07/reports/ch05-author-r2.json

{
  ...
  "obligations": [
    {
      "obligation": "ED-B7CH05-001 repaired",
      "status": "MET",
      "evidence": "Pike entered it as a price gets entered, flat, with the five names under it, and said the things he said. | sloping toward the outer edge as a roof slopes \u2014 not steep, but not flat, | \"Shale-backs,\" said Seln, from ahead, low, in the road's own quiet. | Karis said, without heat, as one asks for a thing already paid for: \"I want a day.\""
    }
  ],
  "inventions": [],
  "state_change_proposals": [],
  "deviations": [
    "Line edit applied directly by the orchestrator (four clauses)."
  ],
  "blockers": []
}
