...

{
  ...
  "purpose": "REPAIR RUN (r4). The r3 replacement did not persist on disk (the r3 file hashed identical to r2 at review); the same single replacement is re-applied and verified by hash before launch: 'oldest dressed stone in Valdris' → 'oldest dressed stone I have' in the weathering sentence. No other passage changes.",
  "scene_shape": {
  ...
  "context_files": [
    ...
    {
      "kind": "reference",
      "label": "THE DRAFT UNDER REPAIR (r2)",
      "path": "v3-runs/book-07/drafts/ch15-r2.md",
      "required": true
    }
  ],
  "verified_findings": [
    ...
    },
    {
      ...
      "severity": "HIGH",
      "gate": "voice.new_canon_and_reveal_discipline",
      "evidence": "r2 weathering sentence: 'the oldest dressed stone in Valdris'.",
      "consequence": "Unapproved world-canon superlative.",
      "repair_target": "Personal ruler only: 'the oldest dressed stone I have'."
    }
  ],
  "exceptions": [],
  "output": {
    "draft_path": "v3-runs/book-07/drafts/ch15.md",
    "report_path": "v3-runs/book-07/reports/ch15-author-r4.json",
    "editor_report_path": "v3-runs/book-07/reports/ch15-editor-r4.json",
    "verifier_report_path": "v3-runs/book-07/reports/ch15-verifier-r4.json",
    "target_words": 4600,
...
# CONTEXT — THE DRAFT UNDER REPAIR (r2) (v3-runs/book-07/drafts/ch15-r2.md)
...
"Dressing, first. Every chip on this table has a face with a tool's stroke in it — the width of the stroke, the angle, the chatter where the edge caught. The floor has no face. There isn't a stroke on it. There isn't a *join* on it — Cael put his hands on the middle and the read went to the lip without finding one, and I've his word and the cord's, and I lay my cheek on it and sighted the whole way across and there was no light under the string. No stroke, no join, no laid edge. I've no word for a stone with none of the three, and I'm not going to invent one." She moved her hand to the carved band. "Weathering, second. The founding stone's dressed face has four hundred years of edge on it — I know what four hundred years does to a dressed edge, because I've had that stone in my hand for two years and measured it against everything else. The carved lines on the uprights are cut a fingernail deep, and their edges are rounder than the founding stone's. Not a little. A great deal. Whatever cut them was cut long enough ago that the weather's had more time on it than it's had on the oldest dressed stone I have, and I can't tell you how much more, because my ruler stops at the founding stone and the lines are past the end of it."
...
# AUTHOR REPORT — v3-runs/book-07/reports/ch15-author-r4.json

{
  ...
  "obligations": [
    ...
    {
      "obligation": "ED-B7CH15-R2-001 (HIGH): remove the Valdris-wide superlative from the weathering sentence.",
      "status": "MET",
      "evidence": "'the weather's had more time on it than it's had on the oldest dressed stone I have, and I can't tell you how much more, because my ruler stops at the founding stone and the lines are past the end of it.' grep 'in Valdris' → 0."
    }
  ],
  "inventions": [],
  ...
  "deviations": [
    "The r3 replacement did not persist on disk; re-applied for r4 and verified (grep 'oldest dressed stone I have,' → 1; 'in Valdris' → 1, the legitimate 'every practitioner in Valdris'). r2 preserved as drafts/ch15-r2.md."
  ],
  "blockers": []
}
