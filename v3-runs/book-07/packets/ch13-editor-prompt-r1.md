...

{
  ...
  "revisions": {
    ...
    "arc": "arc-b7-v2 (books/book-07-void-roads/CHAPTER_ARCHITECTURE.md, editor PASS r4, Chapter 13 card)",
    "state": "state-b7-post-ch12 (v3-runs/book-07/STATE_RUNNING.md + base snapshot)",
  ...
  "pov": {
    ...
    "knowledge_boundary": [
      "Cael is eighteen; NINE fragments + anomaly at open; TEN at close (Tide-adjacent acquired in this chapter). Party SIX at Thornwater, two days back along the void road; a steading back room with a door that shuts.",
      "Injuries: Lira's arm saved/slung/load-restricted (unchanged); Karis's voice returning hoarse; Brom's hand mended; Cael's ribs healed on their own and his calf closed on its own over the two days' walk (Oryn cannot mend him — the Tide rule) — for the first time in Oryn's presence he is STILL and WHOLE ENOUGH, which is the deep reading's condition (taught Ch7); if the calf is not fully closed, she says so and runs the long reading anyway because the long reading is not a mending.",
      "The deep reading: both hands, her whole current through the whole architecture, minutes (about twenty), patient still and uninjured, at a mending's cost. Its result on Cael is STILL A FAILURE TO READ, honestly staged — she perceives movement, more than one, cannot count them, cannot find banks, finds nothing shaped like the thing she reads. She does NOT say he has no banks / needs no container / is made of anything; she says she cannot FIND them. Her lines are fixed in must_include.",
      "The covenant (B3/B4/B6 machinery): sustained close engagement (twenty minutes of her current through him at contact); genuine stakes (three days off a full-suite deployment, frameworks resettling; the only healer in a country spending a mending's reserve on a patient who may return nothing); earnest use ON him (Karis: 'Ephram fought you in earnest and the notice said non-hostile. This is earnest and it isn't a fight at all. The model doesn't say the engagement has to be a fight. It says it has to be real.'); the cost written in advance in the log: she cannot consent to what she cannot know about; he will tell her afterward in full. Oryn learns the mechanism in Chapter 14, NOT here — this chapter ends on 'I need to tell you what I am' and her reply.",
      "The notice text is fixed (see must_include). Two firsts counted on the page: the first 'clinical' engagement field; the first fragment that does nothing in a fight. He counts a third privately and does not write it: ten, the tenth is Tide, the anomaly has been Tide-adjacent for five years.",
      "Nobody says 'Quieting'; nobody theorizes."
    ]
  },
  "purpose": "The acquisition chapter — the series' Chapter 13 tradition honored a fifth time, and for the first time the engagement is clinical: a healer's hands on a patient at real stakes. The ethics argued on the page before the act (the covenant, the cost written in advance), the deep reading rendered as sensation in Cael's POV with Oryn's running commentary an honest failure to read, the interior action completing inside it because the reading has finally been long, the tenth notice in full with its new engagement field, and the chapter ending on her ordering him to lie still while he tells her what he is.",
  "scene_shape": {
    "opening_state": "Thornwater. Oryn has said she will run the long reading because he is, for the first time in her presence, still and whole. Before it, Cael takes the covenant to the circle without her.",
    "pov_goal": "Do the honest thing twice: write the cost before the act, and not stop her when the architecture reaches.",
    "opposition": "His own line (drawn in B4 Ch9, stood on since): the source cannot consent; the person doing this came to help; and the reading itself, twenty minutes of being touched from outside for the first time.",
    "turn": "The circle's council (Lira, Brom, Karis, Seln): the conditions named; Karis's sentence on 'real' versus 'fight'; the log entry written in advance ('Write it before, not after. That's the whole difference between me and the system.'). Then the back room, morning light: her hands on sternum and spine, her current run INTO him as a study, slow, for minutes — a cold that isn't cold moving through architecture never touched from outside, going where it is put — and her commentary: she feels movement, more than one, can't count them, can't find where one stops, can't find banks, 'It isn't that you're broken. It's that I can't find anything shaped like the thing I read.' ... 'Eleven years. I've never had my hands in something and not known what it was.'",
    "choice": "Inside the deep reading — sustained, at stakes, earnest, complete for the first time because it has never before been LONG — the interior action completes, and Cael feels it and does NOT stop her, because stopping her would be the lie. He reaches. Directed. Open-eyed.",
    "outcome": "The notice arrives with her hands still on him (text fixed). Two firsts counted on the page; a third counted privately and unwritten. Oryn takes her hands off, looks at them: 'Something just changed. In you. While I was in there.' 'Yes.' 'Did I do that?' 'No. I did. I need to tell you what I am.'",
    "closing_state": "The chapter ENDS ON HER LINE (dialogue; the previous chapter ended on an image): 'Then lie still while you do it. You've been still for twenty minutes. I want to see if you can manage twenty-one.'"
  },
  "obligations": {
    "must_include": [
      "The circle's covenant council WITHOUT Oryn present: the three conditions named in Cael's words; Karis's 'real, not a fight' sentence verbatim; the cost written in the log in advance, including that she cannot consent to what she cannot know about and that he will tell her afterward in full; the line 'Write it before, not after. That's the whole difference between me and the system.'",
      "The deep reading rendered as sensation in Cael's POV over minutes, with the difference from the three surface readings made explicit (not looking for injury; whole current through the whole of him; slow).",
      "Oryn's running commentary as an honest failure to read, with these lines verbatim: 'I can feel that there's movement. More than one. I can't count them — I can't find where one stops. There's no channel. Everyone has a channel; I feel the banks and I know the Path. I can't find the banks in you. I've looked for twenty minutes. It isn't that you're broken. It's that I can't find anything shaped like the thing I read.' and 'Eleven years. I've never had my hands in something and not known what it was.' She makes NO claim about what he is made of.",
      "The interior action completing inside the reading; Cael not stopping her; 'He reaches. Directed. Open-eyed.' in the series' register.",
      "The notice, shown in full, in a fenced block or the established format, text exactly: FRAGMENT ACQUIRED / [unnamed] — Tide-adjacent. Duration: sustained. Integration: partial. / Tier equivalent: Iron. / Note: current-perception component; architecture-reading component. Self and contact. / Contact range. / Acquisition: directed. Engagement: clinical — non-hostile. (line breaks as in the established notices).",
      "Two firsts counted on the page (clinical engagement field; a fragment that does nothing in a fight); the third counted and NOT written (ten; the tenth is Tide; the anomaly has been Tide-adjacent for five years).",
      "The closing exchange verbatim ending on Oryn's 'twenty-one' line.",
      "Manuscript format: H1 '# Chapter 13 — The Reading', prose only, '---' breaks, ends on the last line of prose."
    ],
    "plants": [
      "The tenth fragment: current-perception, architecture-reading, self and contact (Ch14 self-reading; Ch16 the outward temptation; Ch22).",
      "The anomaly's convergence begins (Ch14).",
      "Oryn's consent-after-the-fact with a condition (Ch14)."
    ],
    "payoffs": [
      "Ch7's two-readings rule (the long one finally run).",
      "The B4 Ch9 covenant and B6 Ch20's 'non-hostile' precedent, extended by argument to 'clinical'."
    ],
    "prohibited_outcomes": [
      "Oryn does not learn the mechanism in this chapter; the disclosure is Chapter 14.",
      "No claim by anyone that Cael lacks banks/containers, is made of Tide, or predates anything — only that she cannot find/read.",
      "No fight; no other fragment use; no destabilization staged yet (Ch14); no theory of the Quiet.",
      "No Teague, letters, Vastin; no quiet ground beat beyond memory.",
  ...
  "invention_budget": {
    "allowed": [
      "Thornwater's back room, morning light, the door, the table; the circle's council texture; Oryn's hands and clinical manner; the reading as cold-that-isn't-cold and shape-without-explanation; Cael's interior during the reach (brief).",
      "Dialogue in established voices beyond the mandated lines (short).",
      "Cael's log entry in advance in his plain register."
    ],
    "approval_required": [
      "Any new named entity; any Tide mechanic beyond the taught two readings; any change to the notice text; any ontological claim."
    ],
    "forbidden": [
      "Disclosure to Oryn in this chapter; ontology; fights; other fragment use; a log or image ending; metadata."
    ]
  },
  "context_files": [
    {
    ...
    {
      "kind": "previous_scene",
      "label": "Chapter 12 as drafted — the immediate seam (the camp, the stake, Oryn at the line)",
      "path": "v3-runs/book-07/drafts/ch12.md",
      "required": true
    },
    {
      "kind": "reference",
  ...
  "exceptions": [],
  "output": {
    "draft_path": "v3-runs/book-07/drafts/ch13.md",
    "report_path": "v3-runs/book-07/reports/ch13-author-r1.json",
    "editor_report_path": "v3-runs/book-07/reports/ch13-editor-r1.json",
    "verifier_report_path": "v3-runs/book-07/reports/ch13-verifier-r1.json",
    "target_words": 4600,
...
# CONTEXT — Chapter 12 as drafted — the immediate seam (the camp, the stake, Oryn at the line) (v3-runs/book-07/drafts/ch12.md)

# Chapter 12 — What Seln Remembers

The light came onto the floor first, as it had the morning before, and he watched it come from the rut.

Positions, catalogued at first grey, because he had been awake the whole of the dark and a count was what he had. Lira on her back on the road where Oryn had left her, the left arm bound across her chest from the shoulder, the right hand flat on the rut beside her, the taped foot turned out; she had not moved in the night. Oryn a stride beyond her, on her side now, the leather roll under her head and her hands tucked into the carter's coat. Karis against the middle box with the notebook shut on her knees, asleep sitting, charcoal still on her fingers and the dark going up both sides of her throat into the collar. Brom on the box with the crossbow across his thighs and the right hand wrapped in Oryn's linen, awake, looking not at the ring but at the scrub. Seln at the stone, standing, with his back to the camp, where he had stood since full dark, and the locked case on its strap across that back, where it rode on every road — the cache, shut, not once in two days off him.

The mule, hipshot, at the road's edge. The lantern out.

One dead hound in the rut against the stone, its forefeet across the line and the rest of it inside, the bolt standing out of its chest. The other was on the floor's west lip, two hundred meters back, and nobody was going to go and get that one.

The floor went white. The eleven uprights stood up out of the grey on it, shortest to tallest, and he counted them, because he had counted them every morning, and it was eleven.

He had not slept. He had written instead, twice.

---

The first entry he had written in the rut by the lantern's edge before Lira turned her head. The second he had written in the dark, by nothing, two hours after Oryn took her hands off the arm and lay down on the road — the lantern put out to save the oil, Seln gone to the stone, the camp settled into the breathing of five people who had all been hurt in the same hour. He could not have slept with it unwritten, and had not tried.

He read it now, in the first light, to see whether it was still true.

*Ninety-sixth day, later. The stone, outside the line. Lantern out.*

*I'm not keeping it secret. I'm keeping it unfiled. There's a difference. Lira said later. Later is when I have a sentence. The answer might be: because whatever I am isn't a Path. I've known that since I was fourteen. Out there it was a flag. In there it's the only thing that works. I don't have a word for what that makes me, and I'm not going to invent one at a camp with Lira's arm two hours old.*

*Unfiled. Not filed wrong. Not filed under a word I invented so the page would have one. The registry filed me under a word the day I was fourteen, and I've spent four years being the case the word didn't fit. I'm not doing it to myself on a road in the dark.*

It was still true. He put a line under *unfiled*, because that was the word, and closed the book on the pencil.

---

Oryn sat up when the light reached the road, and looked at her hands, and then at the camp, in that order.

"Water," she said, to Brom, and Brom got up off the box with the bow in his good hand and went to the mule. "Not the skin. A pan. And the lantern's oil, if there's any; I want it for the hand."

She did the arithmetic before she touched anyone, aloud, because that was how she kept it. Cael sat up in the rut to hear it, and his own bill came up with him: the ribs stopping his breath at the tape as he turned; the right calf gone stiff and hot inside the stuck cloth; the nine gone to nothing with a hollow where each had rung, faint now. Nothing wanted anything, except Anchor, which since the Ostrand road had wanted to fix points in doorways and now wanted the survey stake sixty meters south along the line. He let it want.

"I can't mend what I can't read. That's the rule. I didn't make it, and I'm not going to argue with it on a road with nothing left to argue with." She had the linen out already. "So it gets what the rest of the country gets when I'm eleven days off: washed, bound, and left alone. It'll close on its own. It'll close faster than it should. It always has, hasn't it?"

"Yes."

"Then it's a finding and not an answer, and I've got no third thing to call it." She bound the calf tight from the ankle up, as she had bound it on the walk down from the mountain, and tied it off, and put her hand flat on the binding for a moment, and got up.

She did not say *That's three*. She went along the line, south, into the scrub, slowly, with a hand on the mule's flank as she passed it and nothing in her hands after, and he understood where she was going only when she got there.

---

The stake stood a hand's height out of the ground, sixty meters south of the road along the line, where Karis's cord had found it with the bush grown round it and Brom's marker-stone beside it. Oryn sat down in front of it with her back to the iron and her knees up and the carter's coat pulled round, and looked west, away from the ring, at the country the road had come from.

He went after her, because the calf would take the sixty meters and he wanted to know what it counted. Eleven, on the flat, favoured. He sat down on the marker-stone, a stride off, and said nothing, and she let him.

"Three in two days," Oryn said, after a while, to the country.

He waited.

"The arm. That was last night, and it was one, and it was the size of two. The throat. The hand. Three mendings in two days." She turned her hands over on her knees and looked at them, and let them lie. "That's a route. Near enough, that's what I carry between a hold and the next one, for the people who feed me and shoe the mule. Three serious hurts and a road's worth of small ones. And I've spent it on a road two days from the nearest roof, on a crew that's not on my circuit, sitting against a piece of iron somebody drove where they'd measured to."

"Yes," Cael said.

"The route's eleven days north of here." She said it as she had said *Twelve, in two days* at Thornwater's gate: a count, not a complaint. "It was nine when I sat down at your fire at the bend, and it was a day I owed. Now it's a day and two nights and three mendings and a mule that's eaten what a mule eats in three days. Every day I sit here the route doesn't get shorter. It gets longer at the far end, where I can't see it."

She put her head back against the stake. The struck-flat top of it stood a finger over her hair.

"I can't move Lira today. I could move her tomorrow, if she walks the way I tell her and not the way she walks. That's the finding. The rest is arithmetic, and I keep it aloud because a thing I don't say I start to think I've got, and I haven't." She shut her eyes. "You can sit. Don't talk to me."

He sat. Anchor wanted the iron behind her head, a fixed point at the perimeter's exact edge, and he did not give it one.

---

Seln came along the line from the stone.

He had not left it since full dark. At first light he had read the ground from where he stood — the line's outside, the scrub either side of the rut, as far as the stone let him see and no further — and now he came along the line toward the stake with his knife put away and his eyes on the ground until the ground brought him to it. He stopped. He looked at Oryn against it, and at the flat top of it standing a finger over her hair, and at the number punched under the registry's mark, thirty-one.

Cael had never once learned Seln's face, and did not learn it now; but he saw something happen to it. It was not a change. It was the absence of one — the face going still in a way it had not been still a stride before, the stillness of a man at a shelf with his hand halfway to a book he had not remembered owning.

"Karis's map," Seln said, to the stake, with no change at all in the voice. "The carter's. Not the sheet."

Cael got up off the marker-stone and went and got it.

---

Karis came with it, because Karis went where the map went — along the line with the notebook under her arm and the charcoal in her fist and no voice in the mended throat — and Brom came behind her with the box, because the box was where the map lived. Lira, who had been told not to move, stayed on the road and turned her head to watch. That was the whole of the camp except the mule, sixty meters south of a stone in a rut, round a piece of iron with a healer's back against it.

Seln laid the carter's map on the box's lid.

Karis's whole copy of Pike's plank, no seal, the roads solid, the Fallow road leaving Thornwater's east gate and running two days and bending, at the second day's rise, round a circle the carter had drawn as a circle, blank, and coming back to its line beyond it. Two other roads on the sheet did the same round two other blanks.

Seln put his palm over the bend.

"Charcoal."

Karis gave it to him. He did not look at what was under his hand. He looked at Thornwater's fork and the road's straight east of it before the rise, and he put the charcoal to the map beyond his own thumb and drew — not quickly; Seln did nothing quickly — a road in a hand Cael had seen on the corner of every registry sheet since he was fourteen: dashed, unlabeled, going east and stopping in nothing. Then he lifted the palm and drew a circle over the place it had been. From memory, the charcoal going round once and closing.

It lay on the carter's circle. A finger's width off at the north, where the carter's hand had wobbled, and nowhere else.

"That's theirs," Seln said. "Not the sheet you carry; that's the printed one, and it stops at the Line because the standard wants a waystation at both ends of a road. The ones we carried past the Line were drawn the same way — dashed, nothing at the end of them — and they had that in them." He put the charcoal's end on the circle. "Blanks. Not dashes. A circle of nothing, no name, no mark, no line through it. Three postings, the same maps on all three, the same holes in them, at the same spacing as his." He moved the charcoal's end to the carter's second circle, and the third. "Here. Here. More, further than his goes. I never once asked what they were. You don't ask what a hole is."

Karis was writing before he stopped, and turned the book: *Who drew them.*

"They surveyed it," Seln said. "Five years ago by the stake, maybe six. They paced the circles and stamped the stakes and drew the maps with holes where the circles are. That's not ignorance. Ignorance doesn't stamp iron."

Nobody said anything. Oryn had opened her eyes and was looking at the map upside down, with the iron against the back of her head.

Seln straightened up off the box.

"The Compact knows what quiet ground does," he said. It was the voice he had used over Pike's plank with a finger on the Line, the voice for an inventory; it had no more in it than that. "And it's filed somewhere we can't reach."

He did not say it twice. He put the charcoal down on the map, and it rolled a little and stopped against the carter's line.

Karis wrote one word and turned the book, and it was *Where*, underlined.

Seln read it, and gave it back.

"No," he said. Not a refusal. A finding, in a register Cael knew from a table in Ostrand: a professional saying the extent of what he had. "I carried the maps. I never saw the file. I'm not going to draw you one."

She looked at him a long moment with her hand on the pencil, and then wrote *Entered as said* in the margin, and nothing else, and Cael watched her not write it, and knew what it cost her, because he had a page in his own book with a word on it he had not let himself put a verb after.

---

"The contract," Seln said.

Cael had it. It had ridden in the satchel against the leather book since the ninetieth day, thin broker's paper, the hook-and-bar seal in dark wax, and he unfolded it on the box beside the map. Seln did not pick it up. He read it where it lay, the whole of it, though it was four lines.

*Recovery. Surveyor's instruments abandoned at a site on the Fallow road. East of Thornwater; the second day; where the road leaves its line at the rise and comes back to it. One hundred marks (one hundred).*

"Written inside," Seln said. "Registry form. *Abandoned at a site.* A carter would say *left at the Ring*. This says *site*, because inside, a place with a stake in it is a site." He put one finger on the word. "For a kit that was never here. There's nothing inside that circle a person left except the stake, and the stake's where they measured to, not where they lost anything. The man who wrote this knew that. The man who wrote this drew the hole."

Karis had stopped writing. She was watching his finger.

"So it's not a recovery. It's a question. A hundred marks on a board, priced so nobody who knew the road would take it, and one crew on the wall that didn't know the road and needed the marks. Written from inside by someone who wanted to know which crew would go in." He straightened. "We just told them. The report goes west on the next ferry. It'll say we came out."

"Pike writes it," Cael said. "Posting, taking, witnessing, completion. He enters it, and the broker gets the copy, and the broker sends it where the marks came from."

"And it says: took the slip, went in, came out. Instruments not recovered. Crew of six." Seln looked at the map, and at the circle, and at no one. "That's the whole of what they asked. We've answered it."

Oryn, from the stake, without opening her eyes again: "Six is wrong. I'm a stop."

"They'll write six," Seln said.

Nobody said anything after that, and it was Brom who picked up the box.

---

The rest of the ninety-seventh day was the day it took a camp of six to be still, and he catalogued it because cataloguing was how the day went by.

The dead hound in the rut, dragged into the south scrub by Brom and Seln with a rope round its hind legs, the bolt cut out of it first and put back in the sleeve: five. The ration, said aloud by Seln because somebody had to say it: two days' bread for six at a day and a half's eating, the cheese finished, the dried meat meant for the walk back cut into sixths; two skins of water for six and a mule, which was the reason they would walk tomorrow and not the day after. Lira, eating with her right hand and putting the bread down to break it against her knee because she had no second hand to break it with, and not asking; and Brom breaking it for her the second time without being asked, and neither of them saying anything about that.

Her ankle, re-taped at noon. She could not do it one-handed and did not try; she held the foot up and looked at the ring while he did it, the boiled-linen strip going round in the pattern Oryn had shown them on the mountain, and when he tied it off she said, "Tighter than Oryn," and he said, "Yes," and that was all she said to him in the day. It was enough. *Later* held, on both sides, without anybody touching it.

Karis, on the middle box with the carter's map, copying Seln's circle into the notebook beside the stake's number, and writing under it three words he read upside down: *Blank. Stamped. Filed.* Then a line, then nothing, then the book shut on her knee and her hand flat on it for the rest of the afternoon, the throat going yellow at the edges of the dark, and no sound out of her at all.

Oryn, asleep against the stake in the sun until the sun went off it, and walking back along the line with a hand on the scrub as she came, and reading Lira's arm at the road — the count, the ten, the place found — and saying "Holding" to nobody, and lying down.

Seln at the stone, facing the scrub, with the case on him, for the whole of the light and then the whole of the dark.

Nobody asked him anything. Nobody asked Cael anything either. Five people had seen all nine, and not one of them turned to the sixth in the whole of the day and said the word *yours*. He watched them not do it, and did not file it as kindness, because it was not. It was a unit lying still in a cold camp with the one thing that could be done about anything done, and the one thing that could not be done left where it lay, where it would keep.

---

He wrote the second night's entry with the lantern lit for the length of it, because Oryn had said the oil would do for one more night if the night was short, and he made it short.

*Ninety-seventh day. The stone, outside the line. A hundred and eight in hand; nothing owed; nothing earned. Eighteen.*
...
*The contract, read again. Registry form under a broker's seal, for a kit that was never here, by someone who wanted to know which crew would go in. Seln: we just told them. The report goes west on the next ferry and it'll say we came out.*

*I'm not going to write what that means. I don't know what it means. I know a hundred marks sat on a board for a fortnight so the wrong crew would take it, and we were the wrong crew, and the answer's on a ferry in a month with my name on the slip.*

*Five people saw all nine. Nobody's asked. Not because nobody wants to. Because Lira said later, and this camp keeps its word. Still unfiled. Still no word for it. Tomorrow we walk to Thornwater, Lira the way Oryn says and not the way Lira walks. The healer said she'll read me when I'm still and whole. I'm neither. Two days.*

He put the lantern out.

---

He woke before the light, and lay in the rut with the book on his chest and his hand flat on the cover, and listened to the camp be asleep. Seln was not at the stone. Seln was on the road beyond the mule with his back against a pannier and his chin down, which Cael had never once seen, and filed.

Oryn was at the line.

She had made no sound getting there. She stood on the road side of the two-fist stone with the carter's coat on and her hands at her sides, looking at the ring, where the first grey was finding the tops of the uprights and had not yet found the floor — and she stood there for the time it took him to understand that she was not looking at the ring. She was looking at the stone.

Then she raised her hands.

"After, I tell her. All of it. The nine, the notices, the log, the covenant, what happened on her table, that I wrote this tonight and chose it. Whatever it costs. If she takes her hands off me for good, that's what it costs." He took the leather book out of the satchel and put it on his knee. "Before, not after. I'm writing it now. You can read it, the two of you who read it."

Karis wrote something short and did not turn the book. Lira got up, one-armed, off the sacks.

"Write it," she said. "I'll read it when it's dry."

---

He wrote it by the last of the woman's oil, with the loft asleep around him and Seln at the window still, and read it back once, and did not change a word, because a word changed after was a word written after.

*Ninety-ninth day. Thornwater, the loft. A hundred and eight in hand; nothing owed; nothing earned. Eighteen.*

*Written before. Tomorrow morning, the back room, the door shut. Oryn runs the long reading. Both hands, all of her, all of me, twenty minutes. I lie still. I'm still and whole for the first time in front of her; she said so in the yard, with the tape off.*

*The conditions, as I have them. Sustained: twenty minutes at contact is longer than any bout I've stood. Stakes: I'm three days off the Ring and the nine are still settling; she's three mendings down and her route's late at the far end and she's spending a fourth on a patient who's given her nothing four times. Earnest: she'll do the thing she does as well as she does it. Karis: the model says real, not fight. I don't know if the model's right. Nobody does. Tomorrow's the first time it could be tested and I'm the test.*

*The price. She doesn't know what I am. She can't consent to what she can't know about — not won't; can't. There's nothing I could put in front of her tonight that she could say yes or no to, because the thing doesn't have a name she's heard. I've decided not to tell her before. My reasons are good, and they're the reasons of somebody who wants it, and the real one is that I don't know what she'd say. Entered.*

*If it takes what she's using on me, it takes it from the one person on this road who came to help. I don't know what it costs a source. It's never shown. Tomorrow's the first time it could, and if it does, she pays, and I chose that for her.*

*After: I tell her. In full. On her table, before I'm off it. Whatever it costs me, including the route walking north without me on it.*

*I want it. Write that too.*

*Write it before, not after. That's the whole difference between me and the system.*

He put the pencil in the spine and the book under his hand and did not sleep well, and did not expect to.

---

The back room was the steading's, and then it was hers.

He catalogued it from the door, because she had said he would lie still and he wanted the room fixed before he did. Four paces by five. A window on the east wall, unshuttered, low, with the first sun coming through it flat along the floor and up the far wall to the height of his knee, and climbing. A table under the window, plank, long enough for a man, with a folded blanket on it where a head would go. A stool. A shelf with the woman's jars on it, pushed to one end to make room for the leather roll, open, its knife and its needles and its linen laid out in the order Oryn laid things out, which was the order she would want them. A door, plank, on a leather hinge, that shut.
...
Her hand came onto his sternum. Flat, the palm over the breastbone, the fingers spread toward the throat. The other came onto his back, between the shoulder blades, over the spine, so that the two hands had him between them like a thing held up to the light.
...
"Nothing," Oryn said. "As before. That's the short one. Now the long one, and I'll talk, because I talk, and you'll not answer."

The count went on past ten and did not stop, and the thing under her hands changed.

---

He had no word for it and did not try to make one on the table. He catalogued it instead, because that was the thing he could do lying still.

It came in under the front hand first. Not cold. The idea of cold, without the temperature — the shape of a stream's edge on a wrist, arriving inside the chest where there was no wrist and no stream. It went where it was put. That was the first thing he knew about it and the thing he kept knowing: it did not push, and it did not search, and it did not go where the surface reading had gone, down to the hurt. It went *along*. Her current, in him, following his architecture the way water follows a channel it has been given, slow, at the pace of a woman walking a floor she has never walked and means to walk the whole of.
...
The current went from Wind to Pressure, and along Pressure, and he understood that she could not have told him those names — that what she was feeling was two movements, adjacent, and the names were his — and he lay still and did not give them to her.
...
He reached. Directed. Open-eyed. Still.

It completed the way a knot completes when the last turn is drawn, and the drawing was hers: her current, going along whatever it had been along, and his architecture going along *it*, for the length of one of her breaths, learning the lay of the thing that was learning him.

The notice arrived while her hands were still on him. He read it on the wall, where the sun was, because that was where his eyes were:
...
Two firsts, counted on the page even now, lying still, because he was who he was.

The first notice whose engagement field said *clinical*. The grammar had bent again — it had bent for *directed* on a training-hall floor, for *non-hostile* at a flag — and it had bent now to describe a thing that was earnest and was help and had no other side to it at all. And the first fragment that did nothing in a fight. He read the note line twice to be sure. Perception. Reading. Self and contact. There was not a floor on the continent where it would move him a foot.

He counted a third and did not write it, and would not write it tonight, and knew as he did not write it that it was the one.

Ten. The tenth was Tide. The log had had a word in it for five years, from a session on a floor in Ardenmere with no Tide practitioner in the city, and the word was *Tide-adjacent*, and it had sat under three other words that said *patience*, and now there was a fragment with the same word on it, a real one, with a source, with hands. He did not know what that meant. He did not let himself put a verb after it. He filed it where it would keep.

Oryn took her hands off him.

He felt them go — the front one first, then the back — and felt the current go with them, out the way it had come, and felt, for the length of a breath, the *shape* of it going, from his side, as a thing with a lay to it, and then that was gone too and he was a man on a table in the sun.

She did not sit down. She stood beside the table with her hands in front of her, a little apart, palms up, and looked at them the way she had looked at them at the stone, and at the line, and on a road with the lantern out; and she went on looking at them for longer than she had looked at them anywhere.

"Something just changed," she said. "In you. While I was in there."

"Yes."

"Did I do that?"

He had written the answer the night before, so that he would give it and not a better one.

"No. I did." He did not get up. "I need to tell you what I am."

Oryn looked at her hands a moment longer, and then at him, and put the hands flat on the table's edge, one either side of his shoulder, and leaned on them.

"Then lie still while you do it. You've been still for twenty minutes. I want to see if you can manage twenty-one."
...
# AUTHOR REPORT — v3-runs/book-07/reports/ch13-author-r1.json

{
  ...
  "obligations": [
    {
      "obligation": "must_include: The circle's covenant council WITHOUT Oryn present: the three conditions named in Cael's words; Karis's 'real, not a fight' sentence verbatim; the cost written in the log in advance, including that she cannot consent to what she cannot know about and that he will tell her afterward in full; the line 'Write it before, not after. That's the whole difference between me and the system.'",
      "status": "MET",
      "evidence": "\"I need the circle,\" Cael said. \"Without her. It has to be without her, and I'll say why.\" (Oryn is in the house being fed; the five are in the loft) | \"Sustained close engagement. Not a count of ten with her hands on a hurt. Twenty minutes of a Tide practitioner's whole current inside my architecture, at contact, on purpose. That's the first.\" | \"Stakes. I'm three days off the Ring. ... And the person doing it is the only healer in a country, three mendings down in two days on a route that's late at the far end, spending a fourth on a patient who has given her nothing four times. That's real on both sides. That's the second.\" | \"The third's earnest use. Ephram's said *earnest*. Ephram's said *non-hostile*. This isn't against me. It's on me.\" | Karis, hoarse, verbatim: \"Ephram fought you in earnest and the notice said non-hostile. This is earnest and it isn't a fight at all.\" She stopped to get breath past the throat. \"The model doesn't say the engagement has to be a fight. It says it has to be real.\" | \"She can't consent to it. Not because I won't ask. Because there's nothing she could be asked. You can't say yes to a thing nobody's told you exists.\" | \"After, I tell her. All of it. The nine, the notices, the log, the covenant, what happened on her table, that I wrote this tonight and chose it. Whatever it costs.\" | log: *She can't consent to what she can't know about — not won't; can't.* ... *After: I tell her. In full. On her table, before I'm off it.* ... *Write it before, not after. That's the whole difference between me and the system.*"
    },
    {
      "obligation": "must_include: The deep reading rendered as sensation in Cael's POV over minutes, with the difference from the three surface readings made explicit (not looking for injury; whole current through the whole of him; slow).",
      "status": "MET",
      "evidence": "\"Count of ten,\" she said. \"You know this part.\" ... Ten, by her count. \"Nothing,\" Oryn said. \"As before. That's the short one. Now the long one, and I'll talk\" | The count went on past ten and did not stop, and the thing under her hands changed. | It came in under the front hand first. Not cold. The idea of cold, without the temperature — the shape of a stream's edge on a wrist, arriving inside the chest where there was no wrist and no stream. It went where it was put. ... it did not push, and it did not search, and it did not go where the surface reading had gone, down to the hurt. It went *along*. Her current, in him, following his architecture the way water follows a channel it has been given, slow, at the pace of a woman walking a floor she has never walked and means to walk the whole of. | Nothing in him had been touched from outside before. ... They had stood at the door. This came through it | the sun on the wall used as the clock: 'Ten minutes, near enough' ... 'Twenty, by the wall.' | the current traced along Wind, Pressure, Iron, Compression, Ember, Shadow, Storm, Anchor, Blade in turn, 'slow, learning the lay'"
    },
    {
      "obligation": "must_include: Oryn's running commentary as an honest failure to read, with the two mandated passages verbatim. She makes NO claim about what he is made of.",
      "status": "MET",
      "evidence": "\"I can feel that there's movement. More than one. I can't count them — I can't find where one stops. There's no channel. Everyone has a channel; I feel the banks and I know the Path. I can't find the banks in you. I've looked for twenty minutes. It isn't that you're broken. It's that I can't find anything shaped like the thing I read.\" | \"Eleven years. I've never had my hands in something and not known what it was.\" | earlier commentary is framed as inability throughout: \"I'll say what I feel and not what it means, because I don't know what it means and I'll not learn it by saying.\" / \"I can't find one here. I keep putting my hand where the bank ought to be and there's more water.\" / \"I can't tell you I've been the whole way round, because I can't find the edge of the way.\" | grep on the draft for 'made of', 'no banks', 'needs no', 'predates', 'before the', 'isn't a Path', 'not a Path' = 0 hits; the only 'no channel' phrasing is inside the mandated line."
    },
    {
      "obligation": "must_include: The interior action completing inside the reading; Cael not stopping her; 'He reaches. Directed. Open-eyed.' in the series' register.",
      "status": "MET",
      "evidence": "The conditions the model required were not a thing he reasoned toward. They arrived, as findings arrived, whole ... Sustained: ... Stakes: ... Earnest: ... And long. That was the one the previous nine had never had. | He felt it turn. | He could stop it. He knew the shape of stopping it as he knew the shape of a burst's landing lock: take the attention off her, put it on the wall, on the sun, on the count. Say her name. Say *take your hands off*. Any of those. | Stopping her would be the lie. He had written the price the night before so that the price would be paid and not avoided, and the price was this, and it was arriving with her hands on him. | He reached. Directed. Open-eyed. Still. | It completed the way a knot completes when the last turn is drawn, and the drawing was hers"
    },
    {
      "obligation": "must_include: The notice, shown in full, in a fenced block, text exactly as given (line breaks as in the established notices).",
      "status": "MET",
      "evidence": "Fenced block, six lines, diffed against the packet text with `diff` — EXACT: FRAGMENT ACQUIRED / [unnamed] — Tide-adjacent. Duration: sustained. Integration: partial. / Tier equivalent: Iron. / Note: current-perception component; architecture-reading component. Self and contact. / Contact range. / Acquisition: directed. Engagement: clinical — non-hostile. | anchored to the perceiver within one sentence: 'The notice arrived while her hands were still on him. He read it on the wall, where the sun was, because that was where his eyes were:'"
    },
    {
      "obligation": "must_include: Two firsts counted on the page (clinical engagement field; a fragment that does nothing in a fight); the third counted and NOT written (ten; the tenth is Tide; the anomaly has been Tide-adjacent for five years).",
      "status": "MET",
      "evidence": "Two firsts, counted on the page even now, lying still, because he was who he was. | The first notice whose engagement field said *clinical*. The grammar had bent again — it had bent for *directed* on a training-hall floor, for *non-hostile* at a flag — and it had bent now to describe a thing that was earnest and was help and had no other side to it at all. And the first fragment that did nothing in a fight. He read the note line twice to be sure. Perception. Reading. Self and contact. There was not a floor on the continent where it would move him a foot. | He counted a third and did not write it, and would not write it tonight, and knew as he did not write it that it was the one. | Ten. The tenth was Tide. The log had had a word in it for five years, from a session on a floor in Ardenmere with no Tide practitioner in the city, and the word was *Tide-adjacent*, and it had sat under three other words that said *patience*, and now there was a fragment with the same word on it, a real one, with a source, with hands. He did not know what that meant. He did not let himself put a verb after it. He filed it where it would keep."
    },
    {
      "obligation": "must_include: The closing exchange verbatim ending on Oryn's 'twenty-one' line.",
      "status": "MET",
      "evidence": "\"Something just changed,\" she said. \"In you. While I was in there.\" / \"Yes.\" / \"Did I do that?\" / He had written the answer the night before, so that he would give it and not a better one. / \"No. I did.\" He did not get up. \"I need to tell you what I am.\" / ... / \"Then lie still while you do it. You've been still for twenty minutes. I want to see if you can manage twenty-one.\" — the file's final line; verified with `tail -n 1 | grep -cF` = 1; trailing byte is a single newline."
    },
    {
      "obligation": "must_include: Manuscript format: H1 '# Chapter 13 — The Reading', prose only, '---' breaks, ends on the last line of prose.",
      "status": "MET",
      "evidence": "First line: '# Chapter 13 — The Reading'. Eight '---' section breaks. The notice is the only fenced block. No metadata, word count, notes, or headings other than the H1; the file ends on Oryn's line followed by one newline. §8.4 grep ('End of Chapter', 'approximately', 'word count', 'DRAFT', 'TODO') = 0."
    },
    {
      "obligation": "plant: The tenth fragment: current-perception, architecture-reading, self and contact (Ch14 self-reading; Ch16 the outward temptation; Ch22).",
      "status": "MET",
      "evidence": "Notice: 'Note: current-perception component; architecture-reading component. Self and contact. / Contact range.' | first flicker, self-side, one breath, no destabilization staged: 'He felt them go — the front one first, then the back — and felt the current go with them, out the way it had come, and felt, for the length of a breath, the *shape* of it going, from his side, as a thing with a lay to it, and then that was gone too and he was a man on a table in the sun.' | 'Perception. Reading. Self and contact. There was not a floor on the continent where it would move him a foot.'"
    },
    {
      "obligation": "plant: The anomaly's convergence begins (Ch14).",
      "status": "MET",
      "evidence": "The third first, counted privately and unwritten: 'Ten. The tenth was Tide. The log had had a word in it for five years ... and the word was *Tide-adjacent*, and it had sat under three other words that said *patience*, and now there was a fragment with the same word on it, a real one, with a source, with hands. He did not know what that meant. He did not let himself put a verb after it. He filed it where it would keep.' — nothing compared, nothing resolved; the comparison is Ch14's."
    },
    {
      "obligation": "plant: Oryn's consent-after-the-fact with a condition (Ch14).",
      "status": "MET",
      "evidence": "log in advance: *After: I tell her. In full. On her table, before I'm off it. Whatever it costs me, including the route walking north without me on it.* | council: \"If she takes her hands off me for good, that's what it costs.\" | the ending hands her the terms of the telling: \"Then lie still while you do it. You've been still for twenty minutes. I want to see if you can manage twenty-one.\" — her first condition, in her register; the mechanism and her consent are Ch14's."
    },
    {
      "obligation": "payoff: Ch7's two-readings rule (the long one finally run).",
      "status": "MET",
      "evidence": "Oryn in the yard: \"Still and whole. Near enough that I'll say it. Tomorrow, after I've eaten and slept under a roof, which I've not done since this one. The long one.\" | council: \"Both hands, all of her, run through all of me, for minutes. She said twenty, at Oxhollow; she said it costs what a mending costs; she said I have to be still and whole\" | the reading opens with the short one run and failed a fifth time (\"That's the short one. Now the long one\") and then the long one run in full for twenty minutes by the sun on the wall; her Ch7 prediction ('It won't read you either. I want to feel it not read you properly') paid: \"I've looked for twenty minutes. It isn't that you're broken. It's that I can't find anything shaped like the thing I read.\""
    },
    {
      "obligation": "payoff: The B4 Ch9 covenant and B6 Ch20's 'non-hostile' precedent, extended by argument to 'clinical'.",
      "status": "MET",
      "evidence": "the covenant's machinery on the page: cost written before, source told after, the wanting entered (*I want it. Write that too.* — the B4 Ch9 clause), the line verbatim; \"It was for that in Ostrand and it's for that here.\" | Seln: \"Nobody asked Ephram to be measured; he asked to measure. Nobody asked the woman on the Ostrand road anything. ... That's not consent. It's the nearest thing to it the log's ever had, and it's still not it. I'd enter both.\" | Karis's sentence extends B6 Ch20's *non-hostile* to *real, not fight*; the notice pays it: 'Engagement: clinical — non-hostile.' and 'The grammar had bent again — it had bent for *directed* on a training-hall floor, for *non-hostile* at a flag — and it had bent now to describe a thing that was earnest and was help and had no other side to it at all.'"
    },
    {
      "obligation": "prohibited_outcomes: Oryn does not learn the mechanism; no claim that Cael lacks banks/containers, is made of Tide, or predates anything; no fight; no other fragment use; no destabilization staged; no theory of the Quiet; no Teague/letters/Vastin; no quiet-ground beat beyond memory; no new named entities; the chapter does not end on a log entry or an image; no modern idiom; no feeling/growth declarations; tic caps; no metadata; no 'at the pitch'.",
      "status": "MET",
      "evidence": "Disclosure: the chapter ends on 'I need to tell you what I am' and her reply; nothing of the mechanism is said to Oryn on the page (the only dialogue naming 'the nine', 'the notices', 'the covenant' is in the loft with Oryn in the house). Ontology: grep 'made of|no banks|needs no|predates|before the|isn't a Path|not a Path' = 0; Oryn's every finding is phrased as her inability to find/read. No fight; no fragment deployed (the nine 'ring faintly' as idle texture; Anchor 'wanted nothing under her hand at all'); the tenth is not used — one breath of self-side perception as her hands leave, no destabilization (Ch14). Quiet ground appears only in memory ('as there had been at the stone'; 'the line'; 'the Ring' as a date). grep counts: 'Quieting' 0; 'Architect' 0; 'Teague' 0; 'Vastin' 0; 'letter' 0; 'Compact' 0; 'cache' 0; 'UNBOUND' 0; 'primordial' 0; 'at the pitch'/'at that pitch' 0; okay/literally/basically/gonna 0; feeling-declaration and growth-declaration patterns 0; all §9 capped phrases 0; 'heard about it later' family 0; §8.4 metadata 0. New named entities: none (the steading's woman and the bowman remain unnamed; no new place). Closer: DIALOGUE (Chapter 12 closed on an image; no repeat). Single-word paragraphs: 1, and it is the mandated 'Yes.'"
    }
  ],
  "inventions": [
    "Thornwater on return, catalogued: timber wall on a stone footing; the same bowman calling nothing; the house with two chimneys, one smoking; the steading's woman counting them in and saying 'Six. Well' as a ledger line. Lira having walked the two days at Oryn's pace and not sitting until told.",
    "Oryn's yard examination before she is fed: the rib tape cut off at the back ('Twenty-three days. A rib is six weeks. These are done.'); the calf's ford-line found closed to a pink seam, pressed with a thumb twice ('Closed. Four days. ... That should be a fortnight. I've said so four times and I'll not say it a fifth; it's on the page.'); her declaration 'Still and whole. Near enough that I'll say it'; her rules for the morning ('The back room. The door shut. Nobody in it but the two of us ... you'll be still and you'll not talk and you'll not help.' / 'What does helping look like?' / 'I'll know.').",
    "The loft council's staging: the woman's lantern with a finger's width of oil; positions (Lira on the grain against the sacks, Brom at the ladder's head, Karis on the middle box with the bruise gone yellow and green, Seln standing at the window); Cael counting the conditions on his fingers; Karis speaking her line in the voice Oryn told her not to use yet, 'in pieces, low and torn at the edges', then writing it under the spoken one and turning the book to the lantern.",
    "Council dialogue beyond the mandated lines: Brom's 'And the third's a fight.' (the weight named); Lira's 'Then tell her. Tonight. Before.' and 'That's not the reason.' and 'She asked to read you. She didn't ask for the rest. Those aren't the same sentence.'; Cael's argument for not telling her first (a healer who goes in looking for a thing is running a proof, not a reading; it might be a fifth nothing) and his admission of the real reason ('I don't know what she'd say, and I'm not brave enough to find out before I've got a sentence'); Seln's professional read ('She asked for it. She's asked four times. Nobody asked Ephram to be measured; he asked to measure. ... That's not consent. It's the nearest thing to it the log's ever had, and it's still not it. I'd enter both.'); Brom's 'What's it cost her? Not the reading. The other thing.' and Cael's 'It's never cost the source anything I could see. Lira fights the same. Karis lights the same. Seln's still Seln.'; Lira's closer 'Write it. I'll read it when it's dry.'",
    "The log entry in advance, composed to the card in Cael's plain register (dateline 'Ninety-ninth day. Thornwater, the loft. A hundred and eight in hand; nothing owed; nothing earned. Eighteen.'; the conditions as he has them; the price; the decision not to tell her before and the honest reason; the cost to the source; 'After: I tell her. In full. On her table, before I'm off it'; 'I want it. Write that too.'; the mandated closing line). He reads it back once and changes nothing 'because a word changed after was a word written after.'",
    "The back room, catalogued from the door: four paces by five; an east window, low, the first sun flat along the floor and climbing the far wall (used as the reading's clock throughout — knee, shoulder, top of the wall, ceiling); a plank table with a folded blanket; a stool; the woman's jars pushed aside for the leather roll laid out in Oryn's order; a plank door on a leather hinge that shuts.",
    "Oryn's positioning of the patient (left side down, facing the window, left hand under the blanket, right arm along his side moved a finger's width; 'Breathe like a man asleep'); her hands flat on sternum and between the shoulder blades over the spine, 'like a thing held up to the light'; the short reading run first and failed a fifth time before the long one.",
    "The reading as sensation: 'the idea of cold, without the temperature — the shape of a stream's edge on a wrist'; the current going 'along' not 'down'; lying along each fragment 'as a hand lies along a rope to learn its lay'; the unreached fragments ringing 'the way strings ring on a bench when one is struck'; Cael feeling her patience and her count; Shadow drawing in under her touch and her saying nothing because a movement that hid was a meaning; Storm found quiet three days off the Ring; Anchor wanting nothing under her hand; her current slowing at Blade's edge and not finding it.",
    "Oryn's commentary before the mandated passages, all in the register of inability: 'I'm in. Past the hurt-layer. There's a lot of you. I'd not expected that; the short one made you feel thin.' / 'I'll say what I feel and not what it means' / 'I'm on one and I've lost it, and I'm on — another. Or the same one round a corner.' / how banks feel in Iron Skin, Ember, and Wind ('there's always a bank. It's how you know which river') / 'I can't find one here. I keep putting my hand where the bank ought to be and there's more water.' / 'I can't tell you I've been the whole way round, because I can't find the edge of the way.'",
    "Cael's interior during the reading (brief): that she is not looking for what frightened five people on a floor but for how he is built — 'the least frightened anyone had ever been of him with cause, and it was not courage. It was a trade'; 'the hardest still of the twenty'; that the names of the movements are his and he does not give them to her.",
    "The completion image in the cataloguer's register: 'a count coming out even — a column he had not known he was adding arriving at its foot'; the knot drawn tight, 'and the drawing was hers'; the fourth word after the series' three: 'He reached. Directed. Open-eyed. Still.'",
    "The closing staging: Oryn standing with her hands palms-up in front of her, looking at them longer than at the stone or the line; then putting them flat on the table's edge either side of his shoulder and leaning on them for the last line. Cael 'had written the answer the night before, so that he would give it and not a better one.'"
  ],
  "state_change_proposals": [
    "Timeline: the six reach Thornwater's gate at the end of the second day's walk, the NINETY-NINTH day past the Line (left Thornwater's east gate on the 94th; five days out). Oryn's yard examination and 'the long one' declared on the evening of the 99th; the loft council and the advance log entry the same night (three days off the Ring fight of the 96th); the deep reading in the back room the morning of the HUNDREDTH day, twenty minutes by the sun on the wall, beginning at first light. Chapter 14 opens on the table, immediately after Oryn's last line, with the disclosure. Cael is eighteen (stated in prose and in the log dateline).",
    "Cael — FRAGMENTS: TEN confirmed + the anomaly. Tenth acquired on the 100th day on Oryn's table: notice verbatim — 'FRAGMENT ACQUIRED / [unnamed] — Tide-adjacent. Duration: sustained. Integration: partial. / Tier equivalent: Iron. / Note: current-perception component; architecture-reading component. Self and contact. / Contact range. / Acquisition: directed. Engagement: clinical — non-hostile.' Source: Oryn (Tide, Iron R4). First 'clinical' engagement field; first fragment with no combat use; first Iron-equivalent since Blade. Not yet used; one breath of self-side perception of her current leaving as her hands came off (not a deployment). Destabilization NOT yet staged — Ch14's ('the fragment listens'). The nine were 'ringing faintly' and 'settling' three days off the Ring; those she touched 'settling differently'. Shadow-adjacent untouched (seal intact; the room had one witness, Oryn, who felt it 'draw in' under her current and said nothing). Anchor idle-wanted nothing under her hands.",
    "Cael — the third first, PRIVATE and UNWRITTEN: he counted ten, that the tenth is Tide, and that the anomaly has been logged Tide-adjacent for five years under 'Still open. Still real. Patience.' He did not write it, put no verb after it, and 'filed it where it would keep'. The anomaly is NOT compared, resolved, or theorized. Ch14 retires the three words.",
    "Cael — INJURIES: RIBS — tape cut off by Oryn on the 99th at twenty-three days (running-ledger count), her finding 'A rib is six weeks. These are done.'; breath goes all the way down; no tape from here. RIGHT CALF — the ford's line closed to a pink seam its whole length by the 99th (four days from the rim's reopening); Oryn's finding 'Closed. Four days. That should be a fortnight'; walked at nine on rises and no count on the flat by the second noon; no binding from here. Oryn's declaration on record: 'Still and whole. Near enough that I'll say it.' Marks: one hundred and eight in hand; nothing owed; nothing earned.",
    "Oryn — READINGS ON CAEL: surface-reading count now FIVE failed (the count of ten run at the start of the long one, 'Nothing. As before.'); DEEP reading run ONCE, in full, twenty minutes, on the 100th — an honest failure to read (movement, more than one, uncountable, no banks found, 'nothing shaped like the thing I read'), with the mandated lines on record verbatim. Her reserve: a mending's worth spent on the reading — the FOURTH such spend in three days (arm 96th; throat and hand 97th; the reading 100th) after one night fed and slept under Thornwater's roof; the cost felt by Cael as 'a thinness in the current' by the twentieth minute; her posture after is standing, hands out, then leaning on the table — no collapse staged. Route: still late at the far end (not restated in days this chapter; the loft council says 'a route that's late at the far end'). Her rules on record: 'The back room. The door shut. Nobody in it but the two of us'; 'you'll not help' / 'I'll know'. She has NOT been told about the dawn crossings.",
    "WHO KNOWS WHAT at chapter end: ORYN knows that something changed in Cael while her hands were in him, that he says he did it and not she, and that he has a thing to tell her about what he is; she does NOT know the mechanism, the fragments, the notices, the log, the covenant, or the word 'Tide-adjacent'. The disclosure is Chapter 14 and has not begun on the page (her last line sets its terms). THE CIRCLE (Lira, Brom, Karis, Seln) know he chose the acquisition in advance, the three conditions as he named them, the price as written, his decision not to tell her before and his stated reasons, and his commitment to tell her after in full; Lira has the log entry to read 'when it's dry' (Brom may read it; Karis does not read the log, per B3 terms — she wrote her own line). Nobody outside the six knows anything; the steading's woman gave Oryn the back room as she 'always does' and knows a reading was run and nothing more. Cael's Ch9–12 silence about the Ring (why the fragments worked inside) is UNTOUCHED — the council was about the acquisition, not the Quiet; Lira's 'later' still holds.",
    "Karis — VOICE: returning, hoarse; she spoke her mandated sentence aloud on the 99th 'in pieces, low and torn at the edges', two days after Oryn's 'days' order, and otherwise kept her mouth shut and wrote. Bruise under the jaw yellow at the edges and green in the middle. She holds Cael's three conditions and her own sentence in the notebook (spoken line written beneath itself); she was NOT in the back room and has no data from the reading yet (Ch14's comparative data). Lira — left arm slung, unused; walked two days at Oryn's pace and kept the order. Brom — right hand mended, four lines across the pads; carried nothing on the string. Seln — unmarked; at the loft window through the council; asleep or not unstated.",
    "Third-party verdicts / kept sentences on record this chapter: the steading's woman — 'Six. Well.'; Oryn — 'A rib is six weeks. These are done.' / 'Closed. Four days.' / 'Still and whole. Near enough that I'll say it.' / 'You don't get a yes. You get told.' / 'I'll know.' / 'Breathe like a man asleep.' / 'That's the short one. Now the long one' / 'There's a lot of you.' / 'I'll say what I feel and not what it means' / 'there's always a bank. It's how you know which river' / 'I can't find the edge of the way.' / the two mandated passages / 'Something just changed. In you. While I was in there.' / 'Did I do that?' / the closing line; Karis — the mandated sentence; Seln — 'That's not consent. It's the nearest thing to it the log's ever had, and it's still not it. I'd enter both.'; Lira — 'She asked to read you. She didn't ask for the rest. Those aren't the same sentence.' / 'Write it. I'll read it when it's dry.'; Brom — 'And the third's a fight.' / 'What's it cost her? Not the reading. The other thing.'",
    "Log entries this chapter: ONE, written in advance on the night of the 99th in the loft (text on the page in full). No entry after the reading — the chapter ends on the table; the post-acquisition entry is Ch14's. The third first is deliberately NOT in the log.",
    "Tic ledger for Chapter 13: 'jaw tightened' 0; 'laughed once' 0; 'without humor' 0; 'stomach tightened' 0; 'stomach dropped' 0; 'There it was' 0; 'That was true' 0; 'Also true' 0; 'sounded almost' 0; 'held this' 0; 'which was, in its own way' 0; 'at the pitch'/'at that pitch' 0 (book cap already reached — avoided); 'heard about it later' family 0; 'End of Chapter'/'approximately'/'word count'/'DRAFT'/'TODO' 0; banned modern registers (okay/literally/basically/gonna) 0; standalone '[Name] noticed.' 0; feeling-declaration and growth-declaration greps 0; single-word paragraphs 1 (the packet-mandated 'Yes.'); 'the way X [verb]' identical construction max 2 ('the way she had'); em dashes 29 in 5,169 words. 'Quieting' 0; 'Architect' 0; 'Compact' 0; 'Teague' 0; 'Vastin' 0; 'letter' 0; 'cache' 0; 'UNBOUND' 0. Scene-closer: DIALOGUE (Chapter 12 closed on an image; no repeat). Word count 5,169 (wc -w).",
    "Party SIX at Thornwater, the 100th day, morning: Cael on the table in the back room with Oryn leaning on it, about to tell her what he is (Ch14); the other four in the steading. TEN fragments + the anomaly. Lira one-armed (slung); Karis hoarse; Brom's hand mended; Cael untaped and unbound, whole; Oryn a mending's reserve down on the reading. The covenant's cost written in advance and on the page; the source to be told in full, on her terms ('lie still while you do it')."
  ],
  "deviations": [
    "Length: the first full pass came in at 5,284 words by wc -w — inside the packet's band (4,600 ±15%, ceiling 5,290) but six words under the ceiling — and was tightened by about a hundred and twenty words in one light pass (no beat, obligation, or mandated line removed; three sentences shortened, one chronology error corrected, one meta-sounding phrase replaced). Final 5,169. Reported so the editor knows the draft was not overshot-and-trimmed in the packet's sense, but was tightened from within the band.",
    "The reach line: the packet gives 'He reaches. Directed. Open-eyed.' in present tense and asks for it 'in the series' register'. The series renders this beat in past tense with a fourth word (B6 Ch13 'He reached. Directed. Open-eyed. Mid-fight.'; B6 Ch20 'He reached. Directed. Open-eyed. In earnest.'). Rendered here as 'He reached. Directed. Open-eyed. Still.' — the fourth word being the chapter's condition. If the editor wants the three-word form exactly, drop 'Still.'",
    "The mandated Oryn passage 'Eleven years. I've never had my hands in something and not known what it was.' is rendered as one contiguous quotation (attribution in the preceding sentence) so that it greps verbatim; the first draft had a speech tag between the two sentences, which was removed.",
    "Karis speaks her mandated sentence aloud. The state has her voice 'returning hoarse' by Ch13 and back in Ch14; the draft has her speak it two days after Oryn's 'days' order, in pieces, hoarse, against Oryn's advice, and write it beneath the spoken one — her only spoken words in the chapter. If the editor rules the voice too early, the line can be given as written text turned to the lantern without changing a word of it.",
    "Rib tape count: the running state gives the tape as twenty-one days old on the 97th (so twenty-three on the 99th), while the Ch7 block says it was applied on the eighty-first (which would give eighteen). The draft follows the running count ('Twenty-three days of boiled linen') and does not name the day it was applied, so either ledger reading survives.",
    "The calf: per the packet's contingency, the calf is staged as fully closed (a pink seam) by the 99th, so Oryn's 'still and whole' is said without qualification; the alternative branch (not fully closed; she runs the long reading anyway) was not needed.",
    "The advance log entry does not mention Tide, the anomaly, or the possibility that the tenth would be Tide-adjacent; the packet places that count after the notice as a private, unwritten third first, and the draft keeps the log clean of it so that the count lands there.",
    "Oryn's pre-mandate commentary includes a short description of how banks feel in Iron Skin, Ember, and Wind ('there's always a bank. It's how you know which river'). This is her clinical register describing other Paths she has read, not a claim about Cael; it is invention within the 'clinical manner' allowance and can be cut if the editor reads it as a Tide mechanic beyond the taught two readings."
  ],
  "blockers": []
}
