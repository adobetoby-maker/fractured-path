...

{
  ...
  "purpose": "The trap sprung: the series' second off-channel action and the book's second choreography built on the Quieting as terrain, with the tactical problem inverted from Chapter 11 — people who planned for the line. The stair as cover the rim cannot reach; the stalemate; the healer with eyes and no hands; and the turn: Cael walking up into the bowl unseen, unbinding the lattice, and stepping out of the Quiet already declaring. Nobody taken; no faces; the rival crew arriving to say the board has no column for this.",
  "scene_shape": {
  ...
  "output": {
    ...
    "report_path": "v3-runs/book-07/reports/ch19-author-r1.json",
    "editor_report_path": "v3-runs/book-07/reports/ch19-editor-r1.json",
    "verifier_report_path": "v3-runs/book-07/reports/ch19-verifier-r1.json",
    "target_words": 4600,
