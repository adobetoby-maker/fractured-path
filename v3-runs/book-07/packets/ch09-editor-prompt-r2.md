...

{
  ...
  "context_files": [
    ...
    },
    {
      ...
      "path": "v3-runs/book-07/drafts/ch09-r1.md",
      "required": true
    }
  ],
  "verified_findings": [
    {
      ...
      "evidence": "'Seventeen days' vs day-78 break / day-81 tape at day 93",
      "consequence": "injury ledger distrust",
      "repair_target": "Fifteen days since the break"
    },
    {
      "id": "ED-B7CH09-002",
      "severity": "LOW",
      "gate": "author.13_injury_persistence",
      "evidence": "Ch7 raw heel absent from Oryn's next appearance",
      "consequence": "vanished cost",
      "repair_target": "carry or resolve at her next-appearance inventory"
    }
  ],
  "exceptions": [],
  "output": {
    "draft_path": "v3-runs/book-07/drafts/ch09.md",
    "report_path": "v3-runs/book-07/reports/ch09-author-r2.json",
    "editor_report_path": "v3-runs/book-07/reports/ch09-editor-r2.json",
    "verifier_report_path": "v3-runs/book-07/reports/ch09-verifier-r2.json",
    "target_words": 4600,
...
# CONTEXT — THE DRAFT UNDER REPAIR (r1) (v3-runs/book-07/drafts/ch09-r1.md)
...
# AUTHOR REPORT — v3-runs/book-07/reports/ch09-author-r2.json

{
  ...
  "obligations": [
    {
      "obligation": "ED-B7CH09-001 repaired",
      "status": "MET",
      "evidence": "\"Fifteen days,\" she said. \"Since the break.\" / \"Fifteen.\""
    },
    {
      "obligation": "ED-B7CH09-002 repaired",
      "status": "MET",
      "evidence": "The heel that had gone raw in her boot on the mountain had healed in nine days the ordinary way, on the ordinary schedule; it had not changed the walk, and he catalogued that."
    }
  ],
  "inventions": [],
  "state_change_proposals": [
    "Oryn's heel (Ch7) healed by day 94; no open injury on Oryn."
  ],
  "deviations": [
    "Repairs applied directly by the orchestrator (one exchange, one sentence)."
  ],
  "blockers": []
}
