...

{
  ...
  "revisions": {
    ...
    "arc": "arc-b7-v2 (books/book-07-void-roads/CHAPTER_ARCHITECTURE.md, editor PASS r4, Chapter 6 card)",
    "state": "state-b7-post-ch05 (v3-runs/book-07/STATE_RUNNING.md + base snapshot)",
  ...
  "pov": {
    ...
    "knowledge_boundary": [
      "Cael is eighteen; nine fragments + anomaly; party is FIVE until Oryn arrives on the second day after the collapse. Open injuries at start: Lira's ankle (taped, twice turned: the ford and — in this chapter — the ledge), Brom's forearm (bound, not healed since the ford), Cael's calf (mostly closed; reopens here on the shale), Karis's hands (scarred).",
      "Shale-backs flee declarations as a unit (Karis, Chapter 5); below a herd is the wrong place to be loud (Pike's rule). Lira's Wind burst on the collapsing ledge is her OWN Path (Wind, Iron R1), a full declaration — not Cael's fragment.",
      "ORYN is introduced in this chapter, through her hands, in Cael's POV — NOT through the limited third-person window. Facts available to Cael on the page: a woman, late twenties, Tide Path (she says so, as a trade), Iron-tier (may state rank 4), a traveling healer with a mule and a kit, two years on the void roads, came up the road from Oxhollow because a carter said a crew was overdue on the traverse. Her ROUTE, her want, and her reasons for leaving the city belong to Chapter 7 — at most one sentence here.",
      "Tide Path mechanics shown here for the first time and only as observed: the mending (her current run through the break; bone knitting faster than any healer Cael has watched; it visibly costs her — she sits down afterward like a woman spending something she counts); the SURFACE reading (hands on the hurt, seconds). She does NOT run the deep reading here and does not describe it (Chapter 7). On Cael she gets nothing beneath the injury and says so as a finding.",
      "Nobody knows what quiet ground is; no Quieting; no survey stakes. Nobody has met Teague in conversation."
    ]
  },
  "purpose": "The job goes wrong exactly as the bible requires: the ground itself is the opponent (the ledge lets go; Lira's own Wind saves her and turns thirty shale-backs downhill), the fight is a fight against a mountain with the herd as the clock and where-to-be as the only decision, the cart goes into the gorge and the three boxes are saved at a price the found family pays on purpose — and then the sixth companion walks onto the page through her hands, healing three people and failing, clinically and to his face, to read the fourth.",
  "scene_shape": {
    "opening_state": "First light on the bench: Lira thirty meters out on the ledge over the gorge checking it for a cart's width; the herd two hundred meters above and moving; the other four on the bench behind with the cart and the three boxes.",
    "pov_goal": "Get everyone to the one piece of ground the herd will split around; then — the stupid thing, on purpose — get Karis's boxes off the cart before the mountain takes them.",
    "opposition": "A ledge that held five days of scouting and lets go under Lira; thirty armored animals the size of carts fleeing downhill from her declaration, on shale, toward the bench; and the arithmetic of thirty seconds.",
    "turn": "The ledge goes; Lira does what her body has trained into her — she bursts, her own Wind, full, loud enough to cross a gorge — and lands on the bench with the ledge gone beneath her; two hundred meters above, thirty shale-backs turn away from the declaration, which on a slope means downhill, toward everyone. FIRST: Seln, already moving, has the outcrop the herd will split around; thirty seconds. SECOND: Brom prices the geometry — the cart is between them and the outcrop; the cart is lost; he says so and nobody argues; the three boxes are in it. THIRD: Karis lights a lattice-line across the bench ABOVE the outcrop — a wall of ignition the herd will turn from — and it works and it costs: the herd splits around the outcrop and both halves pass within arm's reach, and the lattice drains her to nothing in eight seconds. Win sentence, legible: Karis took away the herd's line by lighting one it had to turn from.",
    "choice": "FOURTH: the boxes. Brom goes back for the cart; Cael goes after Brom; the chapter is honest that this is the found family doing the stupid thing on purpose. Brom gets two boxes off before the second half of the herd reaches the cart; Cael gets the third and a shale-back's shoulder at the same time — thrown into the outcrop's lee with the box in his arms, three ribs (he catalogues it and is right), the calf opened again on the shale. The cart goes into the gorge. Lira reaches the outcrop last, on an ankle that has now gone twice, and not whole: the ledge took her boot and the shale the rest; the leg below the knee is the wrong shape. She knows she caused it and the chapter lets her.",
    "outcome": "Five practitioners on a mountain with a broken leg, three broken ribs, a drained Ember, a forearm not healed since the ford, and no healer for four days in any direction. On the second day, up the void road from Oxhollow with a mule and a kit: Oryn. She asks who is worst, not who they are. Lira's leg read, set, and MENDED inside an hour — the Tide Path's civil face in full, the current run through the break, bone knitting the way no healer Cael has watched does it — and it costs her visibly. Then Brom's arm. Then Karis, who is only empty. Then Cael: both hands on his ribs, the surface reading — and she stops, takes her hands off, puts them back, and her face does the thing Cael has seen on assessors for four years and never on a healer: the instrument returning nothing. 'Your ribs are broken. I can feel that they're broken. I can't feel YOU. Whatever you are, I can't read it. I've never said that to anyone. Tape them. They'll heal on their own. They always have, haven't they?' Cael: 'Yes.'",
    "closing_state": "The log, on the mountain, one line in a hand that hurts, written BEFORE she reaches him: 'Lira's leg is straight. The boxes are ours. The cart is in the gorge. A healer came up the road because a carter said we were late.' Then the chapter ENDS ON DIALOGUE — her hands off his ribs, her finding said to his face: 'That's not an answer. That's a finding.'"
  },
  "obligations": {
    "must_include": [
      "The collapse and Lira's own Wind declaration saving her and triggering the herd; the herd's downhill flight staged with Chapter 5's rule as the cause.",
      "Four exchanges as in scene_shape with the mountain as terrain (ledge, downhill herd, the outcrop the herd splits around, the cart between, the gorge): at least two beats CAUSED by terrain; geography drawable at each pause.",
      "Karis's lattice-line above the outcrop and its eight-second cost (drained to nothing); the herd splitting within arm's reach.",
      "The boxes: Brom back for the cart, Cael after Brom, two boxes then the third; Cael's three ribs and reopened calf; the cart into the gorge; Lira's leg broken below the knee, her boot taken by the ledge; Lira's knowledge that she caused it, held without melodrama.",
      "Oryn's arrival on the second day (Oxhollow road, mule, kit, a carter's word); introduced through her hands and her questions ('Who's worst?'), no backstory beyond one sentence; Lira's leg set and mended inside an hour with visible cost; Brom's arm; Karis (empty); then Cael — the surface reading returning nothing beneath the break, and her lines as given (the finding), with Cael's 'Yes.'",
      "Tide Path's first on-page use carries its limit/cost in the same scene (charter §6.1): contact only; healing spends her; she does not heal herself.",
      "Cael's log line on the mountain (as given) placed BEFORE Oryn reaches him; the chapter ENDS on her dialogue line 'That's not an answer. That's a finding.'",
      "Cael's cataloguing outside the log (the herd, the geometry, his own ribs).",
      "Manuscript format: H1 '# Chapter 6 — Shale', prose only, '---' breaks, ends on the last line of prose."
    ],
    "plants": [
      "Oryn cannot read Cael (first of three failed surface readings; Chapter 7 teaches the two modes; Chapter 13 completes).",
      "Lira's leg mended by Tide — the healer's mend and its cost; Oryn's reserve arithmetic (Chapter 7).",
      "Cael's ribs and calf — three-week healing that Oryn will find faster than it should be (Chapter 7).",
      "The three boxes saved — the field archive (Chapter 4, Chapter 15)."
    ],
    "payoffs": [
      "Chapter 5's shale-back rule and the ledge; Chapter 4's healer shortage (no healer for four days in any direction) paid by Oryn's arrival.",
      "The banking doctrine's inverse: Lira's declaration is the loudest thing on the mountain and it is exactly the wrong place to be loud."
    ],
    "prohibited_outcomes": [
      "Nobody dies. Lira's leg is broken below the knee and MENDED by Oryn (she keeps the leg, walks with help); Brom's forearm mended; Karis empty, not injured; Cael's ribs taped, calf bound, NOT healed by Oryn.",
      "No fragment use by Cael in the stampede or after (he may WANT Compression/Anchor and hold; the ribs are taken raw); no Shadow-adjacent.",
      "Oryn does not run the deep reading, does not describe the route in detail, does not join the crew, does not explain Tide theory. She does not learn anything about fragments.",
      "No Oryn window/POV; no backstory speech.",
      "No quiet ground, Quieting, stakes; no Teague; no letters; no Vastin.",
      "No new named people beyond Oryn; no new places beyond those on the traverse (descriptive).",
      "The chapter does not end on a log entry or an image; it ends on Oryn's line.",
  ...
  "invention_budget": {
    "allowed": [
      "Full choreography texture for the collapse and the stampede (sound, shale, dust, the animals' armor and gait, the outcrop's shape, the gorge); the two days of waiting (cold, pain, rationing, who does what with a broken leg and three ribs); Oryn's kit, mule, hands, manner (blunt, unhurried, clinical, no awe); the mending described as sensation and consequence.",
      "Dialogue in established voices; Oryn's clinical questions ('When you heal, does it hurt in the right places?' may appear here or wait for Chapter 7).",
      "Cael's interior cataloguing of pain, geometry, and the healer's face."
    ],
    "approval_required": [
      "Any new named entity; any Tide mechanic beyond contact-only mending with visible cost and the surface reading; any fact about Oryn's history beyond one sentence; any change to the injury list."
    ],
    "forbidden": [
      "Deaths; fragment use; Oryn healing Cael; the deep reading; Oryn learning of fragments; Part 2 knowledge; a log or image ending; metadata."
    ]
  },
  "context_files": [
    {
    ...
    {
      "kind": "previous_scene",
      "label": "Chapter 5 as drafted — the immediate seam (the fifth night, the ledge announced)",
      "path": "v3-runs/book-07/drafts/ch05.md",
      "required": true
    },
    {
      "kind": "reference",
  ...
  "exceptions": [],
  "output": {
    "draft_path": "v3-runs/book-07/drafts/ch06.md",
    "report_path": "v3-runs/book-07/reports/ch06-author-r1.json",
    "editor_report_path": "v3-runs/book-07/reports/ch06-editor-r1.json",
    "verifier_report_path": "v3-runs/book-07/reports/ch06-verifier-r1.json",
    "target_words": 4600,
...
## After Chapter 6 (draft r1 with editor; provisional until PASS) — the traverse, Oryn arrived (~day 80)
...
# CONTEXT — Chapter 5 as drafted — the immediate seam (the fifth night, the ledge announced) (v3-runs/book-07/drafts/ch05.md)

# Chapter 5 — Route

The slip was in a hold's hand, and the hold was one he had never heard of.

He read it at the plank on the seventieth morning past the Line, in the order the board taught, which was every slip once and then the ones that paid twice: *Oxhollow ford. High traverse to Thornwater wanted scouted before the autumn carts. Shale bench above the gorge; two days under the void road; not walked three seasons, since the slide. Map wanted, and a word on whether it holds a cart. Seventy marks on the map, paid at Oxhollow.*

Oxhollow was a ford, north, a week by the void road; that was the whole of what the plank knew about it.

Thirteen slips. Two of them, the good two, wore Pike's HOLD and Teague's name across the top in the same pencil; the crew had been in off the autumn road and out again with the hold slips while the five of them were at the well on the south road. That left eleven: one hold's, four escorts at the carters' price, and fences and wells and a roof that wanted thatching. He sorted them by what each would cost the five of them, and the sorting put Oxhollow's slip at the top by itself before he had finished reading it the second time.

He counted why, because he did not trust a thing that sorted itself.

It paid. Seventy marks was the ford's price and three-quarters again, for a walk. Holds priced what a thing was worth to the hold, and a route two days under the void road was worth a great deal to a ford that sent carts south in autumn.

Teague's crew was gone on the hold contracts, a week out and a week back, and Oxhollow's slip had come in on a carter behind them and sat four days on the plank with nobody's finger on it. Pike had said, to the page, when Cael asked why: "Pays on the map, at Oxhollow. That's a week north to get paid for a week's walk, and the crews that could take it are the crews with the pick. Nobody's been on the board long enough to want it."

And the third reason, which he counted last because it was his: it was ground. Not teeth. A scouting run was a thing walked and measured and written down and handed to a man who would trust a cart to the writing, and he had done that every day of his life since he was fourteen, in a notebook, for nothing, at the edges of rooms where the work being paid for was somebody else's. He had never once been paid to catalogue. He read the slip a third time to be sure. It was what it said.

"That one," he said.

Seln, beside him, had already put a finger on it and moved it a quarter-inch on the plank.

---

Pike entered it as a price gets entered, flat, with the five names under it, and said the things he said.

"Three seasons nobody's walked it. Slide came down on the Thornwater end and the carts went round by the void road and stopped talking about the bench. Oxhollow doesn't want a crew that comes back and says it's fine." The pen did not stop. "They want a map they can put a cart on. Width at every narrow. Where it holds and where it doesn't. Where you'd camp." A pause, at the end of a line. "Take a cart. Smith has one, six marks against it coming back. You want to tell a ford it holds a cart, you'd better have had one on it."

He said one more thing, to Seln and not to the rest of them, when Seln stopped at the plank's end on the way out: "Ask me about the shale-backs before you go." Seln asked, there, with his back to the room, and Cael did not go to hear the answer, because a man who asked a thing quietly at the end of a plank had asked it that way on purpose.

The cart was the smith's second-best, two wheels and a bed and a pair of shafts with a chest-strap between them. Brom stood in the shafts and put the strap across his chest and leaned on it once, and it moved, and he nodded, and that was the cart's whole trial. The bound arm went inside the right shaft against his ribs. The good hand took the left.

The boxes went because there was nowhere to leave them. Lowmarch had no wall and a population that turned over with the season, and three boxes in a meadow belonged to whoever walked past them last. Karis roped them onto the cart's bed herself, the front box over the axle and the other two behind it, and put her hand flat on the middle lid when she was done, as if to see whether it was warm.

Inventory, taken on the smith's yard on the seventy-first morning.

The calf: closed, mostly. He had stopped counting on the flat, because the count had gone past twenty and a number that large was not a limp, it was a leg. Uphill it still said nine. He had not told anyone the uphill number, and there was a mountain in the slip.

Brom's forearm: bound wrist to elbow still, but the wrist had closed at last, the cloth coming off clean on the sixty-sixth day, and he had looked at the closed place with the lock face and wrapped it again as if it had not. The hand was allowed to hold. It was not allowed to pull. The chest-strap pulled.

Lira's ankle: the stick was gone, leaned against the inn wall on the sixty-fourth day and walked away from. What she had instead was cloth — the steading's boiled linen cut into strips, wound each morning from the arch up over the joint and tied off at the shin, tight, so that the ankle bent as far as the cloth allowed and no further, which was less than the other, and later. She called it taping. She did it before her boots, sitting, with her mouth shut.

Karis's hands: two lines across each palm, pink and raised, that she flexed against the pen every morning like a woman working a hinge. The letters had come back to their size. She did not look at the palms while she wrote, and Cael did not look at them either.

Five. All walking. None of it healed by anybody.

---

Two days up the Thornwater road to the fan, with the cart; the stretch walked at noon, quiet. They did not go up to Thornwater's gate. The slide had come down a mile short of the steading, and the road went over the toe of what it had left and the traverse went up its side, and there was a cairn, knocked half over, where the two parted. Seln set the stones back on it while the rest of them looked up.

The fan was the worst ground of the route, and Cael catalogued it from the bottom: a spill of broken shale the width of a field, lying at the angle at which shale stops, every plate the size of a hand or a door and none of them fixed to anything. Somewhere on the mountain above it a shelf ran along over the gorge, and the shelf was the traverse, and the fan was where a piece of the shelf had come down.

They took the cart up it on a rope, three ahead on the rope and Brom in the shafts holding the bed level, and it took the whole morning, and the calf said nine the entire way.

---

The bench, when they reached it, was a shelf.

He wrote that down first, at the first halt, because it was the fact everything else stood on. A shelf of grey shale along the mountain's face, a cart and a half wide where they came onto it and sloping toward the outer edge as a roof slopes — not steep, but not flat, so that anything set down on it wanted to go one way. On the left the mountain went up in the same stone, plated, and two hundred meters up, by the eye, a second shelf ran along it, greener than theirs: an upper bench. On the right the shelf stopped, and past where it stopped there was nothing for a long way down, and at the bottom of the nothing a white line that was a river.

The gorge had a sound. On the bench it resolved into water, far down, and wind coming up, and a third thing that was neither: the gorge took every sound they made and gave it back late, from the far wall. Brom set the cart's tail-board down at the first halt and the bang came back a breath afterward from across the gap, smaller, as if a second crew were working over there and were more careful. It was the loudest thing about the place, that it repeated you.

Lira went ahead.

She had taped the ankle at the fan's foot and again at the top, tighter, and then she went out along the bench at a run — not a burst; a burst was a shout, she had learned that on a gravel bar with seven dogs turning toward her — a hundred paces out over the shale with nothing under it but her, and came back at a walk, reading the ground with her feet. Shale that held a walker held nothing, she said; shale that held a runner held a wheel. She ran the bench in hundreds all afternoon and the cart followed in her prints, and at the evening halt she sat down before anyone and took the boot off and did not look at the ankle, and then looked at it.

Karis mapped.

She had paced a length of the void road against the folding rule on the first morning out of Lowmarch and had a number for her stride she trusted; now she walked the bench counting, the pen in the scarred hand, and at every place where the shelf narrowed she ran the cord across it edge to edge and wrote the width, and the count to it from the last width, and the pitch, which she took with the cord and a stone hung on it. Where the gorge came close she dropped a stone over and counted until the sound came up. What went into the book was a chain of numbers with a drawing beside it that looked like nothing at all — a line, kinked, with figures along it — and would look, to a man at Oxhollow with a cart, like the only true thing on the mountain.

Brom kept the cart on the mountain.

He said, at the second halt, that a cart on scree did not roll; it floated. The wheels sat on plates that sat on plates and the whole of it went where the slope wanted, which was over the edge, a finger's width at every turn of the wheel, unless the weight was over the axle and up-slope. He re-roped the boxes at every halt to keep the front one where it was, took the down-slope shaft himself as the counter, and walked the whole day with the cart's want against his chest, and it was — Cael watched for the word — a lock somebody else had built, being held shut by hand.

Seln was ahead of Lira.

Nobody saw him go past her; he was simply further along, and then further, and in the last hour of the light, when the cart came round a shoulder of the mountain, he was standing in a place where the bench widened to three carts and the rock above it leaned out over a floor that was flat and dry and out of the wind. He was standing in it as he was always standing in the place where they would stop, before anybody had said the word.

"Here," he said, which was the whole report.

Cael wrote.

At every halt, on the cart's tail-board or his knee, as he had written in a notebook at the edge of every bout he had ever watched: the width at the narrow, in Karis's number and then in his own paces to check it; the count of narrowings from the fan — one, two, three by the first camp; where Seln had stood. Nothing on the mountain asked him what he was. It was the exact shape of a thing he had done for nothing for four years, except that at the far end of it there was a ford and seventy marks and a man who would read it.

---

*Seventy-third day. The bench, first camp. Three narrowings from the fan, none under a cart's width.*

*Inventory. Nine confirmed, one anomaly, patience. Eighteen. Deployment since the Line: one, the ford, paid. Nothing drifting. Anchor wanted the inn door; there is no door up here. Calf: nine uphill, and the whole fan was uphill, and it's a leg again on the flat. Sixty-two marks earned. Forty-six in hand after the cart.*

*Lira runs it before we walk it. Karis has a number for everything and a drawing that looks like nothing. Brom says the cart floats. I've written eleven widths since noon and none of them mine, and it's the first day of my life I've been paid by the line.*

*The gorge says everything back late. That's the only loud thing on this mountain. Us, twice.*

---

He saw the first of them on the second day because it moved.

They had come round the fourth narrowing — a cart's width and a hand, Karis's cord said, with the outer edge crumbling — and the bench opened again beyond it, and on the upper shelf two hundred meters above, where the green was, a piece of the mountain lifted its head.

Lira, ahead, had stopped with a hand up; the cart stopped behind him with Brom's breath going out of it.

The colour of the shale, which was why he had not seen it. Then, because he knew what he was looking for, the next one, and the next, and he counted them as he counted a crowd, left to right and again, and got twenty-nine and then thirty-one and then thirty, and kept thirty. Thirty animals along the upper bench, every one of them with its face down against the rock. Plated across the back in slabs that overlapped like the stone of a roof, grey going to rust as the shale went; the head small and low for the body and the legs short and thick under it; each one, by the eye at that distance, the size of the cart with its load and Brom in the shafts. They were eating lichen — the green was lichen, on the upper shelf where the wind did not scour it — and the sound he had taken for the gorge since the narrowing was them: a grinding, patient and low, thirty sets of teeth on stone, coming down to the lower bench and then back from the far wall, late.

Placid was Pike's word for them, by Seln's report, and from below it was the word: they looked like animals that had not been consulted about anything in a long time and had not minded. Nothing about them had noticed a cart.

"Shale-backs," said Seln, from ahead, low, in the road's own quiet. "Pike's rule. He said it twice, so I'm saying it twice." He was not looking at the herd; he was looking at the bench under them and the bench above. "Never be below them. Never be *loud* below them."

Cael looked up at the herd and down at the shelf they stood on and did the arithmetic the rule required, which was short. The route was the lower bench. The herd was on the upper. There was no walking this traverse that was not walking below them; the first half of the rule was a thing Oxhollow's carts would break every autumn by taking the road at all. The first half was a carter's wish. The second half was the job.

"They'll follow the lichen," said Karis. She had the book open and was not writing in it. "That's the whole shelf."

"Then they follow it," Seln said. "Above us. All the way."

Karis said, without heat, as one asks for a thing already paid for: "I want a day."

He said yes because a day of her looking had always been worth more than a day of anything else, and for one reason more, which he did not say: he wanted the day too. Thirty of a thing nobody had a page on, standing still in good light. He had never in his life been given a day to look at anything that was not about to hit him.

"Tomorrow," he said. "Here. Seln?"

Seln looked at the overhang a hundred paces on and said "There," and it was a camp. They walked under the herd for the rest of the afternoon and the herd did not look at them once.

---

*Seventy-fourth day. Second camp. Five narrowings. Thirty shale-backs on the upper bench, two hundred meters up by the eye. Armoured. The size of the cart. They eat lichen off the rock and the sound of it comes across the gorge twice. Placid is Pike's word. Mine is that they haven't noticed us, and I don't think it's because we're quiet. I think a cart is nothing to them.*

*Seln quoted Pike: never be below them, never be loud below them. We are below them. Every cart Oxhollow ever sends will be below them. So the rule out here is the second half, and we've been keeping it since the Line without knowing it had a second half. Karis gets tomorrow. So do I.*

---

Karis sat on a flat plate at the camp's edge with the herd above her and the book on her knee and did not move for the first hour except her eyes.

He sat a length from her with his own book and catalogued the herd as he would have catalogued a fighter he was going to have to watch for a season: how they stood; what they did with the weight; what a head did before a body moved. Thirty animals, and not one of them made a movement in an hour that he would have called a decision. Lira had the day too, on the cart's tail with the boot off and the ankle in the sun.

Karis read out what she saw as it went in, to nobody.

"Spacing. Never closer than a body. Never further than three. Thirty, and the spacing holds." A while. "They've moved. The whole line's a length along the shelf from where it was at dawn. I didn't see one of them move. I saw the line be somewhere else."

At noon Brom let the tail-board go, and the bang came back off the far wall, and thirty heads did not lift. An hour after that a rock came off the mountain, loud on the way down, and went through the herd's line between two of them and into the gorge. The two it had passed between stepped a body's width from the place. Then they stepped back. Then they ate.

"Sound and a rock," Karis said. "Nothing. That's not flight. That's a step. The carters didn't make a rule about a step."

The thing she was waiting for came in the middle of the afternoon, and it was small.

An animal at the shelf's outer edge had its weight on a plate that had been holding its weight all day, and the plate tilted. Not far. It went a hand's width at the outer side and slid its own length down the shelf's pitch with the animal on it, as a floor-board goes when the joist under it is gone — and the animal walked off it, uphill, without hurry, and the plate stopped against the next plate and lay there.

The herd moved.

All of it. Thirty animals, along the whole length of the upper shelf that he could see, took a body's length uphill at the same moment, without a head coming up, without a sound that reached him, as if the shelf had been a table and somebody had tilted it and every cup on it had slid the same way at once. Then they stopped. Then they ate.

Karis read it out as it went in.

"A plate went under one at the outer edge. It stepped off, uphill. The herd went uphill, one length, all at the same time. No leader. I've been looking for one since dawn and there isn't one; there's no animal that moves first. They moved as a unit. Away."

"Away from what?" said Lira, from the cart.

"From where the ground went." Karis got up and went to the cart. The three boxes rode roped at its front, the foremost over the axle where Brom kept it, the middle one with a corner worn white where the rope ran; she untied nothing and put her hand under the middle lid and came out with the one thin page in Cael's hand that was the whole of her shelf on this side of the Line, and laid it beside the day's page. There was a rumor with two lines under it in that box too, near the bottom, and she did not take it out.

"The ford," she said. "Read it to me."

He read it, because it was in his hand. "They hunt discharge. They're near-blind to a still body. They turn as one to the loudest declaration, and otherwise to the loudest sound. Water masks it. They break toward whichever hound moves first."

"Whichever moves first." She put her scarred finger on the day's page, on *no leader*. "Those turn as one to the loudest thing and then follow the first to go. These go as one and there's no first. Same shape, upside down. Now the rule. Seln."

"Never be below them. Never be loud below them."

"Loud." Karis said it as a word she was weighing. "A rock off the mountain is loud. A tail-board is loud. They stepped. A step doesn't kill a cart, and the carters didn't make a rule about one. So *loud* in the rule isn't what a rock does. What does a carter mean when he tells a crew to shut up?"

Nobody had to say it. Brom said it anyway, because it was the shortest way. "Don't declare."

"Don't declare. The ford taught us what out here means by *loud*, and it isn't sound. The dogs hunt it. The carters walk quiet through the dogs' country and they walk quiet under these, and it's one word, and I'll enter that the word means one thing. Derived. The herd senses discharge — the ford's sense. The herd's answer is the ford's answer with the sign changed: a hunter comes to it; a grazer goes from it. Flight, not hunt. As a unit, with no first animal, so all thirty at once. Away from the declaration." She stopped the pen. "They went uphill from the slip because the slip was below them. If the loud thing is below them—"

"They go up," said Lira.

"And if it's *above* them."

Seln answered as he answered everything. "Then they come down."

"Thirty of them," Karis said. "The size of that cart. On this." She did not point at the shale; she did not need to. "On a slope, flight is a landslide with legs."

The gorge gave the last of it back to them, late, smaller.

She entered the rest with the pen going and her voice flat. "Not seen. Not tested. Not going to be tested; there's no trial I'd run under thirty of anything on scree. Entered as derived. If it's wrong it's wrong in the direction of being careful, and I'll take that." She underlined *derived* once. "That's the day."

"That's the rule," Seln said, "with the reason on it."

Karis closed the book with the ford's page inside it. "First primary source I've had on this side of the Line. It's got a hundred and twenty legs and it doesn't know I'm here." She looked at Cael. "Write it in yours, too. I'd like it in two hands."

He wrote it in his, beneath the count of thirty, and beneath that the thing she had not said: the ford had been theirs because they had known the rule before the dogs came out of the water, and this was the same kind of knowing, arrived at sitting down.

---

The bench narrowed on the fourth day.

Six, seven, eight — Karis's cord at each, and the widths coming down: a cart and a half, a cart and a hand, a cart. At the eighth the outer edge was not crumbling, it was gone, a clean break where a length of the shelf had let go some season past; Lira ran it first, twice, and came back and said *it holds a runner* and did not say the rest, and Brom took the cart across it with the down-slope wheel a hand from nothing and his whole weight on the up-slope shaft and his face shut, and it went across, and the tail-board did not bang, because nobody let it.

The herd came along above them. It drifted with the lichen, at the pace a cart makes on scree, which is not a pace; it was above them at every halt and above them at the next, thirty grey backs on the green, as if the contract had hired them too. They did not look down. They walked it as they had walked it since the fan: Lira in hundreds, Karis in numbers, Brom against the strap, Seln somewhere ahead in the place they would sleep, and the whole of it quiet in the one way that mattered, which none of them had to think about anymore and every one of them was thinking about.

He wrote at every halt. The widths. The count. The herd's position, by the narrowing it stood above. He was twice as careful with a page that somebody would pay for as he had ever been with one that nobody would.

The fourth camp was an overhang again, because Seln found overhangs. The fire was small. Lira taped the ankle by it, as she did at night now as well as in the morning, and nobody said anything about it.

---

*Seventy-sixth day. Fourth camp. Eight narrowings; the eighth is a cart and no more, and the edge is a break, not a crumble. Karis has it in the book with the break drawn. Two-thirds of the way by Pike's count of days, a little under by mine.*

*The traverse holds. So far. The map's good — Karis's, not mine; mine's the check. The herd's above the eighth narrowing tonight, thirty, grazing along. Karis says they go off declarations, as a unit, away, and on a slope away is down; which means the loudest thing on this mountain is us, and we've been quiet four days. Not one of us has had to try.*

*Nothing's drifted in four days. I'm writing that as a fact and not as a meaning. First honest job I've ever had that didn't have a fight at the end of it. I'm writing that before it's finished, which I don't do. Note that I did.*

---

The fifth day showed them the ledge.

They saw it from the ninth narrowing in the last of the light, because the bench had bent round a shoulder of the mountain and given them the next stretch whole: the shelf running on along the face, a cart wide, then less than a cart, then — a long way ahead, where the mountain bulged out over the gorge — pinching down to a lip that was, at that distance, a line. A ledge. Below it, the gorge, wider there than anywhere they had seen it. Above it, the upper shelf, coming round the same shoulder with the herd on it, thirty backs on the last green, above them and — he counted the narrowings back — behind them now, for the first time, by half a day's grazing. Beyond the ledge, the bench opened again and went on toward Oxhollow.

Karis stood with the cord in her hand and did not run it across anything. "I can't measure that from here. Morning."

"Here," Seln agreed, and it was, of course, an overhang.

Two-thirds. He did the count on the tail-board while the fire was lit: nine narrowings in the book with their widths; Pike's seven or eight days for a cart, and five of them walked. A map a hold could put a cart on, for two-thirds of a mountain. The last third began with a line.

Lira sat down by the fire before anyone and took off the boot.

She did it as she had done it every night on the bench: the day's cloth unwound and laid across her knee, the ankle turned in the firelight as far as it would turn, which was less than the other one, and later; and then the night's strip, from the arch up over the joint and off at the shin, pulled tight, tied. It was the ankle that had never been seen by anyone who could do more for it than boil the cloth. She had not stopped taping it.

She tied it off and looked, not at any of them, at the shoulder of the mountain with the ledge on the far side of it.

"I'll run it at first light," she said. "See if it holds a cart."

Brom, from the strap, which he had not taken off: "It'll hold you."

"It'll hold me, and I'll know what it holds." She put the boot on over the tape and stood on it, once, to feel where it bent. "That's what I'm for up here. That's the job. First light, before the sun's on it."

Nobody argued. It had been the plan at every narrowing since the fan, and the ledge was a narrowing with a name.

Seln was looking up the mountain at the herd. Brom took the strap off at last and sat with the bound arm inside the good one. The gorge gave the fire's small noises back to them, late, from across the gap.

He took the log out.

---

*Seventy-seventh day. Fifth camp, at the ninth narrowing. The ledge is in sight; Lira runs it at first light.*

*The traverse holds. The map's good. Karis says the herd moves off declarations, which means the loudest thing on this mountain is us, and we've been quiet for five days. One more day. First honest job I've ever had that didn't have a fight at the end of it. Sleep.*
...
# MANUSCRIPT — v3-runs/book-07/drafts/ch06.md

# Chapter 6 — Shale

The herd had come round the shoulder in the night.

He counted them from the root of the ledge in the grey before the sun, because counting was the first thing he did with anything, and got thirty. Thirty backs on the upper shelf, two hundred meters up by the eye, along the last of the green above the bench. At dusk they had been half a day behind. Now they were above, and moving: not the drift of four days but a walk, thirty heads down, the whole line going along the shelf at a man's pace toward the bulge, where the upper shelf pinched out against the mountain as the lower one did. The green ended there. The grinding came down to the bench and did not stop.

"They're eating toward the end of it," Karis said. She had the cord in her scarred hand and her eyes on the ledge, which the sun was not on yet. "When it ends they turn round and come back over us. I'd like the cart across first."

"Then I'll run it," said Lira.

They had walked the last of the bench in the dark for that. She had taped the ankle at the camp by feel and put the boot on over the tape and said nothing about either. Now she stood where the shelf became a lip along the mountain's bulge: a cart wide for ten paces, then less, then a ledge the width of a door running out over nothing toward the place where the bench opened again and went on to Oxhollow. Below it the gorge was wider than anywhere they had seen it.

Brom had the strap on and the cart's tail a length back from the ledge's root, the three boxes roped at its front, the down-slope wheel a hand from the edge. Seln was not looking at the ledge. He was looking back along the bench at a thing Cael had walked past in the dark and catalogued as the one object on the traverse that was not a plate: a fin of darker stone standing out of the mountain at the bench's inner edge, forty paces behind them, a man high and three carts long. Seln looked at it as he looked at the places they would sleep.

Lira went out.

Not a run; she read it with her feet first, ten paces at a walk with a hand on the mountain, then the hand off and the walk going to the thing she did between a walk and a run, the ankle taking it. The ledge held a walker. She stopped at thirty meters and turned to come back at a run, because shale that held a runner held a wheel, and that was the word Oxhollow was paying for.

She took two strides.

He heard it before he saw it. The whole ledge under her, from her boots to a length ahead, made one dry note, a plate going in a kiln, and then it was not a ledge. It was three carts' length of the mountain's edge going down into the gorge together, slowly and then not, with her on it.

She did what her body had been doing since she was fourteen.

He had watched her burst four hundred times and owned a piece of it. It was not loud to the ear, or not only: air went somewhere all at once, a clap without the hand, and she was not where she had been. This one was not that. This was Wind, hers, Iron Rank 1 and everything the rank had, the whole declaration spent at once, upward and back, and it crossed the gorge. He felt it cross. The far wall gave the clap back a breath later, smaller, and by then she was on the bench beside him on her hands and one knee, with the ledge gone from under the place she had been standing.

Two hundred meters up, thirty heads came off the rock at once.

---

He did not see them turn. He saw the line be a different line, every back on the shelf pointed away from the ledge, away from the loudest thing that had happened on this mountain in three seasons, and then the line was running, and Karis had been right and wrong in one sentence. A step went uphill. A run did not: the shelf could not hold thirty animals the size of the cart at a run, and the outer plates went out from under the first of them, and the herd came off the upper bench down the face of the mountain in a front two hundred paces wide, on its feet, with the shale coming with it.

A landslide with legs. It was the exact sentence.

"There." Seln, already moving, the arm out along the bench behind them at the fin. "Thirty seconds. Lee side."

He ran. They all ran, back the way they had come, and the arithmetic ran with him: forty paces on the roof-pitched shale, thirty seconds, and above them a sound that had stopped being a grinding and was the mountain coming down at a walk. Brom was past the cart, and then his head turned, and he had done the sum.

"Cart's gone," Brom said. Not loud. He was running when he said it, and the cart stood where it stood, at the ledge's root under the herd's line with the three boxes roped to its bed. "It's between. No time."

Nobody argued. Karis, ahead, did not look back at the cart, which was how he knew she had heard.

The fin came up. He got into the shale in its lee with his shoulder to the stone and Seln's hand on his collar putting him lower, and Brom came in over him, and Karis did not come in. She stopped at the fin's up-slope end, in the open, with her back to the rock and her face to the mountain, and put both scarred hands up in front of her.

"Karis—"

"They go from it." She said it to the mountain. "Seln. Do they."

"They go from it."

"Then they'll go from this."

She lit the line.

She did not light a point, the single ignition he had watched her make a hundred times. She laid the lattice out in a line, the whole length of the face above the fin and past it either way, twenty paces, thirty, a row of points so close together they were one thing, a wall of ignition standing across the mountain at the height of a shale-back's head, between the fin and everything coming down. It was a declaration the size of a road.

The herd hit it and split.

The front came down the face at a gallop with the mountain under it and met a line it had to turn from, and it turned, as water turns at a stone, half left and half right, at a distance he measured afterward at eleven paces from the fin's face and could not have measured then, because there was no distance; there was a grey wall going past his shoulder at the length of his arm with plates the size of doors coming off it. The noise was inside the stone at his back. The herd went past on both sides of the fin, the down-slope half with nothing under its outer feet but the bench and then the edge, and some of it went over. He heard that: a different sound, and the far wall not giving it back. Most of it did not, and turned along the bench, and went.

He counted eight seconds because he was counting, and at the eighth Karis's hands came down.

The line went out with them. She sat where she had been standing, all at once, as a rope-end drops when the hand lets go, and put her back to the fin and her scarred hands in her lap and looked at nothing with her mouth open. He had seen her spent before. This was not spent. Spent was a jar with a little left in it. She had lit a road with a jar.

The first half of the herd was past. The sound had gone along the bench and away; the face above the fin was, for a breath, empty of anything but shale still sliding; and Brom was already up.

---

"Two are mine," Brom said, and went.

The cart stood forty paces on at the ledge's root, where the first half had not reached. The second half was coming down behind it at the slant the line on the shelf had run: further along, later, and further along was the ledge, and the cart. He could see them, fourteen or fifteen animals, a front coming down the face at the cart in a sheet of moving plates, and he could see Brom under them, running down the bench with the bound arm loose, and he could count the seconds.

He went after him. It was not a decision he watched himself make; it was his feet. It was the stupid thing, done on purpose, by people who did it for each other, and he knew it, and it did not slow his feet.

Brom hit the cart's tail and did not untie anything. He put the good hand under the front box and the bound arm under it too, and pulled, and the rope held against Brom for half a second and then did not, because the hand that was allowed to hold and not pull had pulled. Brom turned with the box against his chest and heaved it up-slope out of the herd's line, a length, two, and it landed on its side in the shale and stayed. The second box came off the same way. Cael heard the wrist go; he knew the sound of a thing coming open under cloth. Brom did not heave this one. He ran it.

The third was the middle box, the one with the corner worn white, the one Karis had put her hand flat on at Lowmarch to see whether it was warm.

He had it by the rope and the rope did not give and he had a knife and used it, and the box came into his arms heavier than it had any right to be, paper being heavy, and the first animal of the second half came onto the bench a length from the cart.

Compression wanted him. He felt it want, where it had been wanting since Reydan: take the force, turn it, walk away from it. Anchor wanted the cart, a fixed point under the axle, the cart nailed to the mountain and the boxes with it. He had a hand's breadth of a second to price both. A declaration under a herd that was going from declarations, at the one place on the bench where the split was still holding, and the split was Karis's; it stood on her line and nothing else. One more loud thing under the second half, here, and the second half turned again, and the fin was what it turned toward.

He held. He took it raw.

The shale-back did not see him. It was not built to. It came past the cart at a gallop with its head down and its shoulder came round with it, a plate of armour the size of a tail-board moving at the speed of a falling thing, and took him under the arm on the left side while the box was in front of him, and he went where it put him.

He was on the ground in the fin's lee with the box under him and his face in the shale, and he was catalogued before he could see.

Three ribs. Left side, low, under the arm. He knew the number as he had known Lira's count at the circuit, not by looking, by the shape of what the breath would not do: the first breath stopped at a place and the second stopped at the same place, and there was a give in the wall of him that was three wide. Not four. Three.

And the calf. The right calf, bitten through at the ford and mostly closed, had opened along the shale where he had gone down on it, and he felt that only afterward, as he had felt the bite only when the water went cold.

Behind him the cart went. He turned his head, which he could do, and watched it.

The second half came past it, and the cart did what Brom had said a cart did on scree, which was float: a finger's width at every turn of the wheel, and then not a finger's width. It went sideways along the bench in the shale that was moving under the animals, and its down-slope wheel went out over the place where the bench was no longer, and it tipped as if considering it, and went into the gorge with the shafts up.

He counted the second half past the fin: fourteen. Then the sound going down the mountain toward the fan, and the shale still coming down, plate on plate, settling, and the gorge giving the last of it back, late.

---

Lira came in last.

He had lost her at the ledge's root when he ran; everyone had. Now the bench was a different bench, plated over new to the edge, and she was forty paces off where she had landed, and she was coming on her hands.

Seln went out to her. Cael saw him go and could not have.

She had gone for the fin when they went for it, on the ankle that had gone at the ford and gone again when she landed; he pieced that afterward from the marks in the shale. What had come down on her had not been an animal. It had been the bench: a plate going out under her foot as the second half came down and the whole shelf shifted, the leg going into the gap it left, and the plate above it coming down on the leg with the mountain behind it. The plate was still there. Seln lifted it off. Under it the leg below the knee was the wrong shape. Not bent; the wrong shape, a line with an angle in it where there was not supposed to be an angle. The foot at the end of it had no boot. The ledge had taken the boot. A strip of tape was still round the ankle above the bare foot, tied off at the shin.

She did not make a sound coming in. Seln carried her most of it. She looked at the leg as she had looked at the ankle at every fire on the bench: turned it in her head as far as it would turn, and then looked.

"That was me," she said, when Seln had put her down. Not to any of them. To the bench. "The loud thing."

Nobody said it was not.

"It was the ledge," Karis said, from where she sat with her hands in her lap, in a voice with nothing behind it. "The ledge went. Then it was you."

"Then it was me." Lira put her head back against the stone.

She did not say it again. She had put it in its order, and the order was right, and nobody on the bench took it from her.

---

Inventory, taken in the fin's lee on the seventy-eighth day, in his head, because his hands were under him.

Lira: the right leg broken below the knee, the shape wrong and the skin whole, the foot bare, the ankle under the break gone twice and not the largest thing in the leg anymore. Seln straightened it as far as it would go, with Brom holding her and her own hand in her mouth, and it was not straight. Two plates of the mountain went either side of it, and Karis's cord round the plates from knee to ankle, tight, so that the leg was a thing in a box. She did not faint, and he had never seen her work so hard at anything.

Brom: the right forearm open again at the wrist under the cloth, the cloth dark and getting darker, the hand that had pulled two boxes off a cart hanging useless at the end of it. He rewrapped it himself over the old cloth, one-handed, with his teeth. He said the boxes were fine. He had checked them first.

Karis: nothing broken, nothing cut. Empty. She had sat down at the eighth second and had not stood since. She slept where she sat before noon, in the sun, with her head on the middle box.

Seln: unmarked, which from Seln was a report in itself.

Cael: three ribs, left side, low. Eighteen. Nine confirmed, one anomaly, none of it spent, all of it wanting. The calf Seln washed and bound with the last of the boiled linen from Thornwater, and he did not count paces, because he was not walking anywhere.

Five. Two of them could stand.

The cart: in the gorge, with the road food that had ridden under the boxes and the smith's six marks. The boxes: three, in the fin's lee, on their sides where they had landed and been carried, roped shut still, not one lid sprung. Karis had checked that before she checked her own hands.

The herd: sixteen past the fin in the first half, fourteen in the second, three he had heard go into the gorge and could not swear to. Twenty-seven down the mountain toward the fan.

The map: in Karis's book, in Karis's satchel, on Karis. Nine narrowings and their widths, and now a tenth, which was not a narrowing. It was an absence. The ledge was gone for a cart's width along three carts' length; what was left was a lip against the bulge that a walker could take with her hands on the rock, and a mule could not, and Oxhollow's carts would not, ever. Seln walked out along the lip in the afternoon and came back at dusk and said it went; that beyond the bulge the bench opened as they had seen it open; that for a walker Oxhollow was two days on.

"And a healer?" Cael said, because it was the sum.

Seln had it. He had asked at Thornwater about the thing the steading's woman had said: *the nearest walks a route and she's not due.* Oxhollow had no healer of its own. The nearest was a woman who walked a circuit of the holds and was wherever on it she was. A man at Oxhollow in two days could send a carter along the void road to find her, and that was four days from any place on this mountain in any direction, counted generously.

"Four days," Seln said. "If she's near. First light tomorrow, I go."

"Tonight," said Lira.

"Tomorrow." Seln did not look at the leg. "The bench is new. I'll not walk it in the dark for a healer who isn't there."

That night the fire was a small one, lit with a flint, because the woman who lit fires was asleep against a box. Brom did the food, which was what had been in the packs and not in the cart: a day and a half at the ford's rate for five, and Brom made it three at a rate he did not explain. Cael lay on his right side in the fin's lee with the box for a pillow and counted the breaths that stopped at the place, and did not take the log out, because he could not have held it and did not want to see the hand.

---

The second day came up grey, and the sound of the gorge came up with it.

Seln had his pack on before the light. He stood at the fin's end and looked along the bench toward the ledge's root and the lip beyond it, and did not go, and Cael, lying on the ribs with the day's first breath stopping where the others had, followed his eyes.

There was a mule on the bench.

It stood beyond the bulge, where the shelf opened again, small against the grey, with panniers on it, and a rope from its head going to nothing, because the nothing was a woman on the lip. She came along it as Seln had, one hand on the mountain, at a walk that did not change at the narrow place or the wide. She came off the lip where the cart had stood, looked at the new shale and the fin and the five of them in its lee, and came on at the same walk.

Nobody reached for steel. Seln, who reached for it before anyone, looked at her hands and did not.

Late twenties. A square face, wind-marked; a carter's coat; a pack, and a leather roll under one arm. Her hands were the first thing he catalogued after the walk, because she came in with them out of her sleeves and open: square, short-nailed, the knuckles scarred over old, clean in a way nothing else on the mountain was clean. She looked at the five of them once, all together, as he looked at a board. She did not ask who they were.

"Who's worst?"

Lira said "Me" at the same moment Brom pointed at Lira with the wrapped hand, and the woman was already on her knees at the leg with the roll going down beside her in the shale.

"Name's Oryn." She said it to the splint. "Tide. Healer." She had the cord off the plates and the tape off the ankle before anyone had moved to help her. "A carter came into Oxhollow off the void road two days back at noon and said the shale-backs had come off the mountain onto the low road at a run, and the crew that was up on the traverse was overdue off it. I was at the ford." She looked up, at Lira. "When."

"Two days back. First light."

"Anyone touch this?"

"Straightened it," Seln said. "As far as it went."

"Then it went as far as it went. That's not straight." Her hands were on the leg, above the break and below it, and then they were still, and it lasted the time it took Cael to draw one of the breaths that stopped. Seconds. He had watched assessors go still like that over a page; never a healer over a leg. Then her hands came off it.

"Tier," said Seln, from above her. The professional's question, in the professional's voice.

"Iron. Four, if anybody's keeping a book up here." She did not look at him. "Broken through. Both bones. Two days old. Somebody's ankle under it has been wrong for a month." She said it to Lira as a list. "I'm going to set it. That's the part you'll mind. Then I'm going to mend it, and you'll mind that less. Big man: knee. You" — Seln — "shoulders. Both hands."

Brom took the knee with the good hand and his weight. Seln took Lira's shoulders. Oryn took the foot and the shin in two hands and did not say *now*, and did the thing.

Lira did not scream. She made a sound he had not heard her make in four years, once, and bit it off; and the leg below Oryn's hands was a line again, a line with no angle in it, and Oryn held it there and did not let it go.

"That's set. Don't move."

Then she mended it.

He had been under four healers in four years. A bone set was a bone set: hands and a splint and a season, and the healer's Path took a week off the season and charged for it. He had never once seen a bone knit. It happened inside a leg over months, out of sight.

He watched it happen in a quarter of an hour.

She had both hands on the leg, one above the break and one below, and the nearest word he had was that she was pouring, without anything moving. Lira's face went a colour that was not white, and she said "Cold," not to anyone, and then "No. It's going along," and put her head back and shut her eyes. The swelling at the break went down. It did not go down as a swelling goes down over a night. It went down as water goes out of a basin when the plug is pulled, in the time it takes to watch, and the skin over the place lay flat, and the two lines of Lira's shin, the wrong one and the right one, were one line, and stayed one line, and Oryn's hands came off it.

The leg was straight. From her knees going down in the shale to her hands coming off, he made it less than an hour.

Her face had gone the colour of the shale. Grey, wet at the temples in the cold, the mouth set as a mouth sets that is holding a count. She sat down on the bench, all at once, as Karis had sat down at the eighth second — no. Not as Karis. Karis had dropped as a rope drops. This woman sat down as a carter sets down a load he knows the weight of to the pound, and will pick up again, and would rather not yet.

"That's one," she said. To nobody. She drank from a skin, a long time. Then, to Lira: "Weight on it tomorrow. Not today. The bone's whole; it's new. It'll ache for a season and hold for the rest of your life. The ankle under it I've not touched; I've not got it in me this morning, and it's not going to kill you. Somebody tape it. You'll know how."

"I know how," Lira said, with her eyes shut.

"Hands on. That's the only way it works." Oryn said it as a thing she said often, to a room, before anyone asked. "Two years on these roads and I've never done a thing to anyone from over there. And I can't do it to me." She got up, which took her two tries. "Arm."

---

Brom's arm took less. He sat with the forearm across his knee and the cloth off it, the wrist open in a mouth two fingers long, and she put her hands either side of the open place, and went still for the seconds, and said "Iron Skin," and Brom said "Yes," and she said "Then it should have closed in a month and hasn't, because you've pulled on it. Dogs?" and Brom said "Dog," and she did not ask anything else. It took the time it takes to eat an apple. The mouth at the wrist closed under her hands as the leg had, and when she took her hands off, the arm from wrist to elbow was a raised dark line and nothing else, and Brom looked at it with the lock face and then, for once, without it.

"Don't pull on it for a week," she said. "It's not a dog's business now. It's yours."

She had gone greyer, and sat again, not long, and Cael counted that she had drunk half the skin.

Karis was awake, against the box. She had watched the leg and the arm with the look she gave a primary source, and she said, when Oryn came to her, before Oryn had knelt: "There's nothing wrong with me."

"I'll be the one who says that." Oryn knelt anyway and took both the scarred hands in her own, palm up, and did not ask about the two raised lines across each, and went still. Seconds. She let the hands go.

"Ember," she said. "And nothing. You're empty. That's not a hurt; I can't put back what you spent, and I wouldn't if I could. Eat. Sleep. It fills." She looked at the black line the lattice had left across the face above the fin, thirty paces of scorched shale, and she looked at Karis, and there was no awe in it at all. "That's yours?"

"That's mine."

"Hm." The whole of the verdict. She stood.

He had the log out by then. He had got it out of the satchel with the right hand while she was at Brom's arm, and had found that he could hold the pencil if he did not breathe past the place. He wrote one line. It was not his hand. It was a hand that hurt, and it leaned, and it was legible.

*Eightieth day. Lira's leg is straight. The boxes are ours. The cart is in the gorge. A healer came up the road because a carter said we were late.*

He closed it. She was standing over him.

---

"You," she said. "Ribs. I saw you breathe."

"Three. Left side. Low."

"I'll be the one who says that." She knelt in the shale at his side and did not ask him to move, and put both hands on him, one flat on the ribs where the shoulder had taken him, one on his back behind it, and went still.

Seconds. He counted them. He watched her face because it was the thing in front of him: the face of a woman listening for a thing she had heard a thousand times, as a fighter listens for a step behind him.

She stopped.

Not as she had stopped at the leg or the arm, at the end of the seconds, with the finding ready. She stopped in the middle of them. Her hands came off him. She looked at her hands, both of them, palm and back, as a man looks at a tool that has done a thing it has never done. Then she put them back, exactly where they had been, and went still again, and held it longer, and her face did a thing.

He had watched that thing on faces for four years. At fourteen, for eleven seconds, from the inside. On assessors' faces at Ardenmere and Greyvane, and on a panel at Halcenvane, from the outside, over a page with his name on it and a bracket after it. It was the face of an instrument that has been put to a thing and has returned nothing, not a wrong number, no number, and is running itself again to be sure. He had never once seen it on a healer. Healers did not read the page. Healers read the leg.

She took her hands off him and did not look at them this time. She looked at him.

"Your ribs are broken," she said. "I can feel that they're broken. I can't feel *you*."

Nobody moved. Lira's eyes had opened. Karis, against the box, did not move anything but her eyes.

"Whatever you are, I can't read it." It was said as the leg had been said: a list, exact, at the pace of a woman who did not hurry a finding because the finding was bad. "I've never said that to anyone. Tape them. They'll heal on their own." A breath. "They always have, haven't they?"

"Yes," he said.

"That's not an answer," Oryn said. "That's a *finding*."
...
# AUTHOR REPORT — v3-runs/book-07/reports/ch06-author-r1.json

{
  ...
  "obligations": [
    {
      "obligation": "must_include: The collapse and Lira's own Wind declaration saving her and triggering the herd; the herd's downhill flight staged with Chapter 5's rule as the cause.",
      "status": "MET",
      "evidence": "The ledge goes under her in scene: 'The whole ledge under her, from her boots to a length ahead, made one dry note, a plate going in a kiln, and then it was not a ledge.' Her own Path, full: 'This was Wind, hers, Iron Rank 1 and everything the rank had, the whole declaration spent at once, upward and back, and it crossed the gorge.' The herd's response is Karis's Chapter 5 finding applied: 'He saw the line be a different line, every back on the shelf pointed away from the ledge, away from the loudest thing that had happened on this mountain in three seasons, and then the line was running, and Karis had been right and wrong in one sentence. A step went uphill. A run did not: the shelf could not hold thirty animals the size of the cart at a run ... and the herd came off the upper bench down the face of the mountain in a front two hundred paces wide, on its feet, with the shale coming with it.' followed by 'A landslide with legs. It was the exact sentence.'"
    },
    {
      "obligation": "must_include: Four exchanges as in scene_shape with the mountain as terrain (ledge, downhill herd, the outcrop the herd splits around, the cart between, the gorge): at least two beats CAUSED by terrain; geography drawable at each pause.",
      "status": "MET",
      "evidence": "Geography fixed before the action: the fin 'forty paces behind them, a man high and three carts long' at the bench's inner edge; the cart 'a length back from the ledge's root'; Lira 'at thirty meters' out on a door-wide ledge; the herd two hundred meters up. FIRST (Seln): '\"There.\" Seln, already moving, the arm out along the bench behind them at the fin. \"Thirty seconds. Lee side.\"' SECOND (Brom): '\"Cart's gone,\" Brom said. Not loud. ... \"It's between. No time.\"' / 'Nobody argued.' THIRD (Karis): the lattice-line above the fin and the split. FOURTH (the boxes): Brom back for the cart, Cael after him. Terrain-caused beats: the ledge letting go (the collapse itself); the shelf that cannot hold a run turning flight into a landslide; the fin as the only ground ('Lee side'); the split measured 'at eleven paces from the fin's face'; the cart floating on moving shale over the edge ('its down-slope wheel went out over the place where the bench was no longer'); Lira's leg broken by a plate shifting under the herd, not by an animal. Positions restated at each pause (Cael in the lee, Seln's hand on his collar, Brom over him, Karis at the up-slope end in the open; the cart forty paces on)."
    },
    {
      "obligation": "must_include: Karis's lattice-line above the outcrop and its eight-second cost (drained to nothing); the herd splitting within arm's reach.",
      "status": "MET",
      "evidence": "'She laid the lattice out in a line, the whole length of the face above the fin and past it either way, twenty paces, thirty, a row of points so close together they were one thing, a wall of ignition standing across the mountain at the height of a shale-back's head, between the fin and everything coming down. It was a declaration the size of a road.' / 'The herd hit it and split.' / 'there was a grey wall going past his shoulder at the length of his arm with plates the size of doors coming off it.' / 'He counted eight seconds because he was counting, and at the eighth Karis's hands came down.' / 'Spent was a jar with a little left in it. She had lit a road with a jar.' Win sentence carried in the prose: the herd 'met a line it had to turn from, and it turned, as water turns at a stone, half left and half right.'"
    },
    {
      "obligation": "must_include: The boxes: Brom back for the cart, Cael after Brom, two boxes then the third; Cael's three ribs and reopened calf; the cart into the gorge; Lira's leg broken below the knee, her boot taken by the ledge; Lira's knowledge that she caused it, held without melodrama.",
      "status": "MET",
      "evidence": "'\"Two are mine,\" Brom said, and went.' / 'He went after him. It was not a decision he watched himself make; it was his feet. It was the stupid thing, done on purpose, by people who did it for each other, and he knew it, and it did not slow his feet.' Two boxes off (the bound arm pulling; 'Cael heard the wrist go'), then 'The third was the middle box, the one with the corner worn white'. The shoulder: 'took him under the arm on the left side while the box was in front of him, and he went where it put him.' Ribs catalogued: 'Three ribs. Left side, low, under the arm. ... there was a give in the wall of him that was three wide. Not four. Three.' Calf: 'The right calf, bitten through at the ford and mostly closed, had opened along the shale where he had gone down on it'. Cart: 'it tipped as if considering it, and went into the gorge with the shafts up.' Lira: 'Under it the leg below the knee was the wrong shape. Not bent; the wrong shape, a line with an angle in it' / 'The foot at the end of it had no boot. The ledge had taken the boot.' Her knowledge, held: '\"That was me,\" she said ... To the bench. \"The loud thing.\"' / 'Nobody said it was not.' / '\"Then it was me.\" Lira put her head back against the stone. She did not say it again. She had put it in its order, and the order was right, and nobody on the bench took it from her.'"
    },
    {
      "obligation": "must_include: Oryn's arrival on the second day (Oxhollow road, mule, kit, a carter's word); introduced through her hands and her questions ('Who's worst?'), no backstory beyond one sentence; Lira's leg set and mended inside an hour with visible cost; Brom's arm; Karis (empty); then Cael — the surface reading returning nothing beneath the break, and her lines as given (the finding), with Cael's 'Yes.'",
      "status": "MET",
      "evidence": "Second day: 'The second day came up grey' / 'There was a mule on the bench.' A woman on the lip with 'a leather roll under one arm'; the hands catalogued first: 'square, short-nailed, the knuckles scarred over old, clean in a way nothing else on the mountain was clean. ... She did not ask who they were. \"Who's worst?\"' Name and trade: '\"Name's Oryn.\" She said it to the splint. \"Tide. Healer.\"' The carter's word: 'A carter came into Oxhollow off the void road two days back at noon and said the shale-backs had come off the mountain onto the low road at a run, and the crew that was up on the traverse was overdue off it. I was at the ford.' History held to one sentence: 'Two years on these roads and I've never done a thing to anyone from over there.' Lira: read ('Her hands were on the leg, above the break and below it, and then they were still ... Seconds.'), set ('Oryn took the foot and the shin in two hands and did not say now, and did the thing.'), mended ('He watched it happen in a quarter of an hour.' ... 'the two lines of Lira's shin, the wrong one and the right one, were one line, and stayed one line'), inside an hour ('From her knees going down in the shale to her hands coming off, he made it less than an hour.'), cost visible ('Her face had gone the colour of the shale.' / 'This woman sat down as a carter sets down a load he knows the weight of to the pound, and will pick up again, and would rather not yet.' / '\"That's one,\" she said.'). Brom: 'the arm from wrist to elbow was a raised dark line and nothing else'. Karis: '\"Ember,\" she said. \"And nothing. You're empty. That's not a hurt; I can't put back what you spent\"'. Cael: both hands on the ribs; 'She stopped in the middle of them. Her hands came off him. She looked at her hands ... Then she put them back'; 'It was the face of an instrument that has been put to a thing and has returned nothing'; the lines verbatim: '\"Your ribs are broken,\" she said. \"I can feel that they're broken. I can't feel you.\"' / '\"Whatever you are, I can't read it.\" ... \"I've never said that to anyone. Tape them. They'll heal on their own.\" A breath. \"They always have, haven't they?\"' / '\"Yes,\" he said.'"
    },
    {
      "obligation": "must_include: Tide Path's first on-page use carries its limit/cost in the same scene (charter §6.1): contact only; healing spends her; she does not heal herself.",
      "status": "MET",
      "evidence": "Contact only and no self-healing, in her own mouth in the mending scene: '\"Hands on. That's the only way it works.\" Oryn said it as a thing she said often, to a room, before anyone asked. \"Two years on these roads and I've never done a thing to anyone from over there. And I can't do it to me.\"' Cost: the grey face, sitting down 'all at once', drinking 'a long time', '\"That's one\"', and the reserve stated as a limit on the ankle: '\"The ankle under it I've not touched; I've not got it in me this morning\"'; after Brom's arm 'She had gone greyer ... Cael counted that she had drunk half the skin.' The cost lands before the second use (Brom's arm)."
    },
    {
      "obligation": "must_include: Cael's log line on the mountain (as given) placed BEFORE Oryn reaches him; the chapter ENDS on her dialogue line 'That's not an answer. That's a finding.'",
      "status": "MET",
      "evidence": "The log is written while she is at Brom's arm and Karis, in 'a hand that hurt', and closed before she stands over him: '*Eightieth day. Lira's leg is straight. The boxes are ours. The cart is in the gorge. A healer came up the road because a carter said we were late.*' / 'He closed it. She was standing over him.' Then the break, then the ribs scene. Final line of the file: '\"That's not an answer,\" Oryn said. \"That's a *finding*.\"' — no text after it."
    },
    {
      "obligation": "must_include: Cael's cataloguing outside the log (the herd, the geometry, his own ribs).",
      "status": "MET",
      "evidence": "The herd counted at first light ('got thirty'); the geometry counted on the run ('forty paces on the roof-pitched shale, thirty seconds') and after ('eleven paces from the fin's face'); the ribs ('Three ribs. Left side, low, under the arm ... Not four. Three.'); the full 'Inventory, taken in the fin's lee on the seventy-eighth day, in his head, because his hands were under him' (Lira, Brom, Karis, Seln, Cael, the cart, the boxes, the herd sixteen/fourteen/three, the map); Oryn's hands catalogued before her face; the seconds of each reading counted."
    },
    {
      "obligation": "must_include: Manuscript format: H1 '# Chapter 6 — Shale', prose only, '---' breaks, ends on the last line of prose.",
      "status": "MET",
      "evidence": "First line '# Chapter 6 — Shale'; seven '---' breaks; no headings, notes, or counts; the file ends on Oryn's line with a single trailing newline."
    },
    {
      "obligation": "plant: Oryn cannot read Cael (first of three failed surface readings; Chapter 7 teaches the two modes; Chapter 13 completes).",
      "status": "MET",
      "evidence": "The surface reading only — hands on the hurt, seconds — is what she runs on everyone, and on Cael it returns the injury and nothing beneath: 'She stopped in the middle of them. Her hands came off him. ... Then she put them back, exactly where they had been, and went still again, and held it longer, and her face did a thing.' / '\"I can feel that they're broken. I can't feel you.\"' No deep reading is run or described; the two modes are not named."
    },
    {
      "obligation": "plant: Lira's leg mended by Tide — the healer's mend and its cost; Oryn's reserve arithmetic (Chapter 7).",
      "status": "MET",
      "evidence": "The mend shown as sensation and consequence ('\"Cold\" ... \"No. It's going along\"'; the swelling going 'as water goes out of a basin when the plug is pulled'); the count kept aloud: '\"That's one\"'; the reserve as a stated limit: '\"I've not got it in me this morning\"'; the after-order: '\"Weight on it tomorrow. Not today. The bone's whole; it's new. It'll ache for a season\"'."
    },
    {
      "obligation": "plant: Cael's ribs and calf — three-week healing that Oryn will find faster than it should be (Chapter 7).",
      "status": "MET",
      "evidence": "Ribs and calf left unhealed on the page: '\"Tape them. They'll heal on their own.\" A breath. \"They always have, haven't they?\"' / '\"Yes,\" he said.' The calf 'washed and bound with the last of the boiled linen from Thornwater' by Seln on the first day and not touched by Oryn."
    },
    {
      "obligation": "plant: The three boxes saved — the field archive (Chapter 4, Chapter 15).",
      "status": "MET",
      "evidence": "'The boxes: three, in the fin's lee, on their sides where they had landed and been carried, roped shut still, not one lid sprung. Karis had checked that before she checked her own hands.' The middle box with the worn corner is the one Cael carries; Karis sleeps with her head on it; the log: 'The boxes are ours.'"
    },
    {
      "obligation": "payoff: Chapter 5's shale-back rule and the ledge; Chapter 4's healer shortage (no healer for four days in any direction) paid by Oryn's arrival.",
      "status": "MET",
      "evidence": "The rule paid in the body ('A step went uphill. A run did not' / 'A landslide with legs. It was the exact sentence.'); the ledge announced in Chapter 5 is the opening state and the collapse. The shortage stated as arithmetic through Seln, quoting the steading's woman: '*the nearest walks a route and she's not due.* Oxhollow had no healer of its own. ... that was four days from any place on this mountain in any direction, counted generously.' Paid: 'A healer came up the road because a carter said we were late.'"
    },
    {
      "obligation": "payoff: The banking doctrine's inverse: Lira's declaration is the loudest thing on the mountain and it is exactly the wrong place to be loud.",
      "status": "MET",
      "evidence": "'the whole declaration spent at once ... and it crossed the gorge' / 'away from the loudest thing that had happened on this mountain in three seasons' / Lira's own naming: '\"That was me\" ... \"The loud thing.\"' Karis's lattice is priced the same way ('It was a declaration the size of a road') and Cael's refusal to add one is argued on the rule ('One more loud thing under the second half, here, and the second half turned again, and the fin was what it turned toward.')."
    },
    {
      "obligation": "prohibited_outcomes (all): nobody dies; Lira mended and keeps the leg; Brom mended; Karis empty not injured; Cael's ribs taped/calf bound, NOT healed; no fragment use by Cael (want and hold only); no Shadow-adjacent; Oryn runs no deep reading, gives no route, does not join, explains no Tide theory, learns nothing of fragments; no Oryn POV or backstory speech; no quiet ground/Quieting/stakes/Teague/letters/Vastin; no new names beyond Oryn or places beyond the traverse; ends on Oryn's line; no modern idiom, no feeling/growth declarations, tic caps, no metadata; 'at the pitch' not used.",
      "status": "MET",
      "evidence": "No human death (three shale-backs into the gorge, animals only). Lira's leg set and mended, weight-bearing tomorrow. Brom's wrist closed. Karis 'nothing broken, nothing cut. Empty.' Cael: ribs to be taped, calf bound by Seln, Oryn's hands off him. Fragments: 'Compression wanted him ... Anchor wanted the cart ... He held. He took it raw.' — no deployment; Shadow not mentioned. Oryn: surface readings only; the route appears only as Seln's 'a woman who walked a circuit of the holds' before she arrives, and she says nothing of it; no Tide theory (the mend is described as what Cael sees, 'the nearest word he had was that she was pouring'); nobody speaks of fragments in her hearing; the party's reaction to the finding is silence ('Nobody moved.'). Entirely in Cael's POV. No quiet ground, Quieting, survey stakes, Teague, letters, or Vastin. New proper nouns: Oryn only; the fin, the lip, the bulge, the low road are descriptive. Last line is Oryn's dialogue. Tic greps all zero, including 'at the pitch' (0) and 'at that pitch' (0); no banned modern registers; no feeling or growth declarations; no metadata."
    }
  ],
  "inventions": [
    "The outcrop: a fin of darker, harder stone standing out of the mountain at the bench's inner edge forty paces behind the ledge's root, a man high and three carts long, with a down-slope lee; Seln has it as ground before anyone speaks; the herd's split point measured afterward at eleven paces up-slope of its face; the lattice's scorch left as 'thirty paces of scorched shale' across the face above it.",
    "The collapse's extent: three carts' length of the ledge, a cart's width, gone into the gorge; what remains is a lip against the bulge that a walker can take with hands on the rock and a mule or cart cannot — the map's last finding (the traverse does not hold a cart), and the way Oryn reaches them on foot with the mule left beyond the bulge where the bench opens.",
    "The herd's flight staged as Chapter 5's derivation refined by the event: a step went uphill, a run cannot (the shelf cannot hold thirty at a run; the outer plates go), so the herd comes off the upper bench down the face in a front two hundred paces wide, in two waves along the slant of its line — sixteen past the fin first, fourteen later at the cart; three heard going into the gorge and not sworn to; twenty-seven down the mountain toward the fan, and by the carter's report onto the low road.",
    "Cael's held wants under the herd, with the reason priced in one beat: Compression at contact to take the shoulder; Anchor to fix the cart to the mountain; refused because a second declaration under the second half would turn it toward the fin. No Shadow.",
    "Lira's leg broken by terrain, not by an animal: a plate going out under her foot as the shelf shifted under the second wave, the leg into the gap, the plate above coming down on it; her boot lost with the ledge; the tape from that morning still on the bare ankle. Splinted on the first day with two plates of the mountain and Karis's cord.",
    "Brom pulling both boxes with the bound arm (the hand allowed to hold, not pull), the wrist reopening under the cloth; he rewraps it one-handed with his teeth and checks the boxes before his arm.",
    "The two days of waiting: fire lit with a flint because the Ember practitioner is asleep against a box; the road food gone with the cart and Brom stretching a day and a half of pack food to three; Cael sleeping on the middle box on his right side, counting the breaths that stop, not taking the log out because he could not hold it; Seln walking the remnant lip in the afternoon, doing the healer arithmetic (Oxhollow two days on for a walker; no healer of its own; the route-walking healer four days from anywhere), and packing to go at first light of the second day, refusing to walk new shale in the dark.",
    "Oryn's kit, mule, and manner: a mule with panniers left beyond the bulge; a carter's coat; a leather roll of tools; a water-skin she empties by half in a morning; the walk that does not change pace at the narrow place or the wide; her hands as the first thing catalogued; her lines in the clinical register ('I'll be the one who says that', 'Then it went as far as it went. That's not straight.', 'That's one', 'It's not a dog's business now. It's yours.', 'Hm.' as a verdict on the lattice scorch); Seln asking 'Tier' and her answer 'Iron. Four, if anybody's keeping a book up here.'",
    "The carter's report as she gives it: into Oxhollow off the void road at noon on the day of the collapse; the shale-backs down on the low road at a run; the traverse crew overdue off it; she was at the ford.",
    "The mending as observed from outside: Lira's 'Cold' and 'It's going along'; the swelling going down 'as water goes out of a basin when the plug is pulled'; the two lines of the shin becoming one; the whole from kneeling to hands-off under an hour; Oryn's face the colour of the shale, wet at the temples, sitting 'as a carter sets down a load he knows the weight of to the pound'.",
    "Oryn's surface readings on Brom and Karis naming the Path beneath the hurt ('Iron Skin'; 'Ember') — per the architecture's definition of the surface reading (finds injury and the Path beneath it) — so that 'nothing' on Cael is a contrast the reader can hear. She asks nothing about the lattice or the scars.",
    "Cael's comparison set for the instrument-face: his own Kindling ('At fourteen, for eleven seconds, from the inside'), assessors at Ardenmere and Greyvane, the Halcenvane panel; 'Healers did not read the page. Healers read the leg.' And 'four healers in four years' as his count of healers he has been under.",
    "Lira's line for the cause, and Karis's ordering of it ('The ledge went. Then it was you.' / 'Then it was me.'), held without further comment."
  ],
  ...
  "deviations": [
    "Word count 5,263 against a 4,600 target — inside the 15% tolerance (ceiling 5,290) but above target, in line with Chapters 1–5 (5,269 / 5,169 / 5,150 / 5,273 / 5,235). The first pass ran to 6,344 and was cut by density in three passes; every mandated beat, all four exchanges, the log line, Oryn's lines verbatim, and the exact ending are intact. Further compression is available in the inventory section and the arrival paragraphs without touching obligations.",
    "The mandated log line is written verbatim but carries the log's established dateline prefix ('*Eightieth day.*') in front of it, matching every Book 7 entry's format. It remains one line in the manuscript. If the editor wants the sentence bare, the dateline is a four-word deletion.",
    "Oryn's surface readings on Brom and Karis name the Path beneath the hurt ('Iron Skin'; 'Ember'). This follows the architecture's definition of the surface reading (finds injury and the Path beneath it) and sets up the contrast with 'nothing' on Cael, but the packet's Chapter 6 mechanics list names only the mending and the surface reading on the hurt; flagged for the editor as an extension within the definition, not beyond it. She learns nothing that touches fragments; the party says nothing in her hearing.",
    "The herd's downhill flight is staged as Karis's Chapter 5 derivation refined by the event ('A step went uphill. A run did not'): the shelf cannot hold thirty animals at a run, so flight from the declaration becomes descent. This honors both the Chapter 5 rule ('on a slope, flight is a landslide with legs' / 'Then they come down') and the packet's 'turn away from the declaration, which on a slope means downhill' without asserting that the animals chose downhill.",
    "Three shale-backs are heard going into the gorge (animals, not people; 'Nobody dies' concerns the party and holds). Cael keeps the count as sixteen/fourteen/three-unsworn and twenty-seven down the mountain; the carter's report gives no number, so nothing contradicts.",
    "Seln plans to go for help at first light of the second day and is packed to go when Oryn appears; nobody leaves the mountain, so the party is five on the page until she arrives. The choice not to send him on the first day is argued on the page (new shale, dark, no healer at Oxhollow to reach).",
    "Oryn's arrival timing: the carter reached Oxhollow at noon on the day of the collapse (day 78); she is on the bench the morning of day 80, which is a day and a half for a woman with a mule against Seln's 'two days on' for a walker. Stated as her walking through; not underlined.",
    "Oryn's reserve is shown as a count ('That's one') and a limit ('I've not got it in me this morning') without the Chapter 7 arithmetic (three serious hurts a day). Her route appears only in Seln's pre-arrival arithmetic ('a woman who walked a circuit of the holds'), quoting the steading's woman; Oryn herself says nothing of it.",
    "Karis's lattice is described as the lattice laid out in a line ('a row of points so close together they were one thing') to keep the card's 'lattice-line' legible against her established single-point ignition; no new Ember mechanic is asserted.",
    "The 'as [noun] [verb]' simile form recurs across the chapter (roughly a dozen, none identical); it is the house construction the charter protects, but flagged for the line-edit pass to thin if it reads as an engine."
  ],
  "blockers": []
}
