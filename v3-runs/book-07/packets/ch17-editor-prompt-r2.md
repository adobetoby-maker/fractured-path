...

{
  ...
  "revisions": {
    ...
    "arc": "arc-b7-v2 (books/book-07-void-roads/CHAPTER_ARCHITECTURE.md, editor PASS r4, Chapter 17 card)",
    "state": "state-b7-post-ch16 (v3-runs/book-07/STATE_RUNNING.md + base snapshot)",
  ...
  "pov": {
    ...
    "knowledge_boundary": [
      "Cael is nineteen; ten + located anomaly. Roster SIX; physically FIVE at Lowmarch (Oryn is on her route, two days out of Thornwater on a road that bends toward the Stair road (Millrace ford by the next dusk); she left Thornwater after the circle of six). Lira one-armed (slung; load-restricted for the season).",
      "Known to the circle: the Quieting (named); the Fallow Ring's mechanics; Cael's fragments work inside (all six know); the Compact measured quiet ground (stakes, map blanks); the first contract was written from inside and its completion report went west; the cache is what the Compact wants (B6's open dread).",
      "Pike's ledger entry for the Fallow Ring (incomplete; crew returned) costs them a line and buys what no line records: they went in and came out, which no crew on the board has done. Teague STANDS when they come in — not a greeting; a captain marking a change before the ledger does.",
      "The second posting: same broker (who Pike says has posted nothing else in a year), same 'instruments', a second site — the Long Stair, a day south — at three times the first price. Seln's reading (the professional's chapter-within-a-chapter): registry prose again; a price that is a lure, sized for a crew that went in once and came out; a site chosen where the poster knows six practitioners will be five bodies and one anomaly (the poster does NOT know about Cael's immunity — nobody outside the circle does). 'This isn't a contract. It's a pre-restriction inventory. They've mapped what we do inside, and they've priced a floor where we can't do it.' Karis: 'They don't know about Cael.' Seln: 'They don't need to. They want the case. The boy's the price of the case.'",
      "The council (five voices): Lira and Brom want to walk away; Karis wants the site regardless; Seln wants to TAKE it — a trap you have read is the only instrument for reading the hand behind it: 'They'll send people. People have faces. Six years I've wanted a face.' Cael's decision line verbatim: 'Inside the circle, I'm the only one who works. They chose a floor that makes the rest of you helpless. They don't know it doesn't do anything to me.' They take it: the site is real, the pattern needs it, the trap is built on an assumption the Compact cannot know is wrong.",
      "Teague at the door: 'You're taking the Stair contract.' 'Yes.' 'It's a bad contract.' 'Yes.' 'My crew's at Millrace in two days. If you're late back, we'll come look.' Cael: 'Noted.' Brom quotes Rooke once: 'doors open both ways' (he has never quoted anyone).",
      "No theory of the sites; no 'Architect'; the faceless faction stays faceless; no letters, no Vastin."
    ]
  },
  "purpose": "REPAIR RUN. Apply the six verified findings to v3-runs/book-07/drafts/ch17-r1.md: (001, BLOCKER) resolved at the planning layer by EXC-B7-003 — Teague's fixed line now reads 'My crew's at Millrace in two days'; Oryn's position re-stated as on her route with Millrace ford (Stair road) due by the next dusk; (002) Pike's entry dated eleven days ago off a carter's word; (003) 'five at this table and one on a road north'; (004) 'And if the face is armed'; (005) the three-days-north count removed (see 001); (006) Lira's taped foot at the arrival and the council. No other passage changes.",
  "scene_shape": {
    "opening_state": "Lowmarch, first cold. Pike's Fallow Ring entry; Teague standing; the unit's standing after the Ring. Oryn three days north.",
    "pov_goal": "Read the contract the way Seln reads it, decide whether to walk into a trap on purpose, and say aloud to the whole table the sentence he has never said.",
    "opposition": "A contract that is an inventory; the case on Seln's shoulder as the price; Lira and Brom's honest wish to walk away; Karis who would go alone.",
    "turn": "The posting read; Seln's anatomy (registry prose; nothing else posted in a year; the lure's size; the floor chosen; the pre-restriction-inventory line; 'They want the case.'). The council's four positions in register.",
    "choice": "Cael's decision and the sentence (fixed): they take it, because the site is real and the pattern needs it, and because the trap's assumption is wrong in a way the Compact cannot know.",
    "outcome": "Contract taken; south tomorrow; the log mid-scene: 'Priced too well. Seln says it's for the case. I say the floor's for me and they don't know it. South, tomorrow. Lira's arm is a week old. Brom says doors open both ways. He's quoting Rooke. He's never quoted anyone.'",
    "closing_state": "The chapter ENDS ON DIALOGUE (the previous chapter ended on the log): Teague's offer at the door, and Cael's 'Noted.' — the first time in the book he has said the word to anyone eleven lines up."
  },
  "obligations": {
    "must_include": [
      "Pike's 'incomplete — instruments not recovered — crew returned' line costing a line and buying the unrecorded thing; Teague standing when they come in; the standing shown, not asserted.",
      "The second posting as an object (same broker, same instruments, the Long Stair a day south, three times the price); Pike's 'posted nothing else in a year' unasked.",
      "Seln's anatomy with the fixed lines verbatim (pre-restriction inventory; 'They want the case. The boy's the price of the case.'); Karis's 'They don't know about Cael.'",
      "The council with each position in register; Seln's 'People have faces. Six years I've wanted a face.'; Cael's decision line verbatim.",
      "The mid-scene log entry as given (with Brom quoting Rooke).",
      "Teague's door exchange verbatim; the chapter ENDS on 'Noted.'",
      "Oryn's absence on the page accounted for (three days north on her route); Lira's arm carried (a week old, slung).",
      "Manuscript format: H1 '# Chapter 17 — Priced Too Well', prose only, '---' breaks, ends on the last line of prose."
    ],
    "plants": [
      "The trap's design (people outside the line with crossbows; the floor as disarmament) — Ch19 stages it; here only Seln's inference that they will send people.",
      "Teague's 'we'll come look' (Ch19 close).",
      "The case as the target (Ch18–19)."
    ],
    "payoffs": [
      "Ch12's 'We just told them'; Ch16's report on a desk it shouldn't reach; Ch2's rival clock (Teague stands; speaks at the door)."
    ],
    "prohibited_outcomes": [
      "No travel to the Stair yet; no fight; no fragment use; Oryn absent.",
      "No theory of the sites; no 'Architect'; no naming of the faction; the broker unnamed.",
      "No letters, Vastin.",
  ...
  "invention_budget": {
    "allowed": [
      "Lowmarch in first cold; the board's room and the best table; Pike's manner; the posting's paper; the council's table; Teague at the door.",
      "Dialogue in established voices beyond the fixed lines.",
      "Cael's interior read of the posting and of Teague."
    ],
    "approval_required": [
      "Any new named entity; any fact about the broker or the faction beyond Seln's inferences; any detail of the trap's mechanics beyond 'they will send people'."
    ],
    "forbidden": [
      "Travel; fights; theory; fragment use; a log or image ending; metadata."
    ]
  },
  "context_files": [
    {
    ...
    {
      "kind": "previous_scene",
      "label": "Chapter 16 as drafted — the immediate seam (the circle of six, the second pole)",
      "path": "v3-runs/book-07/drafts/ch16.md",
      "required": true
    },
    {
      "kind": "reference",
    ...
    },
    {
      ...
      "path": "v3-runs/book-07/drafts/ch17-r1.md",
      "required": true
    },
    {
      "kind": "reference",
      "label": "Conflict notice and resolution (EXC-B7-003)",
      "path": "v3-runs/book-07/CONFLICT-B7-CH18.md",
      "required": true
    }
  ],
  "verified_findings": [
    {
      ...
      "evidence": "Teague looked at him a moment longer. Behind him the tall woman with the spear had not moved, and the broad man with the crossbow had shifted his weight off the limp, and the young one at the table's ",
      "consequence": "All four members of Teague's crew are visibly in Lowmarch, but the established Lowmarch-Oxhollow road takes six days and the fixed dialogue places that same crew at Oxhollow in two. The next chapter d",
      "repair_target": "Resolve Lowmarch/Oxhollow/Long Stair geography and travel time at the planning layer, then preserve or formally revise the fixed Teague line under an explicit exception."
    },
    {
      "id": "ED-B7CH17-002",
      "severity": "HIGH",
      "gate": "core.causal_legibility_and_earned_resolution",
      "evidence": "Five of them, on the hundred and twelfth day past the Line, with a mule and three boxes and a girl with her arm across her chest, coming down into a town that had priced them at the bottom of a wall a",
      "consequence": "A fortnight before day 112 is day 98, when the crew was still at the Fallow Ring camp and had not yet begun the two-day return to Thornwater. Pike therefore cannot already have entered a completed out",
      "repair_target": "Reconcile the age of Pike's completion entry with the day-98 departure, day-99 Thornwater return, and day-112 Lowmarch arrival without disturbing the required completed-line wording."
    },
    {
      "id": "ED-B7CH17-003",
      "severity": "HIGH",
      "gate": "state.party_headcount_and_witness_scope",
      "evidence": "They don't know what the floor does to me because *nothing* does anything to me on that floor, and there's no report on any desk in Valdris that says so, because the only six people who've seen it are",
      "consequence": "The six firsthand witnesses are Cael plus five companions, but Oryn is absent north, so only five of those witnesses can be at this table. The contradiction lands inside the central decision speech an",
      "repair_target": "Keep the six-person witness scope and Oryn's absence distinct when Cael states who knows and who is physically at the table."
    },
    {
      "id": "ED-B7CH17-004",
      "severity": "HIGH",
      "gate": "voice.new_canon_and_reveal_discipline",
      "evidence": "\"And if the face has a crossbow,\" Lira said.",
      "consequence": "The chapter is allowed to infer waiting people and no more; it instead names the exact ranged weapon the Chapter 19 trap is designed around. Even as a hypothetical, this narrows the future reveal to i",
      "repair_target": "Limit the council's threat inference to sent or waiting people unless an explicit approval is recorded for the crossbow detail."
    },
    {
      "id": "ED-B7CH17-005",
      "severity": "MEDIUM",
      "gate": "authority.canon_timeline_state",
      "evidence": "Five of them, on the hundred and twelfth day past the Line, with a mule and three boxes and a girl with her arm across her chest, coming down into a town that had priced them at the bottom of a wall a",
      "consequence": "The chapter explicitly frames 'three days' as Cael's elapsed-day count, then dates departure to first light on day 111 and arrival to day 112. At most two named travel days have occurred. The packet r",
      "repair_target": "Reconcile the day-111 departure and day-112 Lowmarch arrival with the packet-required three-days-north state, removing or changing only non-fixed calendar detail unless planning approves a different chronology."
    },
    {
      "id": "ED-B7CH17-006",
      "severity": "MEDIUM",
      ...
      "evidence": "Five of them, on the hundred and twelfth day past the Line, with a mule and three boxes and a girl with her arm across her chest, coming down into a town that had priced them at the bottom of a wall a",
      "consequence": "A full-draft search for 'ankle|taped|tape|foot|boot' returns zero. Lira's right ankle remained taped and was still being elevated in the supplied state/immediate seam; after a two-day walk and through",
      "repair_target": "Recur the taped right ankle or altered gait at Lira's next physical beat, or explicitly resolve it before the Lowmarch arrival if the calendar supports resolution."
    }
  ],
  "exceptions": [
    {
      "id": "EXC-B7-002",
      "approver": "orchestrator/author seat (planning layer, Fable) — owner-delegated loop authority",
      "scope": "Chapter 17 mid-scene log: 'Lira's arm is two weeks old' replaces the card's 'a week old'",
      "authority": "drafted calendar in v3-runs/book-07/STATE_RUNNING.md (mend on the ninety-sixth day; Lowmarch on the hundred and twelfth); charter §4.8 departed-and-returned; EXC-B7-001 precedent",
      "reason": "The card's figure was an estimate written before drafting; on the drafted calendar the arm is sixteen days old on the page the entry is written. Every other word of the entry is verbatim. The architecture card is to be annotated in the book-scope pass."
    },
    {
      "id": "EXC-B7-003",
      "approver": "owner (Toby) — resolution A chosen 2026-09-04; applied by the author/orchestrator seat",
      "scope": "Chapters 17–19 (and the Ch23 fork): the Chapter 18 rendezvous, clinic scene and Teague's fixed line re-sited from Oxhollow to MILLRACE, a ford settlement on the Stair road one day south of Lowmarch and one of Oryn's seven route stops (unnamed on the page until now); Ch17's 'Oryn three days north' becomes 'on her route', Millrace by the next dusk",
      "authority": "closed prose (Ch7: Oxhollow a week from Lowmarch; Ch8: 'Six days from Oxhollow') outranks the card; charter §4.8 departed-and-returned; v3-runs/book-07/CONFLICT-B7-CH18.md",
      "reason": "On the drafted map Oxhollow is six days north-west of Lowmarch and the Stair a day south; the unit cannot pass Oxhollow going south, Teague's crew cannot be there in two days, and Oryn cannot be due there the same day. Re-siting touches no closed prose and keeps every fixed line except the one place-name in Teague's Ch17 line. Millrace screened 2026-09-04 (no M-/mill- proper noun in B1–B7; MIL-race distinct by ear from Marlowe/Merrick/Marrow; no -water/-hold/-mere/-vane suffix)."
    }
  ],
  "output": {
    "draft_path": "v3-runs/book-07/drafts/ch17.md",
    "report_path": "v3-runs/book-07/reports/ch17-author-r2.json",
    "editor_report_path": "v3-runs/book-07/reports/ch17-editor-r2.json",
    "verifier_report_path": "v3-runs/book-07/reports/ch17-verifier-r2.json",
    "target_words": 4600,
...
# CONTEXT — Chapter 16 as drafted — the immediate seam (the circle of six, the second pole) (v3-runs/book-07/drafts/ch16.md)
...
He had built the order on the walk from the common room. It was short. He had had it since the stone and it had not grown, which he had noticed on the walk and filed as the only measurement of the thing he had: fifteen days, and a fact that had not got one sentence longer for being carried.
...
"The report's on a desk by now," Seln said. "The ferry went west eight days ago, with Pike's copy in the sack. Whoever wrote the slip has read that we came out, and is deciding what that's worth."
...
"North in the morning," Oryn said. It was not an answer to Karis; it was a fact about a route. "Oxhollow's seventeen days late and the old woman's knee doesn't care what's under a floor. I'll be on the road at first light and I'll be three days north by the time you're back at the board." She looked at him. "Thornwater's on my route. You know where that is now."
...
*Under the rule: the rule is not for the days I want to. It's for the days I don't notice I've started. She read me for twenty minutes with my leave and could not find a bank. I could read her in twenty and find every bank she has, and she has walked past that line eleven times without stepping off the road and stepped over it eight times alone in the dark, and she is going north at first light with a route seventeen days late and my rule in her pocket. Every time. Written where the inventory goes, so that it gets read every time the inventory does.*
...
# CONTEXT — THE DRAFT UNDER REPAIR (r1) (v3-runs/book-07/drafts/ch17-r1.md)

# Chapter 17 — Priced Too Well

Lowmarch had gone to the first cold while they were east of it, and he catalogued the difference from the road's last rise, because he had catalogued the town from that rise three times now and wanted the fourth to be honest.

The river lower and darker. The ferry landing with half the bales it had carried in the autumn, and those under canvas. The meadow where the five of them had slept in the first weeks, empty, the grass gone to straw, two tent-rings in it where crews had been and were not. Smoke from every roof that had a chimney and from three that had only a hole. The board's room at the lower inn with its landing door shut against the wind and its road door open a hand's width for the smoke, and through the hand's width, a plank on two barrels, and a man at it with one arm, writing.

Five of them, on the hundred and twelfth day past the Line, with a mule and three boxes and a girl with her arm across her chest, coming down into a town that had priced them at the bottom of a wall a season ago and had been moving them up it a line at a time for their outcomes, which was the only honest way to move.

Oryn was three days north. He had counted the days at every halt and had not said the count, because nobody had asked and the count was the same for everyone: she had gone out of Thornwater's gate at first light on the hundred and eleventh with the leather roll on her back and the mule's spare rope in her hand for the next hold's beast, and had not looked back, because a healer walking north does not look back at a crew walking south, and the crew had not needed her to.

---

Pike said the Fallow Ring's line before they had the door shut.

He said it to the book, in the voice he used for a price, without looking up, because the procedure was that the line was read aloud before and after entry and he had entered it a fortnight ago and this was the after. "*Recovery, Fallow road, broker's posting. Taken. Witnessed. Completed: incomplete — instruments not recovered — crew returned. Six went in. Six came out. No price paid.*" The pen stopped. "That's said."

"That's said," Cael said, because somebody from the crew had to, and it had always been him.

"Costs you a line." Pike put two fingers flat on the ledger and turned it, with one push, so that it faced across the plank, which he had done once before and Cael had never forgotten the feel of a page turned toward him. Eight completed lines under the five names. The eighth said what he had just heard it say. "Incomplete's incomplete. Instruments not recovered's not recovered. The wall goes by outcome, and the outcome was you went and came back with nothing to show for a hundred marks, and I've moved you down for it, because if I don't move a crew down for that I've no business moving one up for the other thing." He took the fingers off the ledger. "Eleventh. Teague's ten up."

Nobody argued. It was arithmetic, and it was correct, and Cael had spent four years learning that a ledger that could not move you down was not a ledger.

"And," Pike said.

He did not say it to the book. He said it across the plank, to the five of them, in the same voice, and the same voice made it a different thing.

"I've kept this wall thirty years. Thirteen crews on it now, and I've had forty-odd across the years, and I've walked past the Fallow Ring two hundred times and never once stepped over its line, and I've never once had a crew on my sheet that did. Not once. Not twice, which is the number the road counts." He looked at the eighth line where it lay. "You went in. You came out. Six in and six out, and the sixth a healer, and the only thing in my book that's got room for that is the outcome column, and the outcome column says *incomplete*." He picked the pen up. "The wall's the wall. I've moved you down. I'm telling you what the wall can't say, because I keep it and I'd sooner you heard it from the man who keeps it than worked it out from the room."

The room had worked it out.

He catalogued it, because it was the first room in a season that had had anything to work out about them. The board's room at the lower inn at the end of the day, a dozen people in it under a low roof, crews and carters and the hide-woman with her ledger, and every one of them had gone quiet at Pike's *six went in* and stayed quiet through *six came out* and was now not looking at the five of them in the way a room does not look at a thing it has decided about. Not fear. He had had fear from rooms for four years and knew its weight. This was the thing the Concourse had done on the bluff when a name went up a board it should not have been on: the room updating, all at once, without a word, on an outcome it had watched happen and could not price.

He had the room's pieces, because he had catalogued them coming in: the hide-woman at the middle table with her ledger shut on her thumb, who had looked at the five of them in the first week as at a thing that would be gone by the snow; the crew of three from the autumn, new canvas gone grey, at the table by the road door; two carters at the fire with their backs to it, one of whom had walked the Thornwater road behind them in the first week and said *first crew I've hired that knew to shut up*; the boy who carried the ledger up from the landing when the light went off the water. Every one of them had heard *six went in*. Not one of them said anything, and the not-saying was the room's whole verdict, and it was a better one than the wall could give, because the wall had a column for it and the room did not.

Teague stood up.

He was at the best table with his three, and he stood up when the five of them came in off the road and did not sit down again until they had crossed to the plank, and it was not a greeting. He did not nod. He did not speak. He stood as a captain stands when the ledger is about to change and he means the room to see that he saw it first — the weight down through the heels, the shoulders low and square, the hands loose — and when Pike had said *eleventh* he sat down, and turned his shoulder to the fire, and that was the whole of it.

Cael filed it beside the eighth line, and found that the two of them together said more than either.

Pike rewrote the wall that evening, in full, in the one-armed hand, as he rewrote it every time a line moved: thirteen crews on one sheet, top to bottom, and the five names eleventh, one below where they had been, with the mule-named crew still thirteenth and a crew of three from the autumn twelfth, and Teague's four at the top where they had been for three years. He pinned it where it went, by the road door, and stood back from it the way he stood back from a price he had just said, and did not look at the five of them, because the sheet was the saying and the saying was for the room.

---

The posting was on the wall between the door and the plank, where Pike put the ones that had been read and returned by everyone.

He saw the seal before he saw the paper. Dark wax, a hook and a bar, in the corner — the landing broker's, the one on a third of the bales — and thin broker's stock under it, and a clerk's hand, even, schooled, the letters sitting on a line that had not been drawn. He read it from the doorway, upside down, and then took it off its nail and read it the right way up at the plank, and Karis read it over his shoulder, and Seln did not read it at all, because Seln had read it from the doorway with the rest of the wall and had already gone still in the way he went still at a shelf.

*Recovery. Surveyor's instruments abandoned at a site on the Stair road. South of Lowmarch; the first day; where the road drops off the ridge and the ground opens. Three hundred marks (three hundred).*
...
Karis had her finger on *the Stair road*.

"That's the carter's second circle," she said. Her voice was nearly whole; it caught on *circle* and came back. "South, a day, where the road drops. It's on the map with a blank round it. It's a site."

"It's a site," Seln said.

He said it to the plank, and then he took the slip out of Cael's hand, gently, as he had once taken a case off a shelf, and laid it flat on the wood under the river stone, and put one finger on it, and gave them the chapter he had been carrying since the doorway.

---

"Registry prose." The finger on *abandoned at a site*. "Same as the first. *Site*, not *the Stair*; *abandoned*, not *left*; the price twice, figures and words. A clerk inside wrote this. The same clerk. I could put the two slips against each other and show you the hand, and Pike's already done it, because Pike reads paper."
...
"The site's the thing." Seln did not look at her. He looked at the slip. "He didn't post the Fallow Ring again. He could have; the instruments are still 'abandoned' there, by his own paper. He posted a different circle. One day south, close enough to Lowmarch that a crew walks in the morning and is inside the line by the afternoon, on a floor he *knows*." The finger came off the price. "He knows the floor. He stamped the stakes. He drew the holes in the maps. He knows that at that line, six practitioners walk in and five bodies and one anomaly walk on — five people with their Paths gone and one that the registry has never been able to read and that his paper calls *shattered*. He's read the report. He knows we walked into one of these and walked out. What he wants to know now is what we did inside, and he's built a place to find out, where the finding-out costs him nothing and us everything."

Nobody said anything. The room, which had been not-looking, had stopped pretending.

Seln said: "This isn't a contract. It's a pre-restriction inventory. They've mapped what we do inside, and they've priced a floor where we can't do it."

Karis said, "They don't know about Cael."

"They don't need to." Seln's voice did not change at all, which was how they knew he meant it. "They want the case. The boy's the price of the case."

He took his finger off the slip. The river stone sat on its corner. He had said the whole of what he had, in the order he had it, and it was a report, and nobody had asked for it, and he had given it anyway to five people at a plank, which was the second time in his life.

Pike wrote something in the book that was not a line, and put the pen down.

---

The council was at the corner table with the road door open its hand's width and the smoke going out through it, and it was the second honest collision of the year, and the leavers lost it, and lost it for the right reason.

Lira first, because Lira asked the honest question first.

"Walk away." She said it to the table, flat, the arm across her chest. "That's the honest one. It's a trap. Seln's just told us it's a trap, and he's told us what it's for, and it's for him and it's for you, and I've got one arm. We don't take it. We take the axe-head fence at forty and the autumn walk at fifty and we pace the carter's third circle on our own time when nobody's paid us to walk into it. There's no rule that says the site has to be on somebody else's slip."

"Yes," Brom said. It was the weight being named. "What she said. We've a hundred and eight and a mule. We don't need three hundred. We need the winter, and the winter's on the wall at forty and fifty and fed." He looked at the slip, under its stone, across the room. "Three hundred's a number a man doesn't reach for. My father said that about a horse once. He was right about the horse."

Karis, then, and she said it as she had said everything that week, as a finding.

"I don't care who posted it. I care that it's a site." She had the carter's map out already, the second blank under her thumb. "It's on the bearing from the Ring — near enough; I'll know when I've paced it. It's a day off. It's got stakes in it, because he's stamped them, which means it's been *measured*, which means when I measure it I'll have a second number to put against my first, and one number is a count and two is a fact. I would go alone. I'm saying so plainly so nobody has to guess. If the five of you take the fence, I take the map and a cord and a crossbow I don't know how to wind and go and pace the Long Stair by myself, and you can enter that in the ledger under whatever column you like."

"We know," Lira said. "That's why we're at this table and not already at the fence."

Seln had not sat down. He stood at the table's end with the case on his back and his hand on the chair he was not using, and said the thing none of them had expected, in the voice for an inventory.

"Take it."

Brom looked up.

"Take the contract." Seln did not raise his voice; he never had. "A trap you've read is the only instrument you'll ever have for reading the hand behind it. I've read this one. I know what it's for and how it's built and what it assumes. That's more than I've ever known about them. Six years I've been carrying a case for people I can't see, and the one time they've reached for it in the open, it's a slip on a nail with a price on it." He looked at the slip, across the room. "They'll send people. A lure's no use if nobody's waiting at the end of it. People have faces. Six years I've wanted a face."

"And if the face has a crossbow," Lira said.

"Then I'll have seen it." Seln sat down. "That's the whole of my argument. I'm not going to make it twice."

Cael had listened to the four of them, because that was what the table was for and he had learned it at another one, and he had the count: two to walk, one to go regardless, one to go *because*. He had the decision too. He had had it since the plank, since Seln's finger came off the price, and he had let the table make its case first because a decision that arrives before the argument is a decision that has not been priced.

He said it to the whole table, and it was the sentence he had never said aloud to more than one person at a time.
...
"We take it," he said. "Not for three hundred. Karis is right that it's a site and the pattern needs it, and Seln's right that a trap you've read is an instrument, and Lira and Brom are right that it's a trap. All of that's true and all of it's on the table. Here's the thing that isn't on theirs." He put his hand flat on the map, over the second blank. "Everything they've built, they've built on one assumption. That inside that line, six practitioners are five bodies and one anomaly, and that the anomaly's a boy the registry couldn't read and can't fight either. They stamped those stakes five years before they'd ever heard my name. They don't know what the floor does to me because *nothing* does anything to me on that floor, and there's no report on any desk in Valdris that says so, because the only six people who've seen it are at this table. The trap's real. The floor's real. The assumption's wrong, and they can't know it's wrong, and I can." He took his hand off the map. "That's why."

Lira looked at him for a long time, and then at the arm across her chest, and then at Brom.

"Doors open both ways," Brom said.

Everyone looked at him.

"Rooke said it. On a stair, once, to a cohort, about a hall that had a door at each end and a habit of using one." Brom looked at the slip under its stone. "They've built a door we walk in by. It opens the other way too. He's saying he's the one who can open it." He put his big hands on the table. "I don't like it. I'm in."

"I'm in," Lira said. "I want it entered that I said walk away. I was right. We're going anyway."

"Entered," said Karis, writing.
...
*Hundred and twelfth day. Lowmarch, the board's room, the corner table. A hundred and eight in hand; nothing owed; nothing earned. Nineteen. Ten. Eleventh on the wall; Teague's ten up. Oryn three days north.*
...
Pike marked the slip at the plank without being asked to, which he had never done.

He took it out from under the river stone and wrote HOLD across the top of it and the five names under, in the one-armed hand, and put it back on its nail, and said, to the book, "Taken," and then, to the room, in the voice that carried under the roof, "Stair road. Recovery. Three hundred. Taken by the five." He did not say what he thought of it. He had said that already, and once was the number.

Then, still to the room: "Teague."

Teague was already up.

He had watched the council from the best table without hearing a word of it — the corner table was across the room and the road door's draught took the sound out — and Cael had watched him watch, because it was the thing he did, and had seen the man read every face at the corner table in order, the way he read a job: Lira's, Brom's, Karis's bent over a map, Seln's when Seln sat down, and his own, when he put his hand on the blank. Teague had read the decision off the table before Karis wrote it. That was what a captain who had been top of a wall for three years could do, and Cael had priced it, and it was worth what it cost.

He came across the room, and stopped a stride and a half off, which was a distance two people out here used and neither of them had learned from the other, and did not look at the slip.

"You're taking the Stair contract."
...
Teague looked at him a moment longer. Behind him the tall woman with the spear had not moved, and the broad man with the crossbow had shifted his weight off the limp, and the young one at the table's end had stopped eating, and none of that was for the room. It was for their captain, who was about to say a thing he had not said all year to a crew ten lines under him.

"My crew's at Oxhollow in two days," Teague said. "If you're late back, we'll come look."

It was not an offer. It was not a kindness. It was a term, stated by a man who kept his own ledger and had just put a line in it, and Cael recognized the register from the other side, because he had used it himself at a plank and at a table and in a hearing room, and knew what it cost to say a thing that way to somebody you had been pricing for a season. He filed it beside Pike's *six went in*, and beside a line in a book on a bluff that said *the instruments will not see its like*, and beside a one-armed man's *he'll speak to you when you've cost him something*, and found that the shelf was full and that the last thing on it was a captain at the top of a wall telling the crew at the bottom of it where he would be.

He had never once said the word to anyone eleven lines up, or ten. He said it now.

"Noted."

---

# CONTEXT — Conflict notice and resolution (EXC-B7-003) (v3-runs/book-07/CONFLICT-B7-CH18.md)

# CONFLICT NOTICE — Book 7, Chapter 18 (Oryn's Choice)

Filed by the author seat (Fantasy Author A / Fable), 2026-09-04. Chapter 18 is NOT drafted pending resolution. Decision hierarchy: canon > charter > chapter card > instinct. Closed prose is canon for this purpose.

## Card instruction
CHAPTER_ARCHITECTURE.md, Chapter 18: "The unit's route south passes Oxhollow; Oryn's route north is due there the same day; and the chapter opens on her at the ford's clinic-shelter." The Long Stair is "a day south" of Lowmarch (Ch17 card and packet). Chapter 17's fixed line (already drafted, in editor): Teague — "My crew's at Oxhollow in two days. If you're late back, we'll come look." Chapter 19's close has Teague's crew arrive at the Stair "as promised".

## Canon it breaks (closed prose)
- Book 7 Ch7 (closed): Oxhollow is a ford settlement at the gorge's mouth under the bench, north-west of Lowmarch; "roads north (under the bench, her route), east (holds), south across the ford (Lowmarch, a week)".
- Book 7 Ch8 (closed), first line: "Six days from Oxhollow: a road, and a river, and a road ... " — the unit reached Lowmarch on the ninetieth day, six days out of Oxhollow.
- Book 7 Ch16 (in editor, r2): Oryn leaves Thornwater "north" toward Oxhollow, "seventeen days late" there; Ch17 (in editor): "Oryn three days north".

On the drafted map, Oxhollow is six days from Lowmarch and in the opposite direction from a Stair that is one day south. The unit cannot pass it going south, Teague's crew cannot be there in two days, and Oryn cannot be due there "the same day" the unit walks south from Lowmarch.

## Proposed resolutions (not applied)
A. Re-site the rendezvous, keep the beats. Chapter 18's clinic scene happens at the hold or ford on the Stair road where Oryn's route is due (one of her five unnamed holds; Ch7 gave the route seven stops and named only Oxhollow and Thornwater). Teague's Ch17 line changes "Oxhollow" to that ford's name (a Ch17 repair under an exception; Ch17 is still in its first editor round). Ch18, Ch19 and Ch23 cards amended to match. Oryn's Ch16 "north" and "Oxhollow seventeen days late" stand: her circuit brings her round to the Stair-road stop within three days. Cost: one new place name, screened against the registry (no O-onset — Oryn/Oxhollow/Ostrand already stack; no -hold, -mere, -vane); one exception (EXC-B7-003); three card annotations. No closed prose changes.

B. Keep Oxhollow, move the Stair. Make the Long Stair a day short of Oxhollow on the north-west road instead of "a day south of Lowmarch", and change the Ch17 slip's site line and Seln's "a day south" (Ch17 in editor; small repair). Then the unit walks north-west, passes Oxhollow on the sixth day, and the Stair is beyond it. Cost: Ch17 repair; Ch18/19/23 cards annotated; the arc's "Part 3 alignment" bearing (Ring → Stair → Hall → fourth site, on one line) must be re-checked against a Stair that now sits north-west of Lowmarch rather than south; the Ch23 walk and Oryn's fork also move. Larger blast radius.

C. Accept the card and file an exception overriding Ch7/Ch8's distance. Rejected by the author seat: it would make closed prose false on the page ("Six days from Oxhollow").

## Recommendation
A. It touches no closed prose, costs one screened name and one exception, and keeps every fixed line in Chapters 18–19 intact except the single word "Oxhollow" in Teague's Ch17 line (repairable now, before Ch17 closes).

## What is needed from the owner
Choose A, B, or another route. If A: approve minting one place name (or instruct the author seat to mint and screen it). The author seat will then annotate the three cards, add EXC-B7-003 to the Ch17/Ch18 packets, repair Ch17's line in its next editor round, and draft Chapter 18.
...
# MANUSCRIPT — v3-runs/book-07/drafts/ch17.md
...
Five of them, on the hundred and twelfth day past the Line, with a mule and three boxes and a girl with her arm across her chest and a taped right foot she put down flat at every stride, coming down into a town that had priced them at the bottom of a wall a season ago and had been moving them up it a line at a time for their outcomes, which was the only honest way to move.

Oryn was on her route. She had gone out of Thornwater's gate at first light on the hundred and eleventh with the leather roll on her back and the mule's spare rope in her hand for the next hold's beast, north, on a road that bent as every road out here bent, and had not looked back, because a healer walking her circuit does not look back at a crew walking off it, and the crew had not needed her to. He had the seven stops in the order she had said them at a table, and the one after Thornwater was a ford called Millrace, on the Stair road, a day south of Lowmarch; by her count she would be at its table by tomorrow's dusk, and he had not said so to anyone, because nobody had asked and the count was the same for everyone.

---

Pike said the Fallow Ring's line before they had the door shut.

He said it to the book, in the voice he used for a price, without looking up, because the procedure was that the line was read aloud before and after entry, and he had entered it eleven days ago off a carter's word from Thornwater, and this was the after. "*Recovery, Fallow road, broker's posting. Taken. Witnessed. Completed: incomplete — instruments not recovered — crew returned. Six went in. Six came out. No price paid.*" The pen stopped. "That's said."
...
"Walk away." She said it to the table, flat, the arm across her chest and the taped foot up on the bench where the two days had put it. "That's the honest one. It's a trap. Seln's just told us it's a trap, and he's told us what it's for, and it's for him and it's for you, and I've got one arm. We don't take it. We take the axe-head fence at forty and the autumn walk at fifty and we pace the carter's third circle on our own time when nobody's paid us to walk into it. There's no rule that says the site has to be on somebody else's slip."
...
"And if the face is armed," Lira said.
...
"We take it," he said. "Not for three hundred. Karis is right that it's a site and the pattern needs it, and Seln's right that a trap you've read is an instrument, and Lira and Brom are right that it's a trap. All of that's true and all of it's on the table. Here's the thing that isn't on theirs." He put his hand flat on the map, over the second blank. "Everything they've built, they've built on one assumption. That inside that line, six practitioners are five bodies and one anomaly, and that the anomaly's a boy the registry couldn't read and can't fight either. They stamped those stakes five years before they'd ever heard my name. They don't know what the floor does to me because *nothing* does anything to me on that floor, and there's no report on any desk in Valdris that says so, because the only six people who've seen it are five at this table and one on a road north. The trap's real. The floor's real. The assumption's wrong, and they can't know it's wrong, and I can." He took his hand off the map. "That's why."
...
"My crew's at Millrace in two days," Teague said. "If you're late back, we'll come look."
...
# AUTHOR REPORT — v3-runs/book-07/reports/ch17-author-r2.json

{
  ...
  "obligations": [
    {
      "obligation": "ED-B7CH17-001 (BLOCKER): resolve the Lowmarch/Oxhollow/Stair geography at the planning layer; preserve or formally revise the fixed Teague line under an exception.",
      "status": "MET",
      "evidence": "Owner chose resolution A (EXC-B7-003, in the packet): the rendezvous is MILLRACE, a ford on the Stair road a day south of Lowmarch and one of Oryn's seven stops. Teague: \"My crew's at Millrace in two days,\" Teague said. \"If you're late back, we'll come look.\" Oryn's position: 'Oryn was on her route ... the one after Thornwater was a ford called Millrace, on the Stair road, a day south of Lowmarch; by her count she would be at its table by tomorrow's dusk'. Log: 'Oryn on her route; Millrace tomorrow, by her count.' Oxhollow (six days north-west) untouched."
    },
    {
      "obligation": "ED-B7CH17-002 (HIGH): reconcile the age of Pike's completion entry.",
      "status": "MET",
      "evidence": "'he had entered it eleven days ago off a carter's word from Thornwater, and this was the after' (day 101, after the day-99 return)."
    },
    {
      "obligation": "ED-B7CH17-003 (HIGH): keep the six-witness scope and Oryn's absence distinct.",
      "status": "MET",
      "evidence": "'the only six people who've seen it are five at this table and one on a road north.'"
    },
    {
      "obligation": "ED-B7CH17-004 (HIGH): no crossbow inference in the council.",
      "status": "MET",
      "evidence": "'And if the face is armed,' Lira said. — the council infers only that people will be sent."
    },
    {
      "obligation": "ED-B7CH17-005 (MEDIUM): reconcile Oryn's 'three days north' with the calendar.",
      "status": "MET",
      "evidence": "The elapsed-day framing is removed; her position is stated as route and destination (Millrace by the next dusk) under EXC-B7-003."
    },
    {
      "obligation": "ED-B7CH17-006 (MEDIUM): carry Lira's taped ankle.",
      "status": "MET",
      "evidence": "Arrival: 'a taped right foot she put down flat at every stride'; council: 'the taped foot up on the bench where the two days had put it'."
    }
  ],
  "inventions": [
    "Millrace named on the page for the first time (Teague's line; Cael's recollection of Oryn's seven stops in order)."
  ],
  "state_change_proposals": [
    "Millrace: a ford settlement on the Stair road, a day south of Lowmarch; one of Oryn's seven stops, the one after Thornwater on her circuit; Oryn due there on the 113th; Teague's crew there 'in two days'. Oryn's road out of Thornwater goes north and bends."
  ],
  "deviations": [
    "Nine hunks against r1: six for findings 002–006 (applied before the route decision) and three for the resolution (Oryn's paragraph; Teague's line; the log line). r1 preserved as drafts/ch17-r1.md; the pre-resolution r2 draft as drafts/ch17-r2pre.md."
  ],
  "blockers": []
}
