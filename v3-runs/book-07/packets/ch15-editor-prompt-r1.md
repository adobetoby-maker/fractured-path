...

{
  ...
  "revisions": {
    ...
    "arc": "arc-b7-v2 (books/book-07-void-roads/CHAPTER_ARCHITECTURE.md, editor PASS r4, Chapter 15 card)",
    "state": "state-b7-post-ch14 (v3-runs/book-07/STATE_RUNNING.md + base snapshot)",
  ...
  "pov": {
    ...
    "knowledge_boundary": [
      "Cael is nineteen; ten fragments + the located anomaly. Party SIX at Thornwater, a week of tables. Lira one-armed (slung, load-restricted); Karis's voice nearly back.",
      "Karis's field report is the chapter's structure — five findings in her formal register. She COINS 'the Quieting' here (a process, not a place) and the book adopts it from this chapter on; before this line nobody has said the word.",
      "Finding two (Book 9 plant, observed only): every Arbiter in the party went silent at the same line, same stride, same instant, same way — Wind, Iron Skin, Ember, Shadow, Tide, Iron R1 to Bronze — and Karis enters the sentence she does not know how to file: a personal spiritual entity should not fail like a piece of equipment on a circuit. NO explanation.",
      "Finding three (Book 8 plant, as a LIMIT): she dates the fused stone against every masonry stratum in her three boxes (registry-era, standardization-era, pre-standardization, founding-era waystation stone from Prynn's archive) and reaches her method's limit: older than the registry; older than the standardization directive; older than the two-hundred-year modification and the sub-layer beneath it (Book 6's findings, which the circle knows); older, she says, using the word ONCE, than [UNBOUND] — 'older than the word they retired, and I can't say by how much. Entered as a limit, not a finding. We explained the middle of the story in Ostrand. This is before the beginning, and I don't have a ruler for it.' The word [UNBOUND] appears exactly once in the chapter and nowhere else in the book.",
      "Finding four: the stakes, Seln's map blanks, the contract's registry prose — the Compact knows, measured, filed, drew maps with holes. Entered once; not pursued. Finding five: Cael's ten fragments work inside — she has the data; she writes the observation and STOPS at the interpretation: 'I have a hypothesis and I'm not entering it, because entering it would make it a finding, and it isn't one. It's a fear.'",
      "Karis's closing dialogue (fixed): 'The circle's perfect. Perfect isn't natural. Somebody made a floor that turns Paths off. It's older than anything I can date. And it doesn't turn you off. Three facts. I'm not putting a verb between them.' Cael: 'You said you weren't entering the hypothesis.' Karis: 'I'm not. I'm saying it to you. That's different.' NOTHING beyond the three facts; no maker, no purpose, no 'Architect'.",
      "Cael has still told nobody why he thinks it worked (Lira first, Chapter 16)."
    ]
  },
  "purpose": "Karis's chapter: the researcher aimed at the largest primary source of her life, the Quieting given its name, and the book's [UNBOUND] discipline honored as a stratum limit — five findings entered in her formal register across a week at Thornwater, the fifth one stopped at its interpretation because she is honest about the difference between a finding and a fear.",
  "scene_shape": {
    "opening_state": "Thornwater, a week of tables: the copied carvings, the paced perimeter, the stake's number, the three boxes open.",
    "pov_goal": "Watch Karis do what she is for, and hold his own silence one more chapter.",
    "opposition": "Her method's limits (no ruler for the floor's age); her fear (the fifth finding); his unfiled fact.",
    "turn": "The five findings in order: the name; the failure mode (identical Arbiter failure — equipment on a circuit); the strata limit with [UNBOUND] once; the stakes; the thing she will not write.",
    "choice": "Karis stops her pen at the interpretation and says the three facts aloud to Cael instead, refusing a verb between them.",
    "outcome": "The Quieting named; the floor dated as 'older than everything'; the Compact's knowledge entered once; the hypothesis unentered; Cael's log (mid-scene): 'Karis dated the floor. Older than everything. She has a hypothesis she won't write down. I have four people who saw what I did inside, and one healer who felt what I'm made of, and I've told none of them why I think it worked. Lira first. Tomorrow. It's always been Lira first.'",
    "closing_state": "The chapter ENDS ON DIALOGUE (the previous chapter ended on the log): Cael: 'You said you weren't entering the hypothesis.' Karis: 'I'm not. I'm saying it to you. That's different.'"
  },
  "obligations": {
    "must_include": [
      "Karis's five findings in her formal register, in order, each landing on a thread the reader carries: (1) the name 'the Quieting' coined with her reason (process, not place); (2) the identical Arbiter failure and her unfileable sentence; (3) the strata limit with the masonry strata named, [UNBOUND] used exactly once, and her 'middle of the story / before the beginning / no ruler' lines; (4) the stakes/map-blanks/registry-prose entered once; (5) the observation about Cael's fragments written, the interpretation stopped, with her 'It's a fear.' line verbatim.",
      "The copied carvings as objects (lines in no alphabet she owns), the paced perimeter's arithmetic recalled, the stake's number.",
      "Cael's log entry mid-scene (as given), before the closing exchange.",
      "Karis's three-facts speech verbatim and the closing exchange verbatim; the chapter ENDS on 'That's different.'",
      "Oryn present at Thornwater (working her route's backlog if she appears; at most a beat); Lira one-armed; Seln and Brom in register.",
      "Manuscript format: H1 '# Chapter 15 — Strata', prose only, '---' breaks, ends on the last line of prose."
    ],
    "plants": [
      "'The Quieting' as the book's term from here on.",
      "Identical Arbiter failure (Book 9).",
      "The floor older than every stratum including the retired word (Book 8).",
      "Karis's unentered hypothesis (never entered in this book).",
      "'Lira first. Tomorrow.' (Ch16)."
    ],
    "payoffs": [
      "Ch10's measurements and carvings; Ch12's stakes and blanks; B3/B6's strata discipline recognized by the circle."
    ],
    "prohibited_outcomes": [
      "No maker, purpose, intelligence, 'Architect', 'primordial', 'before the system' in anyone's mouth or narration; Karis states three facts and refuses a verb; [UNBOUND] appears once only.",
      "No disclosure by Cael (Ch16); no fight; no fragment use; no travel.",
      "No Teague, letters, Vastin (Ch16).",
  ...
  "invention_budget": {
    "allowed": [
      "The week of tables as texture (paper, cord, chalk, the boxes as shelves, Thornwater's autumn); Karis's method-register in full; the others' small beats; Oryn's route backlog as a glimpse.",
      "Dialogue in established voices; Cael's interior cataloguing of Karis working."
    ],
    "approval_required": [
      "Any new named entity; any stratum or dating fact beyond those listed; any additional [UNBOUND] use."
    ],
    "forbidden": [
      "Theory/ontology; disclosure; fights; travel; a log or image ending; metadata."
    ]
  },
  "context_files": [
    {
    ...
    {
      "kind": "previous_scene",
      "label": "Chapter 14 as drafted — the immediate seam (the birthday, the retired words)",
      "path": "v3-runs/book-07/drafts/ch14.md",
      "required": true
    },
    {
      "kind": "reference",
  ...
  "exceptions": [],
  "output": {
    "draft_path": "v3-runs/book-07/drafts/ch15.md",
    "report_path": "v3-runs/book-07/reports/ch15-author-r1.json",
    "editor_report_path": "v3-runs/book-07/reports/ch15-editor-r1.json",
    "verifier_report_path": "v3-runs/book-07/reports/ch15-verifier-r1.json",
    "target_words": 4600,
...
# CONTEXT — Chapter 14 as drafted — the immediate seam (the birthday, the retired words) (v3-runs/book-07/drafts/ch14.md)
...
# MANUSCRIPT — v3-runs/book-07/drafts/ch15.md
...
The carvings she kept to herself for the first four days, and he let her. He had counted the bands on the second upright at the ring and stopped; she had copied all eleven and had been going over the sheets since with a pencil and a second sheet beside each, and the second sheets were filling with marks in rows, and the rows were a tally. He knew a tally when he saw one. He did not ask what she was counting until the fourth evening, and then she said, without looking up, "The kinds. Every band is the same kind of line and never the same line, and I want to know how many kinds there are before I say anything about any of them." He asked how many. "I have a number. I'm not saying it until I've a second site to check it against. A count from one place is a count. From two it's a fact." She went back to the pencil. It was the first time in four years he had heard her refuse to say a number, and he filed that as a measurement of the number.

She worked with her voice for the first time since the ring. It had come back, as Oryn said it would, in pieces, over days, and by the week's middle it was a low usable thing that went on her when she pushed it and came back when she rested it, and she rested it by writing. She said the findings aloud, one at a time, as they came, to whoever was at the table, and wrote each one beneath the saying, and the writing was the entry and the saying was for them, which was a rule he had learned from a one-armed man at a plank and which she had arrived at on her own.
...
"I said it as geometry." Karis did not pick the pen back up. "A circle is the shape you get when one thing is a fixed distance from another thing all the way round. Nothing in the ground does that. Water doesn't. Frost doesn't. A bog doesn't. A cord with a stake at one end does, and a wheel does, and a bowl does, and every one of those is a thing somebody made. That's still geometry. It's a fact about the shape, and I've entered it as a fact about the shape, and I'm not going to walk from *shape* to *somebody* in the small hand, because the small hand is where the book keeps what it knows." She looked at the word at the top of the page. "The process has a shape. The shape is a circle. Two facts. Leave them where they are."
...
"Registry-era." A grey chip with a dressed face. "The academy above Ostrand. Built, not converted; every course laid under the registry's own standard, the mortar mixed to its own directive. Fifty years, near enough, and I can show you the tool that dressed it, because the tool's still in use." She set it down. "Standardization-era." Darker, with a lip of mortar on it. "A records hall's back wall, in Ardenmere. Two hundred years, near enough. Same era as the papers in a case Seln carries and hasn't opened, and I can put the mortar against the paper's watermark and get the same generation." Down. "Pre-standardization." Paler, coarser, the dressing marks broader. "Greyvane's old course, the one under the converted waystation's floor — older than the academy by a good deal, laid by people who dressed stone with a wider chisel than anyone's used since." Down. "And the founding era." The last chip, and the one she touched twice. "Waystation stone, from the wall Prynn's archive sat inside. Four hundred years, by the archive's own ledger, which I read the entry in. It's the oldest dressed stone I have ever had in my hand and it is the floor of my ruler. Below it I have nothing. I've never needed anything below it, because nothing I've ever measured was older."
...
"I have a hypothesis," she said. "You know I have. Everyone at this table knows I have; Lira's been watching me not write it for three days. I've had it since the stone. I've had it since Oryn took her hands off you at the Ring and said *nothing in my hands* and you walked twenty meters in with the read running under your boots and told me it was dark before and dark now." The nib did not move. "And I'm not entering it, because entering it would make it a finding, and it isn't one. It's a fear."
...
# AUTHOR REPORT — v3-runs/book-07/reports/ch15-author-r1.json

{
  ...
  "obligations": [
    {
      "obligation": "must_include: Karis's five findings in her formal register, in order: (1) the name with her reason; (2) identical Arbiter failure and her unfileable sentence; (3) the strata limit with the masonry strata named, [UNBOUND] once, and her middle/beginning/ruler lines; (4) stakes/map-blanks/registry-prose entered once; (5) the observation about Cael's fragments written, the interpretation stopped, 'It's a fear.' verbatim.",
      "status": "MET",
      "evidence": "(1) 'It isn't a place. ... Something is *happening* to the ground, in a circle, at a fixed distance from a made floor, and it's the happening I need a word for, not the place' — she writes *the Quieting*: 'A process ... a thing that *happens*, not a thing that *is*'; adopted by the table and the road after. (2) Five sigils at five points; 'Every one of them went out at the same stride' ... 'A personal spiritual entity should not fail the way five looms fail when somebody shuts the sluice on the wheel that drives them.' / 'I don't know how to file that' — entered as observation, *identically* underlined, unexplained. (3) The four chips named and dated in order (registry-era: the academy above Ostrand; standardization-era: a records hall in Ardenmere; pre-standardization: Greyvane's old course under the converted waystation; founding-era: waystation stone from the wall Prynn's archive sat inside, four hundred years by its ledger) and the floor's rubbings set past the last of them; dressing and weathering as the two measures; then the limit verbatim: 'It's older, I'll say once and not again, than [UNBOUND] — older than the word they retired, and I can't say by how much. Entered as a limit, not a finding. We explained the middle of the story in Ostrand. This is before the beginning, and I don't have a ruler for it.' grep UNBOUND → 1. (4) Four sentences: the stake, the map, the contract; 'The Compact measured this. They paced the circle before I did ... and they filed it, somewhere none of us can reach. Entered once. As said.' / 'Anything else on this is a question and not a finding, and I'm not entering questions today.' (5) The observation written in the small hand (five Paths did not render; the sixth's fragments rendered, nine of nine, witnessed by five; Arbiter unchanged 'stated by him'); the pen held over the page; 'I have a hypothesis ... And I'm not entering it, because entering it would make it a finding, and it isn't one. It's a fear.' verbatim; 'The observation's entered. The interpretation's stopped. That's five.'"
    },
    {
      "obligation": "must_include: The copied carvings as objects (lines in no alphabet she owns), the paced perimeter's arithmetic recalled, the stake's number.",
      "status": "MET",
      "evidence": "Eleven rubbings cut to the uprights' heights, 'a ring laid flat'; her tally of the kinds of line ('Every band is the same kind of line and never the same line') with a number she will not say until a second site; the perimeter page quoted ('sixty-two cords and twenty strides; twelve hundred and fifty-six and a piece; ten cords in from the stone to the middle; a circle'); 'The stake's number, thirty-one, copied under the registry's mark drawn from memory.'"
    },
    {
      "obligation": "must_include: Cael's log entry mid-scene (as given), before the closing exchange.",
      "status": "MET",
      "evidence": "'*Hundred and ninth day. Thornwater, the common room, the tables cleared. ... Nineteen.*' followed by the mandated entry verbatim: '*Karis dated the floor. Older than everything. She has a hypothesis she won't write down. I have four people who saw what I did inside, and one healer who felt what I'm made of, and I've told none of them why I think it worked. Lira first. Tomorrow. It's always been Lira first.*' — before the closing exchange."
    },
    {
      "obligation": "must_include: Karis's three-facts speech verbatim and the closing exchange verbatim; the chapter ENDS on 'That's different.'",
      "status": "MET",
      "evidence": "'The circle's perfect ... Perfect isn't natural. Somebody made a floor that turns Paths off. It's older than anything I can date. And it doesn't turn you off. Three facts. I'm not putting a verb between them.' / 'You said you weren't entering the hypothesis.' / 'I'm not,' Karis said. 'I'm saying it to you. That's different.' — last line of the file."
    },
    {
      "obligation": "must_include: Oryn present at Thornwater (route backlog, at most a beat); Lira one-armed; Seln and Brom in register.",
      "status": "MET",
      "evidence": "Oryn at the house door on the 104th: 'I'm nine days late here and eleven at the next. Send me who's hurt.' — three hurts in the yard, one glance at the table, back to the wrist. Lira holding paper 'with the right and a stone from the yard', arm across her chest. Brom: 'Door.' / 'You could have said that with less.' / 'Say it with less.' Seln: the elbow moved before she finished reaching; 'Six.' / 'I'm not filing that either. I'm counting it.' / 'Good.'"
    },
    {
      "obligation": "must_include: Manuscript format: H1 '# Chapter 15 — Strata', prose only, '---' breaks, ends on the last line of prose.",
      "status": "MET",
      "evidence": "H1 present; seven '---' breaks; no bold or headers (the finding openers are plain sentences); ends on Karis's line; metadata grep 0."
    },
    {
      "obligation": "plants: 'the Quieting' from here on; identical Arbiter failure (B9); the floor older than every stratum incl. the retired word (B8); Karis's unentered hypothesis; 'Lira first. Tomorrow.' (Ch16).",
      "status": "MET",
      "evidence": "All five on the page as quoted above; the made-shape pre-plant carried once more ('A circle is the shape you get when one thing is a fixed distance from another thing all the way round ... every one of those is a thing somebody made. That's still geometry.')."
    },
    {
      "obligation": "prohibited_outcomes: no maker/purpose/intelligence/'Architect'/'primordial'/'before the system'; [UNBOUND] once; no disclosure; no fight; no fragment use; no travel; no Teague/letters/Vastin; no new named entities; not a log or image ending; tic caps; no 'at the pitch'.",
      "status": "MET",
      "evidence": "grep: Architect 0, primordial 0, 'before the system' 0, UNBOUND 1, 'at the pitch' 0, capped tics 0, one-word paragraphs 0. Karis walks from 'shape' to 'somebody' ONLY in the mandated closing speech ('Somebody made a floor') and explicitly refuses the step in the small hand. No disclosure: Cael's silence is stated and held ('unfiled, where it would keep'; the log's 'told none of them'). No fight, no fragment use, no travel (Thornwater throughout). No letters, Teague, Vastin. No new names (the woman, the boy, the bowman, the girl with the wrist unnamed; Prynn and Ardenmere are established). Ends on dialogue (Ch14 ended on the log)."
    }
  ],
  "inventions": [
    "The week's staging: Karis takes the common room on the 103rd in exchange for three days of paper for the hold's accounts; the hold eats in the yard; the grain carts filling the loft; ice on the trough.",
    "The rubbings cut to the uprights' heights and laid 'tallest to shortest, a ring laid flat'; Karis's tally of the kinds of carved line and her refusal to state the number before a second site (a Ch20 set-up, not a finding).",
    "Finding two's image for the failure: five looms stopping when the sluice is shut on the wheel that drives them — the card's 'equipment on a circuit' rendered in-world (the series' 'circuit' is the fight circuit; mills exist).",
    "Seln's 'Six ... Five went out. I'm not filing that either. I'm counting it.' and Karis's struck-through six with the note 'one dark since fourteen; no change either side of the line; stated by him, not tested by me' — carrying only what Cael already said aloud at the stone (Ch9/Ch10).",
    "The strata's physical method: dressing (tool stroke, angle, chatter) and weathering (edge-rounding on the carved lines against the founding stone's dressed edge); the knife test on the lip ('The knife marked. The floor didn't.').",
    "Oryn's three hurts at Thornwater (rope-burn, a wrist set wrong in the spring, the bowman's shoulder) and her line at the door.",
    "Cael's mirrored silence beside Karis's unentered hypothesis ('the third thing at the table nobody wrote down')."
  ],
  "state_change_proposals": [
    "Timeline: Ch15 runs from the 103rd (Karis takes the room) to the 109th (the log; the closing exchange). Finding one said on the 105th; finding two over two days after; the strata and the stakes mid-week; the fifth on the 109th at dusk. 'Lira first. Tomorrow.' = the 110th (Ch16).",
    "THE WORD: 'the Quieting' coined by Karis on the page (105th) and adopted; nobody in the party says 'quiet ground' of it again without hearing the correction.",
    "Karis: voice nearly back by the 109th (goes on a word and returns); throat's yellow gone. Notebook holds: the five findings; *identically* underlined; the four strata named and dated; the floor entered past the founding stone as a limit; [UNBOUND] used once as a limit; the stakes entered once; the fifth observation entered, interpretation stopped ('It's a fear.'). She holds a private count of the kinds of carved line (number unstated). She has said the three facts aloud to Cael only.",
    "Oryn: worked Thornwater's backlog in the yard (three mendings across the week: rope-burn, a re-set wrist, a shoulder) at her rate; 'nine days late here and eleven at the next' as of the 104th; did not come to the table.",
    "Lira: arm slung, unused; reads the rubbings upside down; holds paper with a stone. Brom: string restriction expired; crossbow back on his belt. Seln: the case on his back; the door end; counted six sigils.",
    "Cael: ten fragments; nothing used; no letters; marks one hundred and eight; silence held; the slip back in the satchel. Knowledge: Karis knows (and has said to him alone) the three facts; she has NOT said her hypothesis; nobody has said a maker.",
    "Kept sentences: Karis — 'the Quieting' / 'identically' / 'A personal spiritual entity should not fail the way five looms fail when somebody shuts the sluice on the wheel that drives them.' / 'The knife marked. The floor didn't.' / 'Everything I can date, I've dated. The floor's under all of it. I don't know how far.' / 'It's just correct.' / the three facts; Lira — the clock line, said again; Brom — 'Door.'; Seln — 'I'm counting it.' / 'Good.'; Oryn — 'Send me who's hurt.'"
  ],
  "deviations": [
    "Length: first pass came in at 3,909 words (one under the band's floor) and was expanded from within the chapter's own beats to 4843 — the carvings tally, Thornwater's autumn, the made-shape exchange, Lira's clock line re-entered, Cael's interior at the slip, and the mirrored-silence paragraph. No mandated line changed.",
    "The finding openers were first drafted as bold headers (the B6 Ch16 precedent) and converted to plain prose sentences to meet the packet's 'prose only' format and audio-first rules.",
    "The card's 'equipment on a circuit' is rendered as looms on a mill-wheel to avoid the series' fight-circuit sense of 'circuit'.",
    "'Karis Dellenmoor' is spoken once by Karis of herself (the registry lists Dellenmoor as her surname); no new entity.",
    "Karis's strata name the academy above Ostrand by place, not 'Halcenvane' (registry disposition pending)."
  ],
  "blockers": []
}
