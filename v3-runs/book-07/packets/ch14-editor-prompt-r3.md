...

{
  ...
  "purpose": "REPAIR RUN (r3). Rebuild from v3-runs/book-07/drafts/ch14-r1.md byte-for-byte, applying ONLY the three verified findings from r2 (ask-first established in the yard; the three-part condition ledger; the built-to implication removed) as minimal insertions/replacements, with the inserted text tightened so wc -w ≤ 5,290. No other passage changes.",
  "scene_shape": {
  ...
  "context_files": [
    ...
    {
      "kind": "reference",
      "label": "THE DRAFT UNDER REPAIR (r1 — the byte-identical base)",
      "path": "v3-runs/book-07/drafts/ch14-r1.md",
      "required": true
    },
    {
      "kind": "reference",
      "label": "The rejected r2 (for the diff only)",
      "path": "v3-runs/book-07/drafts/ch14-r2.md",
      "required": false
    }
  ],
  "verified_findings": [
    ...
    },
    {
      "id": "ED-B7CH14-004",
      "severity": "MEDIUM",
      "gate": "recheck.targeted_repair_diff",
      "evidence": "r2 diff against r1: thirteen hunks outside the three repair targets.",
      "consequence": "Unaudited prose drift; non-repair prose not certifiable as unchanged.",
      "repair_target": "Restore every non-repair hunk to r1 byte-for-byte; keep only the three repairs; tighten inserted text for word count."
    }
  ],
  "exceptions": [],
  "output": {
    "draft_path": "v3-runs/book-07/drafts/ch14.md",
    "report_path": "v3-runs/book-07/reports/ch14-author-r3.json",
    "editor_report_path": "v3-runs/book-07/reports/ch14-editor-r3.json",
    "verifier_report_path": "v3-runs/book-07/reports/ch14-verifier-r3.json",
    "target_words": 4600,
...
# CONTEXT — THE DRAFT UNDER REPAIR (r1 — the byte-identical base) (v3-runs/book-07/drafts/ch14-r1.md)
...
# CONTEXT — The rejected r2 (for the diff only) (v3-runs/book-07/drafts/ch14-r2.md)
...
He knew three things about it that were not guesses, and he counted them. It had been there before Oryn; session nine was five years old and she was two months. It had been there before Brom's read caught it, because a read catches what is already there. And it was not the Quiet — the Quiet was outside him, a line on the ground that stopped Paths, and this was inside, and the fragments went round it, and had for longer than he had owned any.
...
# AUTHOR REPORT — v3-runs/book-07/reports/ch14-author-r3.json

{
  ...
  "obligations": [
    {
      "obligation": "ED-B7CH14-004 (MEDIUM): restore every non-repair hunk to r1 byte-for-byte; keep only the three repairs; tighten inserted text for word count.",
      "status": "MET",
      "evidence": "r3 was generated programmatically from drafts/ch14-r1.md with exactly three string replacements; diff r1→r3 shows three hunks, all inside the verified findings' spans. Word count 5288 (r1 was 5,270; ceiling 5,290)."
    },
    {
      "obligation": "ED-B7CH14-001 (HIGH): establish ask-first and Cael's acceptance outside the fixed exchange.",
      "status": "MET",
      "evidence": "Yard, second day, inserted after 'It's just that I didn't know they were places.': \"And when it turns outward, you ask. Every time. I ask the dying.\" / \"I ask first. Every time.\" (Oryn's line follows Cael's, so attribution is unambiguous; Ch16 restates the term in full per the arc.)"
    },
    {
      "obligation": "ED-B7CH14-002 (MEDIUM): keep the condition's parts distinct in the log.",
      "status": "MET",
      "evidence": "\"*The condition, in parts. Self first: done. Ask first: said in the yard, untested. Tell her: owed. What I found goes below, as what it is and not what it means.*\""
    },
    {
      "obligation": "ED-B7CH14-003 (HIGH): remove the built-to implication.",
      "status": "MET",
      "evidence": "\"and this was inside, and the fragments went round it, and had for longer than he had owned any.\" — location, movement, duration only."
    }
  ],
  "inventions": [],
  "state_change_proposals": [
    "As in r2's report: Oryn's condition has three parts (self first — done 102nd; ask first — said in the yard 101st, untested; tell her — owed)."
  ],
  "deviations": [
    "The r2 trims outside the repair spans are withdrawn; r2 is preserved as drafts/ch14-r2.md for the diff. The ask-first insert is deliberately terse (the arc's full restatement is Ch16's) to hold the band without touching non-repair prose."
  ],
  "blockers": []
}
