...

{
  ...
  "purpose": "The artifact chapter: the recovery contract paid in the wrong currency — a registry survey kit abandoned mid-use five years ago, its field ledger's last line an unfinished bearing — and Karis's six hours with the chamber's walls, advancing the sites' meaning by exactly one notch: forty-one shared characters, and a line that recurs at the perimeter's radius, entered as a measurement and not a maker.",
  "scene_shape": {
  ...
  "output": {
    ...
    "report_path": "v3-runs/book-07/reports/ch20-author-r1.json",
    "editor_report_path": "v3-runs/book-07/reports/ch20-editor-r1.json",
    "verifier_report_path": "v3-runs/book-07/reports/ch20-verifier-r1.json",
    "target_words": 4600,
...
# AUTHOR REPORT — v3-runs/book-07/reports/ch20-author-r1.json

{
  ...
  "deviations": [
    "The card's 'stake half-driven' is rendered as a stake with a bright point beside its mallet on unmarked stone (the fused floor will not take a stake, per Ch15's knife test) — 'half-driven' as attempted, not achieved. Reported so the editor can rule.",
    "First pass came in at 3,662 words (under the floor) and was expanded from within the chapter's own beats (Teague's one line; the chamber's air; Oryn/Karis's exchange; the sheet-giving; the rim) to 4299."
  ],
  "blockers": []
}
