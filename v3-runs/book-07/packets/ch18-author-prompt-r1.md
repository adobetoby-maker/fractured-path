...

{
  ...
  "scene_shape": {
    "opening_state": "Oxhollow's ford; Oryn at the lean-to with a line of patients; the five arriving south with the contract.",
  ...
  "obligations": {
    "must_include": [
      ...
      "Lira's arm carried; six on the road from Oxhollow.",
    ...
    "prohibited_outcomes": [
      ...
      "No Teague on the page (he is at Oxhollow in two days — after they leave); no letters, Vastin.",
  ...
  "invention_budget": {
    "allowed": [
      "Oxhollow's lean-to clinic and its line of patients as texture; Oryn's hands and arithmetic; the road south; the ridge; the stair's shape at dusk; the stakes as objects.",
