...

{
  ...
  "purpose": "REPAIR RUN (r4). Rebuild from drafts/ch14-r1.md byte-for-byte with the three repairs only; the built-to replacement now ends at location and movement ('and the fragments went round it.') with no temporal clause, per ED-B7CH14-005.",
  "scene_shape": {
  ...
  "context_files": [
    ...
    {
      "kind": "reference",
      "label": "The rejected r3 (for the diff only)",
      "path": "v3-runs/book-07/drafts/ch14-r3.md",
      "required": false
    }
  ],
  "verified_findings": [
    ...
    },
    {
      ...
      "severity": "HIGH",
      "gate": "core.continuity_persistence",
      "evidence": "r3: 'and had for longer than he had owned any' — fragments as subject.",
      "consequence": "Implies fragment action before acquisition / an unauthorized chronology.",
      "repair_target": "Location and movement only; established temporal facts stay in their existing sentences."
    }
  ],
  "exceptions": [],
  "output": {
    "draft_path": "v3-runs/book-07/drafts/ch14.md",
    "report_path": "v3-runs/book-07/reports/ch14-author-r4.json",
    "editor_report_path": "v3-runs/book-07/reports/ch14-editor-r4.json",
    "verifier_report_path": "v3-runs/book-07/reports/ch14-verifier-r4.json",
    "target_words": 4600,
...
# CONTEXT — The rejected r3 (for the diff only) (v3-runs/book-07/drafts/ch14-r3.md)
...
# AUTHOR REPORT — v3-runs/book-07/reports/ch14-author-r4.json

{
  ...
  "obligations": [
    {
      ...
      "status": "MET",
      "evidence": "r4 generated programmatically from drafts/ch14-r1.md with exactly three string replacements; diff r1→r4: three hunks. Word count 5279."
    },
    {
    ...
    {
      "obligation": "ED-B7CH14-003 + ED-B7CH14-005: remove the built-to implication and any unauthorized chronology.",
      "status": "MET",
      "evidence": "\"and this was inside, and the fragments went round it.\" — sentence ends at location and movement; the paragraph's existing sentences carry the authorized temporal facts (before Oryn; before Brom's read caught it)."
    }
  ],
  "inventions": [],
  ...
  "deviations": [
    "r2 and r3 preserved as drafts/ch14-r2.md and ch14-r3.md for the diffs; r4 differs from r1 in exactly three places."
  ],
  "blockers": []
}
